    ...
    if (regionID == 1) then
        ...
        elseif (player:getCurrentMission(COP) == DAWN) then
            ...
            elseif (player:getVar("PromathiaStatus") == 7) then
                ...
                elseif (player:getQuestStatus(JEUNO,SHADOWS_OF_THE_DEPARTED) == QUEST_AVAILABLE and player:getQuestStatus(JEUNO,STORMS_OF_FATE) == QUEST_COMPLETE) and player:getVar("ShadowsDepartedDay")~=VanadielDayOfTheYear()) then
