...
[1] =
--in my runs, 4-6 items would drop, so building pools accordingly
{
    {
...
--both blitz and aegis can drop, but ive never seen aegis in tandem with tundra/druids
    {
...
--basing the drop rates of this group  off of RJ but replacing steel items with the typical bcnm 40 6 person trash drops. because UO drops more gear
--mimicing RJ feels better for this first grouping. 
    {
...

    {
        ...
        {itemid=0, droprate =94},
    },
--basing the drop rates of this group  off of UO 
    {
