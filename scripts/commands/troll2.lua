...
function onTrigger(player)
   SpawnMob('16973962'); --War_Wamouracampa----GrpId=1592               poolID=4301
   SpawnMob('16973963'); --War_Wamouracampa
   SpawnMob('16973964'); --Incendiary_Bombs----GrpId=1523               poolID=2072
   ...
   SpawnMob('16973979'); --War_Wamoura---------GrpId=1592               poolID=4301
   SpawnMob('16973980'); --War_Wamoura
   SpawnMob('16973981'); --War_Wamoura
   SpawnMob('16973982'); --War_Wamoura
   SpawnMob('16973983'); --War_Wamoura
   SpawnMob('16973984'); --Aerial_Torpedo------GrpId=1487               poolID=52
   SpawnMob('16973985'); --Bombshells
   SpawnMob('16973986'); --Bombshells----------GrpId=1493               poolID=406
   ...
   SpawnMob('16973994'); --Vyurvarjur_the_Nimble-----------GrpId=1590      poolID=4269
   SpawnMob('16973995'); --Troll_Forager
   SpawnMob('16973996'); --Troll_Forager-------GrpId=1579               poolID=4016
   SpawnMob('16973997'); --Troll_Forager
   SpawnMob('16973998'); --Killing_Claw--------GrpId=1524               poolID=2230
   SpawnMob('16973999'); --Slaughterous_Scorpion
   SpawnMob('16973400'); --Slaughterous_Scorpion-----------GrpId=1572      poolID=3664
end