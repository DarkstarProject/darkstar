...
-- Check if COR Main or Sub
    ...
    if (target:addCorsairRoll(caster:getMainJob(), caster:getMerit(MERIT_BUST_DURATION), dsp.effect.COMPANIONS_ROLL, effectpower, 0, duration, caster:getID(), total, MOD_PET_REGAIN) == false) then
