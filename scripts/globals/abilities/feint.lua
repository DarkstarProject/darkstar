...
function onUseAbility(player,target,ability)
    local augment = player:getMod(dsp.mod.AUGMENTS_FEINT) * player:getMerit(MERIT_FEINT) / 25; -- Divide by the merit value (feint is 25) to get the number of merit points
