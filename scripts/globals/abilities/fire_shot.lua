...
function onUseAbility(player,target,ability,action)
    ...
    dmg = dmg * applyResistanceAbility(player,target,dsp.magic.ele.FIRE,dsp.skill.MRK, (player:getStat(dsp.mod.AGI)/2) + player:getMerit(dsp.merit.QUICK_DRAW_ACCURACY));
