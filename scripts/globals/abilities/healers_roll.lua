...
-- Check if COR Main or Sub
    ...
    if (target:addCorsairRoll(caster:getMainJob(), caster:getMerit(MERIT_BUST_DURATION), dsp.effect.HEALERS_ROLL, effectpower, 0, duration, caster:getID(), total, dsp.mod.CURE_POTENCY_RCVD) == false) then
