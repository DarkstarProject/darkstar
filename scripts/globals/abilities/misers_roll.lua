...
-- Check if COR Main or Sub
    ...
    if (target:addCorsairRoll(caster:getMainJob(), caster:getMerit(MERIT_BUST_DURATION), dsp.effect.MISERS_ROLL, effectpower, 0, duration, caster:getID(), total, MOD_SAVETP) == false) then
