...
-- Check if COR Main or Sub
    ...
    if (target:addCorsairRoll(caster:getMainJob(), caster:getMerit(MERIT_BUST_DURATION), dsp.effect.NATURALISTS_ROLL, effectpower, 0, duration, caster:getID(), total, dsp.mod.ENH_MAGIC_DURATION) == false) then
