...
function onAbilityCheck(player,target,ability)
    if (player:hasStatusEffect(dsp.effects.FINISHING_MOVE_5)) then
        return 561,0;
    else
        return 0,0;
    end
...
function onUseAbility(player,target,ability)
    ...
    if (player:hasStatusEffect(dsp.effects.FINISHING_MOVE_1)) then
        ...
        player:addStatusEffect(dsp.effects.FINISHING_MOVE_1 + moves,1,0,7200);
        return moves+1;
    elseif (player:hasStatusEffect(dsp.effects.FINISHING_MOVE_2)) then
        ...
        player:addStatusEffect(dsp.effects.FINISHING_MOVE_2 + moves,1,0,7200);
        return moves + 2;
    elseif (player:hasStatusEffect(dsp.effects.FINISHING_MOVE_3)) then
        ...
        player:addStatusEffect(dsp.effects.FINISHING_MOVE_3 + moves,1,0,7200);
        return moves + 3;
    elseif (player:hasStatusEffect(dsp.effects.FINISHING_MOVE_4)) then
        ...
        player:addStatusEffect(dsp.effects.FINISHING_MOVE_4 + moves,1,0,7200);
        return moves + 4;
    else
        player:addStatusEffect(dsp.effects.FINISHING_MOVE_1 + moves - 1,1,0,7200);
        return moves;
    end
end;