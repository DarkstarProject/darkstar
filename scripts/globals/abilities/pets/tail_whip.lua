...
function onPetAbility(target, pet, skill)
    ...
    if (duration > 0 and AvatarPhysicalHit(skill, totaldamage) and target:hasStatusEffect(EFFECT.WEIGHT) == false) then
        target:addStatusEffect(EFFECT.WEIGHT, 50, 0, duration);
    end
