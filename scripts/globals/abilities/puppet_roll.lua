...
function applyRoll(caster,target,ability,action,total)
    ...
    if (target:addCorsairRoll(caster:getMainJob(), caster:getMerit(MERIT_BUST_DURATION), EFFECT_PUPPET_ROLL, effectpower, 0, duration, caster:getID(), total) == false) then
        ability:setMsg(422);
