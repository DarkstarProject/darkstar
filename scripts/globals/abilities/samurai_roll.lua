...
-- Check if COR Main or Sub
    ...
    if (target:addCorsairRoll(caster:getMainJob(), caster:getMerit(MERIT_BUST_DURATION), dsp.effect.SAMURAI_ROLL, effectpower, 0, duration, caster:getID(), total, dsp.mod.STORETP) == false) then
