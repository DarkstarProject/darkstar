...
-- Check if COR Main or Sub
    ...
    if (target:addCorsairRoll(caster:getMainJob(), caster:getMerit(tpz.merit.BUST_DURATION), tpz.effect.WARLOCKS_ROLL, effectpower, 0, duration, caster:getID(), total, tpz.mod.MACC) == false) then
