...
local atmaMods =
{
    ...
    [dsp.ki.ATMA_OF_THE_WINGED_ENIGMA]          = {dsp.mod.HASTE_GEAR, 5},
    ...
    [dsp.ki.ATMA_OF_THE_AVARICIOUS_APE]         = {dsp.mod.HASTE_GEAR, 5}, -- not implemented: Monster Correlation
    ...
    [dsp.ki.ATMA_OF_THE_ASCENDING_ONE]          = {dsp.mod.WINDRES, 100, dsp.mod.HASTE_GEAR, 5, dsp.mod.SNAP_SHOT, 5},
    ...
    [dsp.ki.ATMA_OF_THE_CRIMSON_SCALE]          = {dsp.mod.HASTE_GEAR, 5, dsp.mod.ENMITY, -20},
    ...
    [dsp.ki.ATMA_OF_THE_OMNIPOTENT]             = {dsp.mod.DEX, 50, dsp.mod.HASTE_GEAR, 10, dsp.mod.ENMITY, 20},
    ...
    [dsp.ki.ATMA_OF_THE_SEA_DAUGHTER]           = {dsp.mod.REGAIN, 50, dsp.mod.HASTE_GEAR, -12, dsp.mod.REGEN, 30},
