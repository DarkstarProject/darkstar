...
function atmaEffectGain(target, effect)
    ...
    elseif (pwr == 92) then -- dsp.kis.ATMA_OF_THE_FOE_FLAYER
        target:addMod(MOD_MPP, 20);
        target:addMod(MOD_REFRESH, 20);
        target:addMod(MOD_FASTCAST, 20);
        target:addMod(MOD_MACC, 50);
    elseif (pwr == 93) then -- dsp.kis.ATMA_OF_THE_ENDLESS_NIGHTMARE
        target:addMod(MOD_MND, 20);
        target:addMod(MOD_DARKRES, 100);
        target:addMod(MOD_FORCE_DARK_DWBONUS, 1);
    elseif (pwr == 94) then -- dsp.kis.ATMA_OF_THE_SUNDERING_SLASH
        target:addMod(MOD_ATT, 20);
        target:addMod(MOD_REGAIN, 30);
    elseif (pwr == 95) then -- dsp.kis.ATMA_OF_ENTWINED_SERPENTS
        target:addMod(MOD_ATT, 20);
        target:addMod(MOD_DOUBLE_ATTACK, 15);
    elseif (pwr == 96) then -- dsp.kis.ATMA_OF_THE_HORNED_BEAST
        target:addMod(MOD_ACC, 60);
        target:addMod(MOD_PETRIFYRES, 50);
    elseif (pwr == 97) then -- dsp.kis.ATMA_OF_AQUATIC_ARDOR
        target:addMod(MOD_ABSORB_DMG_CHANCE, 6);
        target:addMod(MOD_MAGIC_ABSORB, 6);
    elseif (pwr == 98) then -- dsp.kis.ATMA_OF_THE_FALLEN_ONE
        target:addMod(MOD_INT, 30);
        target:addMod(MOD_MND, 30);
    elseif (pwr == 99) then -- dsp.kis.ATMA_OF_FIRES_AND_FLARES
        target:addMod(MOD_AGI, 20);
        target:addMod(MOD_RATT, 40);
    elseif (pwr == 100) then -- dsp.kis.ATMA_OF_THE_APOCALYPSE
    ...
    elseif (pwr == 101) then -- dsp.kis.ATMA_OF_THE_HEIR                         KI ID = 1655;
    elseif (pwr == 102) then -- dsp.kis.ATMA_OF_THE_HERO                         KI ID = 1656;
    elseif (pwr == 103) then -- dsp.kis.ATMA_OF_THE_FULL_MOON                    KI ID = 1657;
    elseif (pwr == 104) then -- dsp.kis.ATMA_OF_ILLUSIONS                        KI ID = 1658;
    elseif (pwr == 105) then -- dsp.kis.ATMA_OF_THE_BANISHER                     KI ID = 1659;
    elseif (pwr == 106) then -- dsp.kis.ATMA_OF_THE_SELLSWORD                    KI ID = 1660;
    elseif (pwr == 107) then -- dsp.kis.ATMA_OF_A_FUTURE_FABULOUS                KI ID = 1661;
    elseif (pwr == 108) then -- dsp.kis.ATMA_OF_CAMARADERIE                      KI ID = 1662;
    elseif (pwr == 109) then -- dsp.kis.ATMA_OF_THE_TRUTHSEEKER                  KI ID = 1663;
    elseif (pwr == 110) then -- dsp.kis.ATMA_OF_THE_AZURE_SKY                    KI ID = 1664;
    elseif (pwr == 111) then -- dsp.kis.ATMA_OF_ECHOES                           KI ID = 1665;
    elseif (pwr == 112) then -- dsp.kis.ATMA_OF_DREAD                            KI ID = 1666;
    elseif (pwr == 113) then -- dsp.kis.ATMA_OF_AMBITION                         KI ID = 1667;
    elseif (pwr == 114) then -- dsp.kis.ATMA_OF_THE_BEAST_KING                   KI ID = 1668;
    elseif (pwr == 115) then -- dsp.kis.ATMA_OF_THE_KIRIN                        KI ID = 1669;
    elseif (pwr == 116) then -- dsp.kis.ATMA_OF_HELLS_GUARDIAN                   KI ID = 1670;
    elseif (pwr == 117) then -- dsp.kis.ATMA_OF_LUMINOUS_WINGS                   KI ID = 1671;
    elseif (pwr == 118) then -- dsp.kis.ATMA_OF_THE_DRAGON_RIDER                 KI ID = 1672;
    elseif (pwr == 119) then -- dsp.kis.ATMA_OF_THE_IMPENETRABLE                 KI ID = 1673;
    elseif (pwr == 120) then -- dsp.kis.ATMA_OF_ALPHA_AND_OMEGA                  KI ID = 1674;
    elseif (pwr == 121) then -- dsp.kis.ATMA_OF_THE_ULTIMATE                     KI ID = 1675;
    elseif (pwr == 122) then -- dsp.kis.ATMA_OF_THE_HYBRID_BEAST                 KI ID = 1676;
    elseif (pwr == 123) then -- dsp.kis.ATMA_OF_THE_DARK_DEPTHS                  KI ID = 1677;
    elseif (pwr == 124) then -- dsp.kis.ATMA_OF_THE_ZENITH                       KI ID = 1678;
    elseif (pwr == 125) then -- dsp.kis.ATMA_OF_PERFECT_ATTENDANCE               KI ID = 1679;
    elseif (pwr == 126) then -- dsp.kis.ATMA_OF_THE_RESCUER                      KI ID = 1680;
    elseif (pwr == 127) then -- dsp.kis.ATMA_OF_NIGHTMARES                       KI ID = 1681;
    elseif (pwr == 128) then -- dsp.kis.ATMA_OF_THE_EINHERJAR                    KI ID = 1682;
    elseif (pwr == 129) then -- dsp.kis.ATMA_OF_THE_ILLUMINATOR                  KI ID = 1683;
    elseif (pwr == 130) then -- dsp.kis.ATMA_OF_THE_BUSHIN                       KI ID = 1684;
    elseif (pwr == 131) then -- dsp.kis.ATMA_OF_THE_ACE_ANGLER                   KI ID = 1685;
    elseif (pwr == 132) then -- dsp.kis.ATMA_OF_THE_MASTER_CRAFTER               KI ID = 1686;
    elseif (pwr == 133) then -- dsp.kis.ATMA_OF_INGENUITY                        KI ID = 1687;
    elseif (pwr == 134) then -- dsp.kis.ATMA_OF_THE_GRIFFONS_CLAW                KI ID = 1688;
    elseif (pwr == 135) then -- dsp.kis.ATMA_OF_THE_FETCHING_FOOTPAD             KI ID = 1689;
    elseif (pwr == 136) then -- dsp.kis.ATMA_OF_UNDYING_LOYALTY                  KI ID = 1690;
    elseif (pwr == 137) then -- dsp.kis.ATMA_OF_THE_ROYAL_LINEAGE                KI ID = 1691;
    elseif (pwr == 138) then -- dsp.kis.ATMA_OF_THE_SHATTERING_STAR              KI ID = 1692;
    elseif (pwr == 139) then -- dsp.kis.ATMA_OF_THE_COBRA_COMMANDER              KI ID = 1693;
    elseif (pwr == 140) then -- dsp.kis.ATMA_OF_ROARING_LAUGHTER                 KI ID = 1694;
    elseif (pwr == 141) then -- dsp.kis.ATMA_OF_THE_DARK_BLADE                   KI ID = 1695;
    elseif (pwr == 142) then -- dsp.kis.ATMA_OF_THE_DUCAL_GUARD                  KI ID = 1696;
    elseif (pwr == 143) then -- dsp.kis.ATMA_OF_HARMONY                          KI ID = 1697;
    elseif (pwr == 144) then -- dsp.kis.ATMA_OF_REVELATIONS                      KI ID = 1698;
    elseif (pwr == 145) then -- dsp.kis.ATMA_OF_THE_SAVIOR                       KI ID = 1699;
    end
end;
