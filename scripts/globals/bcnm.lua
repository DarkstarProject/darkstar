...
itemid_bcnmid_map = {139,{1553,11,1175,15}, -- Horlais Peak
...
-- 0,1,2,3,4,5,...
bcnmid_param_map = {139,{0,0,5,5,6,6,7,7,11,11,15,15},
					140,{32,0,33,1,34,2},
...
function EventFinishBCNM(player,csid,option)
	...
	if(player:hasStatusEffect(EFFECT_BATTLEFIELD) == false) then -- Temp condition for normal bcnm (started with onTrigger)
		...
		if(id == 68 or id == 418 or id == 450 or id == 482 or id == 545 or id == 578 or id == 609 or id == 81 or id == 76 or id == 107 or id == 11 or id == 105 or id == 82 or id == 34 or id == 15) then
