...
ZENI = 10;
AHTURHGAN = 3;
LEUJAOAM_ASSAULT_POINT = 4;
MAMOOL_ASSAULT_POINT = 5;
LEBROS_ASSAULT_POINT = 6;
PERIQIA_ASSAULT_POINT = 7;
ILRUSI_ASSAULT_POINT = 8;
NYZUL_ISLE_ASSAULT_POINT = 9;
...
seals = {
	...
	CHARCOAL_GREY_SEAL, DEEP_PURPLE_SEAL, CHESTNUTCOLORED_SEAL,
	LILACCOLORED_SEAL,
	CERISE_SEAL,CERISE_SEAL,CERISE_SEAL,
	SALMONCOLORED_SEAL,SALMONCOLORED_SEAL,SALMONCOLORED_SEAL,
