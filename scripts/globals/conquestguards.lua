...
-----------------------------------
-- Supply Run
-- {Option,QuestKI,Zone,MenuMask,ConquestReward,VariableTP,MinLvL}
-----------------------------------
SupplyRun = {0x10005,RONFAURE_SUPPLIES,0x64,0x000020,0x0A,"RONF_TELE",10,RONFAURE,
             0x10006,ZULKHEIM_SUPPLIES,0x67,0x000040,0x1E,"ZULK_TELE",10,ZULKHEIM,
             0x10007,NORVALLEN_SUPPLIES,0x68,0x000080,0x3C,"NORV_TELE",15,NORVALLEN,
             0x10008,GUSTABERG_SUPPLIES,0x6A,0x000100,0x0A,"GUST_TELE",10,GUSTABERG,
             0x10009,DERFLAND_SUPPLIES,0x6D,0x000200,0x3C,"DERF_TELE",15,DERFLAND,
             0x1000A,SARUTABARUTA_SUPPLIES,0x73,0x000400,0x0A,"SARU_TELE",10,SARUTABARUTA,
             0x1000B,KOLSHUSHU_SUPPLIES,0x76,0x000800,0x1E,"KOLS_TELE",10,KOLSHUSHU,
             0x1000C,ARAGONEU_SUPPLIES,0x77,0x001000,0x3C,"ARAG_TELE",15,ARAGONEU,
             0x1000D,FAUREGANDI_SUPPLIES,0x6F,0x002000,0x46,"FAUR_TELE",35,FAUREGANDI,
             0x1000E,VALDEAUNIA_SUPPLIES,0x70,0x004000,0x50,"VALD_TELE",40,VALDEAUNIA,
             0x1000F,QUFIM_SUPPLIES,0x7E,0x008000,0x3C,"QUFI_TELE",15,QUFIMISLAND,
             0x10010,LITELOR_SUPPLIES,0x79,0x010000,0x46,"LITE_TELE",25,LITELOR,
             0x10011,KUZOTZ_SUPPLIES,0x72,0x020000,0x50,"KUZO_TELE",30,KUZOTZ,
             0x10012,VOLLBOW_SUPPLIES,0x71,0x040000,0x64,"VOLB_TELE",50,VOLLBOW,
             0x10013,ELSHIMO_LOWLANDS_SUPPLIES,0x7B,0x080000,0x46,"ELLO_TELE",25,ELSHIMOLOWLANDS,
             0x10014,ELSHIMO_UPLANDS_SUPPLIES,0x7C,0x100000,0x5A,"ELUP_TELE",35,ELSHIMOUPLANDS};
