...
-----------------------------------
-- Supply Run
-- {Option,QuestKI,Zone,MenuMask,ConquestReward,VariableTP}
-----------------------------------
SupplyRun = {0x10005,RONFAURE_SUPPLIES,0x64,0x000020,0x0A,"RONF_TELE",
             0x10006,ZULKHEIM_SUPPLIES,0x67,0x000040,0x1E,"ZULK_TELE",
             0x10007,NORVALLEN_SUPPLIES,0x68,0x000080,0x3C,"NORV_TELE",
             0x10008,GUSTABERG_SUPPLIES,0x6A,0x000100,0x0A,"GUST_TELE",
             0x10009,DERFLAND_SUPPLIES,0x6D,0x000200,0x3C,"DERF_TELE",
             0x1000A,SARUTABARUTA_SUPPLIES,0x73,0x000400,0x0A,"SARU_TELE",
             0x1000B,KOLSHUSHU_SUPPLIES,0x76,0x000800,0x1E,"KOLS_TELE",
             0x1000C,ARAGONEU_SUPPLIES,0x77,0x001000,0x3C,"ARAG_TELE",
             0x1000D,FAUREGANDI_SUPPLIES,0x6F,0x002000,0x46,"FAUR_TELE",
             0x1000E,VALDEAUNIA_SUPPLIES,0x70,0x004000,0x50,"VALD_TELE",
             0x1000F,QUFIM_SUPPLIES,0x7E,0x008000,0x3C,"QUFI_TELE",
             0x10010,LITELOR_SUPPLIES,0x79,0x010000,0x46,"LITE_TELE",
             0x10011,KUZOTZ_SUPPLIES,0x72,0x020000,0x50,"KUZO_TELE",
             0x10012,VOLLBOW_SUPPLIES,0x71,0x040000,0x64,"VOLB_TELE",
             0x10013,ELSHIMO_LOWLANDS_SUPPLIES,0x7B,0x080000,0x46,"ELLO_TELE",
             0x10014,ELSHIMO_UPLANDS_SUPPLIES,0x7C,0x100000,0x5A,"ELUP_TELE"};
--TAVNAZIAN_ARCHIPELAGO_SUPPLIES
--
-----------------------------------
-- Expeditionary Force
...
-----------------------------------
-- Outpost Warp
-- {Option,VariableTP,Zone,XPos,YPos,ZPos,Rotation}
-----------------------------------
OPWARP = {5,"RONF_TELE",0x64,-446,-20,-220,0,
          6,"ZULK_TELE",0x67,143,-7,100,0,
          7,"NORV_TELE",0x68,57,0,-10,192,
          8,"GUST_TELE",0x6A,582,41,-57,220,
          9,"DERF_TELE",0x6D,468,24,421,192,
		  10,"SARU_TELE",0x73,-15,-13,318,128,
		  11,"KOLS_TELE",0x76,-480,-32,50,192,
          12,"ARAG_TELE",0x77,-298,17,418,98,
          13,"FAUR_TELE",0x6F,-20,-59,-117,0,
          14,"VALD_TELE",0x70,210,-24,-206,0,
		  15,"QUFI_TELE",0x7E,-246,-20,301,192,
		  16,"LITE_TELE",0x79,-39,0,-146,0,
		  17,"KUZO_TELE",0x72,-257,8,-252,0,
          18,"VOLB_TELE",0x71,-184,8,-66,0,
          19,"ELLO_TELE",0x7B,-243,0,-400,192,
          20,"ELUP_TELE",0x7C,203,0,-82,36,
          0,"SAND_TELE",0xE7,49,-1,29,164,
