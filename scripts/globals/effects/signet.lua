...
function onEffectGain(target,effect)
    target:addLatent(dsp.latent.TARGET_EVEN_MATCH_LOWER, 0, dsp.mod.DEF, 15)
    target:addLatent(dsp.latent.TARGET_EVEN_MATCH_LOWER, 0, dsp.mod.EVA, 15)
end
...
function onEffectLose(target,effect)
    target:delLatent(dsp.latent.TARGET_EVEN_MATCH_LOWER, 0, dsp.mod.DEF, 15)
    target:delLatent(dsp.latent.TARGET_EVEN_MATCH_LOWER, 0, dsp.mod.EVA, 15)
end