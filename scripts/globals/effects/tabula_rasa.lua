...
function onEffectGain(target,effect)
    ...
    if (target:hasStatusEffect(EFFECT.LIGHT_ARTS) or target:hasStatusEffect(EFFECT.ADDENDUM_WHITE)) then
    ...
    elseif (target:hasStatusEffect(EFFECT.DARK_ARTS) or target:hasStatusEffect(EFFECT.ADDENDUM_BLACK)) then
