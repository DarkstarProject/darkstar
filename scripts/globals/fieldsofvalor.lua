...
function finishFov(player,csid,option,r1,r2,r3,r4,r5,msg_offset)
    ...
    elseif (option == FOV_MENU_ELITE_INTRO) then
    elseif (option == FOV_MENU_ELITE_CHAP1) then
        -- Sample code
        -- if (player:getCurrency("valor_point")) >= 100) then
            -- giveEliteRegime(player,ELITE_TRAINING_CHAPTER_1,100);
            -- player:delCurrency("valor_point",100);
        -- else
        -- end
    elseif (option == FOV_MENU_ELITE_CHAP2) then
