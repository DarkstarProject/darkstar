...
local npcid = {51,{16986711,16986712,16986713,16986714,16986715,16986716},   -- Wajaom Woodlands
		 52,{16990602,16990603,16990604,16990605,16990606,16990607},   -- Bhaflau Thickets
		 89,{17142543,17142544,17142545,17142546,17142547,17142548},   -- Grauberg [S]
		 95,{17167161,17167162,17167163,17167164,17167165,17167166},   -- West Sarutabaruta [S]
		 115,{17248835,17248836,17248837,17248838,17248839,17248840},  -- West Sarutabaruta
		 123,{17281620,17281621,17281622},							   -- Yuhtunga Jungle
		 124,{17285672,17285673,17285674},							   -- Yhoator Jungle
		 145,{17371604,17371605,17371606,17371607,17371608,17371609}}; -- Giddeus
...
function startHarvesting(player,zone,npc,trade,csid)
	...
	if(trade:hasItemQty(1020,1) and trade:getItemCount() == 1) then
		...
		item = getHarvestingItem(player,zone);
