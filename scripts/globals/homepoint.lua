...
homepoints[29]  = { 1, 20,      -6,      3,       0,   0, 243,  500}; -- Ru'Lude Gardens #1    
...
homepoints[61]  = { 2, 20,    -312,    -42,    -422,   0, 130, 1000}; -- Ru'Aun Gardens #3       
...
homepoints[93]  = { 3, 20,     182,     34,     -62, 223, 160, 1000}; -- Den of Rancor #2          
