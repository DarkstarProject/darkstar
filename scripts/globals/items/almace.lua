...
local NAME_WEAPONSKILL = "AFTERMATH_ALMACE";
local NAME_EFFECT_LOSE = "AFTERMATH_LOST_ALMACE";

-- https://www.bg-wiki.com/bg/Relic_Aftermath
local aftermathTable = {};

-- Almace 85
aftermathTable[19458] =
{
    { -- Tier 1
        duration = 30,
        mods =
...
aftermathTable[19536] = aftermathTable[19458]; -- Almace (90)
aftermathTable[19634] = aftermathTable[19458]; -- Almace (95)
aftermathTable[19807] = aftermathTable[19458]; -- Almace (99)
aftermathTable[19855] = aftermathTable[19458]; -- Almace (99/II)
aftermathTable[20653] = aftermathTable[19458]; -- Almace (119)
aftermathTable[20654] = aftermathTable[19458]; -- Almace (119/II)

-- Almace (119/III)
aftermathTable[20689] =
{
    { -- Tier 1
        duration = 60,
        mods =
