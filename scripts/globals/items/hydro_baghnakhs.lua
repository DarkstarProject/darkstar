...
function onAdditionalEffect(player,target,damage)
    ...
    if (player:getEquipID(SLOT_AMMO) == 18234) and (player:getEquipID(SLOT_MAIN) == 17512) then
        slotdmg = 6
    elseif(player:getEquipID(SLOT_AMMO) == 18233) and (player:getEquipID(SLOT_MAIN) == 17512) then
        slotdmg = 12
    end
