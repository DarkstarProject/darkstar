...
local NAME_WEAPONSKILL = "AFTERMATH_KOGARASUMARU";
local NAME_EFFECT_LOSE = "AFTERMATH_LOST_KOGARASUMARU";

-- https://www.bg-wiki.com/bg/Mythic_Aftermath
local aftermathTable = {};

-- Kogarasumaru (75)
aftermathTable[19002] =
{
    {   -- Tier 1
        duration = 60,
        mods =
...
aftermathTable[19091] = aftermathTable[19071]; -- Kogarasumaru (85)
aftermathTable[19623] = aftermathTable[19071]; -- Kogarasumaru (90)

-- Kogarasumaru (95)
aftermathTable[19721] =
{
    {   -- Tier 1
        duration = 90,
        mods =
...
aftermathTable[19830] = aftermathTable[19721]; -- Kogarasumaru (99)
aftermathTable[19959] = aftermathTable[19721]; -- Kogarasumaru (99/II)
aftermathTable[21017] = aftermathTable[19721]; -- Kogarasumaru (119)
aftermathTable[21018] = aftermathTable[19721]; -- Kogarasumaru (119/II)
