...
local Maps = {dsp.kis.MAP_OF_THE_SAN_DORIA_AREA, dsp.kis.MAP_OF_THE_BASTOK_AREA, dsp.kis.MAP_OF_THE_WINDURST_AREA, dsp.kis.MAP_OF_THE_JEUNO_AREA, dsp.kis.MAP_OF_ORDELLES_CAVES, dsp.kis.MAP_OF_GHELSBA, dsp.kis.MAP_OF_DAVOI, dsp.kis.MAP_OF_CARPENTERS_LANDING, dsp.kis.MAP_OF_THE_ZERUHN_MINES,
    dsp.kis.MAP_OF_THE_PALBOROUGH_MINES, dsp.kis.MAP_OF_BEADEAUX, dsp.kis.MAP_OF_GIDDEUS, dsp.kis.MAP_OF_CASTLE_OZTROJA, dsp.kis.MAP_OF_THE_MAZE_OF_SHAKHRAMI, dsp.kis.MAP_OF_THE_LITELOR_REGION, dsp.kis.MAP_OF_BIBIKI_BAY, dsp.kis.MAP_OF_QUFIM_ISLAND, dsp.kis.MAP_OF_THE_ELDIEME_NECROPOLIS,
    dsp.kis.MAP_OF_THE_GARLAIGE_CITADEL, dsp.kis.MAP_OF_THE_ELSHIMO_REGIONS, dsp.kis.MAP_OF_THE_NORTHLANDS_AREA, dsp.kis.MAP_OF_KING_RANPERRES_TOMB, dsp.kis.MAP_OF_THE_DANGRUF_WADI, dsp.kis.MAP_OF_THE_HORUTOTO_RUINS, dsp.kis.MAP_OF_BOSTAUNIEUX_OUBLIETTE,
    dsp.kis.MAP_OF_THE_TORAIMARAI_CANAL, dsp.kis.MAP_OF_THE_GUSGEN_MINES, dsp.kis.MAP_OF_THE_CRAWLERS_NEST, dsp.kis.MAP_OF_THE_RANGUEMONT_PASS, dsp.kis.MAP_OF_DELKFUTTS_TOWER, dsp.kis.MAP_OF_FEIYIN, dsp.kis.MAP_OF_CASTLE_ZVAHL, dsp.kis.MAP_OF_THE_KUZOTZ_REGION,
    dsp.kis.MAP_OF_THE_RUAUN_GARDENS, dsp.kis.MAP_OF_NORG, dsp.kis.MAP_OF_THE_TEMPLE_OF_UGGALEPIH, dsp.kis.MAP_OF_THE_DEN_OF_RANCOR, dsp.kis.MAP_OF_THE_KORROLOKA_TUNNEL, dsp.kis.MAP_OF_THE_KUFTAL_TUNNEL, dsp.kis.MAP_OF_THE_BOYAHDA_TREE, dsp.kis.MAP_OF_THE_VELUGANNON_PALACE,
    dsp.kis.MAP_OF_IFRITS_CAULDRON, dsp.kis.MAP_OF_THE_QUICKSAND_CAVES, dsp.kis.MAP_OF_THE_SEA_SERPENT_GROTTO, dsp.kis.MAP_OF_THE_VOLLBOW_REGION, dsp.kis.MAP_OF_THE_LABYRINTH_OF_ONZOZO, dsp.kis.MAP_OF_THE_ULEGUERAND_RANGE, dsp.kis.MAP_OF_THE_ATTOHWA_CHASM, dsp.kis.MAP_OF_PSOXJA,
    dsp.kis.MAP_OF_OLDTON_MOVALPOLOS, dsp.kis.MAP_OF_NEWTON_MOVALPOLOS, dsp.kis.MAP_OF_TAVNAZIA, dsp.kis.MAP_OF_THE_AQUEDUCTS, dsp.kis.MAP_OF_THE_SACRARIUM, dsp.kis.MAP_OF_CAPE_RIVERNE, dsp.kis.MAP_OF_ALTAIEU, dsp.kis.MAP_OF_HUXZOI, dsp.kis.MAP_OF_RUHMET, dsp.kis.MAP_OF_AL_ZAHBI, dsp.kis.MAP_OF_NASHMAU,
    dsp.kis.MAP_OF_WAJAOM_WOODLANDS, dsp.kis.MAP_OF_CAEDARVA_MIRE, dsp.kis.MAP_OF_MOUNT_ZHAYOLM, dsp.kis.MAP_OF_AYDEEWA_SUBTERRANE, dsp.kis.MAP_OF_MAMOOK, dsp.kis.MAP_OF_HALVUNG, dsp.kis.MAP_OF_ARRAPAGO_REEF, dsp.kis.MAP_OF_ALZADAAL_RUINS, dsp.kis.MAP_OF_BHAFLAU_THICKETS,
    dsp.kis.MAP_OF_VUNKERL_INLET, dsp.kis.MAP_OF_GRAUBERG, dsp.kis.MAP_OF_FORT_KARUGONARUGO};
