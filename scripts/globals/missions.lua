...
RESONACE                        = 1;
EMISSARY_FROM_THE_SEAS          = 2;
SET_FREE                        = 3;
THE_BEGINNING                   = 4;
FLAMES_OF_PRAYER                = 5;
THE_PATH_UNTRAVELED             = 6;
AT_THE_HEAVENS_DOOR             = 9;
THE_LIONS_ROAR                  = 10;
EDDIES_OF_DESPAIR_I             = 11;
A_LAND_AFTER_TIME               = 13;
FATES_CALL                      = 14;
WHAT_LIES_BEYOND                = 15;
THE_TIES_THAT_BIND              = 16;
IMPURITY                        = 17;
THE_LOST_AVATAR                 = 18;
VOLTO_OSCURO                    = 20;
RING_MY_BELL                    = 21;
...
FROM_THE_RUINS                  = 35;
CAUTERIZE                       = 36;
UNCERTAIN_DESTINATIONS          = 39;
GANGED_UP_ON                    = 40;
SACRIFICE                       = 42;
SOMBER_DREAMS                   = 43;
OF_LIGHT_AND_DARKNESS           = 46;
TEMPORARY_FAREWELLS             = 47;
BRUSHING_UP                     = 48;
KEEP_ON_GIVING                  = 49;
PAST_IMPERFECT                  = 50;
THE_CURSED_TEMPLE               = 51;
WISDOM_OF_OUR_FOREFATHERS       = 52;
WHERE_DIVINITIES_COLLIDE        = 53;
VISIONS_OF_DREAD                = 54;
TO_THE_SKIES                    = 55;
ESCHA_RUAUN                     = 56;
THE_DECISIVE_HEROINE            = 58;
FALL_FROM_GRACE                 = 59;
BANISHING_THE_DARKNESS          = 60;
OVER_THE_RAINBOW                = 61;
CACOPHONOUS_DISCORD             = 62;
EDDIES_OF_DESPAIR_II            = 63;
PRETENDER_TO_THE_THRONE         = 64;
BANISHED                        = 66;
CALL_OF_THE_VOID                = 67;
BOTH_PATHS_TAKEN                = 69;
THE_MAN_BEHIND_THE_MASK         = 72;
UNCERTAIN_FUTURES               = 73;
-- RECKONING                    =  -- Category
DARKNESS_BECKONS                = 74;
THE_BREWING_STORM               = 76;
THE_RIVER_RUNS_RED              = 77;
THE_CRUCIBLE                    = 78;
FORWARD_THINKING                = 79;
TEARS_OF_THE_GENERALS           = 80;
WHAT_HE_LEFT_BEHIND             = 81;
GONE_BUT_NOT_FORGOTTEN          = 82;
AUGUST_ARTIFACTS                = 83;
SOLEMNITY                       = 84;
EYES_ON_YOU                     = 85;
EXPLORING_THE_RUINS             = 86;
BECOME_SOMETHING_MORE           = 87;
UNSHAKABLE_NIGHTMARES           = 88;
WHAT_REMAINS_OF_HOPE            = 89;
DEATH_CARES_NOT                 = 91;
NO_TIME_LIKE_THE_FUTURE         = 92;
SIN                             = 94;
PENANCE                         = 96;
VESSEL_OF_LIGHT                 = 97;
THE_LIFESTREAM_OF_REISENJIMA    = 98;
FROM_WEST_TO_EAST               = 99;
GOOD_THINGS_COME_IN_THREES      = 100;
TACKLING_THE_PROBLEM            = 101;
WAY_TO_DIVINITY                 = 102;
THE_WINDS_OF_TIME               = 103;
CALM_AFTER_THE_STORM            = 105;
NARY_A_CLOUD_IN_SIGHT           = 107;
AN_UNENDING_SONG                = 108;
A_DEEP_SLEEP                    = 110;
GUARDIANS                       = 111;
IROHA_IN_DISTRESS               = 112;
ABSOLUTE_TRUST                  = 113;
THE_ORBS_RADIANCE               = 114;
A_RHAPSODY_FOR_THE_AGES         = 115;
