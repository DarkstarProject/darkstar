...
THE_MITHRA_AND_THE_CRYSTAL	= 24;
THE_GATE_OF_THE_GODS		= 26;
ARK_ANGELS					= 28;
THE_SEALED_SHRINE			= 30;
THE_CELESTIAL_NEXUS			= 32;
AWAKENING					= 34;
THE_LAST_VERSE				= 36;
	...
	if(nation == SANDORIA) then
		if((csid == 0x03f1 or csid == 0x07d9) and option ~= 1073741824 and option ~= 31) then
			...
			timeline = {
				...
				4,{0x02b7,0},{0,0},{{9,44},{14,0},{5,350},{7},{12}},{0,0},{0,0},{0}, -- MISSION 2-2 (Papal Chambers)
	...
	elseif(nation == WINDURST) then
		...
		if(csid == guardlist[guard] and option ~= 1073741824 and option ~= 31) then
			...
			timeline = {
				...
				13,{0x0025,0},{0,0},{0,0},{0,0},{{11,5},{14,0},{10,71},{6},{8,10000},{12}},{0,0},{0,0},{0,0},{0,0},{0}, -- MISSION 4-1 (Finish (Pakh Jatalfih))
