...
function OnMobWeaponSkill(target, mob, skill)
	...
	skill:setMsg(MobStatusEffectMove(mob, target, typeEffect, 18, 0, 180));

	local dmgmod = 1;
	local info = MobMagicalMove(mob,target,skill,mob:getWeaponDmg()*3.3,ELE_DARK,dmgmod,TP_NO_EFFECT);
