...
function onMobWeaponSkill(target, mob, skill)
    ...
    MobStatusEffectMove(mob, target, EFFECT.POISON, mob:getMainLvl()/3, 3, 60);
    MobStatusEffectMove(mob, target, EFFECT.SLOW, 128, 3, 120);
    MobStatusEffectMove(mob, target, EFFECT.PLAGUE, 5, 3, 60);
