        ...
        zone =
        {
            ...
            [dsp.zone.RANGUEMONT_PASS] =
            {
                ...
                page =
                {
                    ...
                    { 5,2,0,0, 87, 92,850,607},
                    { 3,3,0,0, 88, 90,850,608},
                    { 3,3,0,0, 88, 90,850,609},
                },
            },
            [dsp.zone.BOSTAUNIEUX_OUBLIETTE] =
            {
                ...
                page =
                {
                    ...
                    { 6,1,0,0, 94, 97,1200,614},
                    { 6,1,0,0, 95, 97,1200,615},
                    { 6,0,0,0, 96, 97,1200,616},
                    { 2,5,0,0, 95, 99,1200,617},
                },
            },
            [dsp.zone.TORAIMARAI_CANAL] =
            {
                ...
                page =
                {
                    ...
                    { 4,3,0,0, 95, 97,1500,622},
                    { 5,2,0,0, 95, 98,1500,623},
                    { 5,2,0,0, 96, 98,1500,624},
                    { 8,2,0,0, 94, 99,1500,625},
                },
            },
            [dsp.zone.ZERUHN_MINES] =
            {
                ...
                page =
                {
                    { 3,0,0,0,  1,  3,  90,626},
                    { 3,0,0,0,  2,  4, 110,627},
                    { 5,2,0,0, 75, 78,100,628},
                    { 5,2,0,0, 75, 79,100,629},
                    { 5,2,0,0, 75, 80,100,630},
                },
            },
            ...
            [dsp.zone.KING_RANPERRES_TOMB] =
            {
                ...
                page =
                {
                    ...
                    { 6,1,0,0, 78, 80,800,636},
                    { 5,2,0,0, 77, 80,800,637},
                    { 5,2,0,0, 80, 83,800,638},
                },
            },
            [dsp.zone.DANGRUF_WADI] =
            {
                ...
                page =
                {
                    ...
                    { 4,2,0,0, 86, 89,400,642},
                    { 5,2,0,0, 86, 90,400,643},
                    { 5,2,0,0, 86, 90,400,644},
                    { 2,2,2,0, 90, 91,400,645},
                    { 5,2,0,0, 90, 93,400,646},
                },
            },
            [dsp.zone.INNER_HORUTOTO_RUINS] =
            {
                ...
                page =
                {
                    ...
                    { 3,3,0,0, 78, 82,500,651},
                    { 3,3,0,0, 79, 82,500,652},
                    { 2,4,0,0, 81, 83,500,653},
                    { 2,4,0,0, 81, 84,500,654},
                },
            },
            [dsp.zone.ORDELLES_CAVES] =
            {
                ...
                page =
                {
                    ...
                    { 3,3,0,0, 84, 86,800,661},
                    { 3,3,0,0, 86, 88,800,662},
                },
            },
            [dsp.zone.OUTER_HORUTOTO_RUINS] =
            {
                ...
                page =
                {
                    ...
                    { 5,1,0,0, 81, 85,500,669},
                    { 5,1,0,0, 82, 85,500,670},
                },
            },
            [dsp.zone.THE_ELDIEME_NECROPOLIS] =
            {
                ...
                page =
                {
                    ...
                    { 3,3,0,0, 91, 95,1300,677},
                    { 3,3,0,0, 91, 95,1300,678},
                },
            },
            [dsp.zone.GUSGEN_MINES] =
            {
                ...
                page =
                {
                    ...
                    { 2,5,0,0, 85, 87,850,685},
                    { 2,5,0,0, 85, 89,850,686},
                },
            },
            [dsp.zone.CRAWLERS_NEST] =
            {
                ...
                page =
                {
                    ...
                    { 4,3,0,0, 91, 93,1300,693},
                    { 4,3,0,0, 92, 96,1300,694},
                },
            },
            [dsp.zone.MAZE_OF_SHAKHRAMI] =
            {
                ...
                page =
                {
                    ...
                    { 3,3,0,0, 83, 85,800,701},
                    { 3,3,0,0, 86, 88,800,702},
                },
            },
            [dsp.zone.GARLAIGE_CITADEL] =
            {
                ...
                page =
                {
                    ...
                    { 5,2,0,0, 91, 96,1200,709},
                    { 4,3,0,0, 92, 96,1200,710},
                },
            },
            [dsp.zone.FEIYIN] =
            {
                ...
                page =
                {
                    ...
                    { 4,2,0,0, 95, 99,1300,717},
                    { 4,3,0,0, 95, 99,1300,718},
                },
            },
...
dsp.regime.checkRegime = function(player, mob, regimeId, index, regimeType)
    ...
    if REGIME_WAIT == 0 or player:getCharVar("[regime]lastReward") < vanadielEpoch then
        -- gil
        player:addGil(reward/5)
        player:messageBasic(dsp.msg.basic.FOV_OBTAINS_GIL, reward/5)
