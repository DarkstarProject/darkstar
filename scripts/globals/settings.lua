...
WEAPON_SKILL_POWER  = 1.600; -- Multiplies damage dealt by Weapon Skills.
...
RELIC_3RD_UPGRADE_WAIT_TIME = 30;      -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
AF2_FAME = 30; -- base fame for completing an AF2 quest
