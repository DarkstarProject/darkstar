...
EXP_RATE   = 6.000; -- Multiplies exp earned from fov.
...
SPELL_POWER = 5.000; -- Multiplies damage dealt by Elemental and Divine Magic.
BLUE_POWER  = 15.000; -- Multiplies damage dealt by most Blue Magic.
...
STONESKIN_CAP = 300; -- soft cap for hp absorbed by stoneskin
