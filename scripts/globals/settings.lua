...
START_GIL = 250000; --Amount of gil given to newly created characters.
...
EXP_RATE   = 15.000; -- Multiplies exp earned from fov.
TABS_RATE  = 15.000; -- Multiplies tabs earned from fov.
SAN_FAME   = 15.000; -- Multiplies fame earned from San d'Oria quests.
BAS_FAME   = 15.000; -- Multiplies fame earned from Bastok quests.
WIN_FAME   = 15.000; -- Multiplies fame earned from Windurst quests.
NORG_FAME  = 15.000; -- Multiplies fame earned from Norg and Tenshodo quests.
JEUNO_FAME = 15.000; -- Multiplies fame earned from Jeuno quests.
...
SPELL_POWER = 2.000; -- Multiplies damage dealt by Elemental and Divine Magic.
...
MINING_BREAK_CHANCE     = 0.10; -- % chance for the pickaxe to break during mining.  Set between 0 and 1.
...
RELIC_2ND_UPGRADE_WAIT_TIME = 120;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
RELIC_3RD_UPGRADE_WAIT_TIME = 120;      -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
SCAVENGE_RATE = 0.9; --The chance of obtaining an item when you use the Ranger job ability Scavenge.  Do not set above 1!
...
CIRCLE_KILLER_EFFECT = 25; -- Intimidation percentage granted by circle effects. (made up number)
...
BARD_SONG_LIMIT = 10; --Maximum amount of songs from a single Bard that can be granted to a single target at once.  Set between 1 and 31.
BARD_INSTRUMENT_LIMIT = 10; --Maximum amount of songs from a single Bard with an instrument that can be granted to a single target at once.  Set between 2 and 32.
...
DIG_ABUNDANCE_BONUS = 45; -- Increase chance of digging up an item (450  = item digup chance +45)
