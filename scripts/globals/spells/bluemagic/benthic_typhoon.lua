...
function onSpellCast(caster,target,spell)
    ...
    params.tpmod = TPMOD_CRITICAL; params.dmgtype = DMGTYPE_PIERCE; params.scattr = SC_GRAVITATION;
	params.numhits = 1;
    params.multiplier = 2.50; params.tp150 = 3.00; params.tp300 = 3.50; params.azuretp = 1.50; params.duppercap = 90;
