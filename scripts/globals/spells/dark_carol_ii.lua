-----------------------------------------
-- Spell: Dark Carol II
-- Increases resistance against dark and
-- sometimes nullifies dark damage for
...
function onSpellCast(caster,target,spell)
	...
	if not (target:addBardSong(caster,EFFECT_CAROL,power,0,duration,caster:getID(), ELE_DARK, 2)) then
		spell:setMsg(75);
	end
