...
function onSpellCast(caster,target,spell)
    ...
    local params = {}params.diff = caster:getStat(dsp.mod.INT)-target:getStat(dsp.mod.INT)params.attribute = dsp.mod.INTparams.skillType = dsp.skill.ENFEEBLING_MAGICparams.bonus = 1.0resist = applyResistance(caster, target, spell, params)
