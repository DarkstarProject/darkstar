...
function onSpellCast(caster,target,spell)
    ...
    local params = {};params.diff = caster:getStat(dsp.mod.INT)-target:getStat(dsp.mod.INT);params.attribute = dsp.mod.INT;params.skillType = dsp.skill.ENFEEBLING_MAGIC;params.bonus = 1.0;resist = applyResistance(caster, target, spell, params);
