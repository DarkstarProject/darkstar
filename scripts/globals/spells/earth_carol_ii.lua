...
-- Increases resistance against earth and
-- sometimes nullifies earth damage for
...
function onSpellCast(caster,target,spell)
	...
	if not (target:addBardSong(caster,EFFECT_CAROL,power,0,duration,caster:getID(), ELE_EARTH, 2)) then
		spell:setMsg(75);
	end
