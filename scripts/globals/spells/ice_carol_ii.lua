-----------------------------------------
-- Spell: Ice Carol II
-- Increases resistance against ice and
-- sometimes nullifies ice damage for
...
function onSpellCast(caster,target,spell)
	...
	if not (target:addBardSong(caster,EFFECT_CAROL,power,0,duration,caster:getID(), ELE_ICE, 2)) then
		spell:setMsg(75);
	end
