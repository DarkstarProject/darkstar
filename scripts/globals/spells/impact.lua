...
local params = {}params.dmg = 939params.multiplier = 2.335params.hasMultipleTargetReduction = falseparams.resistBonus = 1.0   --local dmg = doElementalNuke(caster, target, spell, params)
