...
-- Increases resistance against light and
-- sometimes nullifies light damage for
...
function onSpellCast(caster,target,spell)
	...
	if not (target:addBardSong(caster,EFFECT_CAROL,power,0,duration,caster:getID(), ELE_LIGHT, 2)) then
		spell:setMsg(75);
	end
