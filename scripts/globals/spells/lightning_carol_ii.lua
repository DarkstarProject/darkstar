...
-- and sometimes nullifies lightning
-- damage for party members within area
-- of effect. 
-----------------------------------------
...
function onSpellCast(caster,target,spell)
	...
	if not (target:addBardSong(caster,EFFECT_CAROL,power,0,duration,caster:getID(), ELE_LIGHTNING, 2)) then
		spell:setMsg(75);
	end
