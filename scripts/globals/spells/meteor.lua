...
function onSpellCast(caster,target,spell)
	...
	--NOT AFFECTED BY DARK BONUSES (STAFF ETC)
	...
	dmg = ((100+caster:getMod(MOD_MATT))/(100+target:getMod(MOD_MDEF))) * (caster:getMod(MOD_INT) + (caster:getMod(79+ELEMENTAL_MAGIC_SKILL)+caster:getSkillLevel(ELEMENTAL_MAGIC_SKILL))/6) * 3.5;
