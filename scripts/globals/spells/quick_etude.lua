...
function onSpellCast(caster,target,spell)
	...
	elseif(sLvl+iLvl >= 182 & sLvl+iLvl <= 235) then
		power = 4
	elseif(sLvl+iLvl >= 236 & sLvl+iLvl <= 288) then
		power = 5
	elseif(sLvl+iLvl >= 289 & sLvl+iLvl <= 342) then
		power = 6
	elseif(sLvl+iLvl >= 343 & sLvl+iLvl <= 396) then
		power = 7
	elseif(sLvl+iLvl >= 397 & sLvl+iLvl <= 449) then
		power = 8
