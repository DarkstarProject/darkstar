...
-- Increases resistance against water and
-- sometimes nullifies water damage for
...
function onSpellCast(caster,target,spell)
	...
	if not (target:addBardSong(caster,EFFECT_CAROL,power,0,duration,caster:getID(), ELE_WATER, 2)) then
		spell:setMsg(75);
	end
