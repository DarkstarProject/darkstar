-----------------------------------------
-- Spell: Wind Carol II
-- Increases resistance against wind and
-- sometimes nullifies wind damage for
...
function onSpellCast(caster,target,spell)
	...
	if not (target:addBardSong(caster,EFFECT_CAROL,power,0,duration,caster:getID(), ELE_WIND, 2)) then
		spell:setMsg(75);
	end
