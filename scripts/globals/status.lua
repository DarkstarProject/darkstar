...
MOD_REPAIR_EFFECT       = 851 -- Removes # of status effects from the Automaton
MOD_REPAIR_POTENCY      = 852 -- Note: Only effects amount regenerated by a %, not the instant restore!
