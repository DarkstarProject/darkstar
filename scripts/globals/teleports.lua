...
function toEscape(player, zone)
	...
	elseif(zone == 167) then -- From Bostaunieux Oubliette
		player:setPos(-663,-27,19,6,0x64); -- To West Ronfaure at F-8
	elseif(zone == 190) then -- From King Ranperre's Tomb
		player:setPos(200,0,-536,187,0x65); -- To East Ronfaure at H-11
	elseif(zone == 173) then -- From Korroloka Tunnel
		player:setPos(-72,0,20,255,0xAC); -- To Zeruhn Mines at H-7
	elseif(zone == 195) then -- From The Eldieme Necropolis
		player:setPos(403,-15,-128,187,0x69); -- To Batallia Downs at F-8
	elseif(zone == 166) then -- From Ranguemont Pass
		player:setPos(809,-63,649,98,0x65); -- To East Ronfaure at K-4
	elseif(zone == 9) then -- From Pso'Xja
		player:setPos(-414,-39,-420,255,0x6F); -- To Beaucedine Glacier at E-11
