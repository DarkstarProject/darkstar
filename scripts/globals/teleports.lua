...
function retraceSandoria(player)
    player:setPos(1, 1, 0, 1, 0x50);
end;

function retraceBastok(player)
    player:setPos(-293, -12, -64, 1, 0x57);
end;

function retraceWindurst(player)
    player:setPos(-40, -5, 150, 1, 0x5E);
end;
