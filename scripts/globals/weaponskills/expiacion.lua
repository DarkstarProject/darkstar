...
-- Element: None
-- Modifiers: STR:30% INT:30% DEX:20%
...
function onUseWeaponSkill(player, target, wsID)
	...
	params.str_wsc = 0.3; params.dex_wsc = 0.2; params.vit_wsc = 0.0; params.agi_wsc = 0.0; params.int_wsc = 0.3; params.mnd_wsc = 0.0; params.chr_wsc = 0.0;
