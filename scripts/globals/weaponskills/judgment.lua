...
-- Club weapon skill
-- Skill: 200
-- Modifiers: STR:32% ; MND:32% - 1hit, damage varies
...
function OnUseWeaponSkill(attacker, target, wsID)
	...
	ftp100 = 2; ftp200 = 2.5; ftp300 = 4;
	--wscs are in % so 0.2=20%
	str_wsc = 0.32; dex_wsc = 0.0; vit_wsc = 0.0; agi_wsc = 0.0; int_wsc = 0.0; mnd_wsc = 0.32; chr_wsc = 0.0;
