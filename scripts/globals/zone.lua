...
ORIGINAL_ROTZ =
{ -- TODO: Format and double check me!
    [dsp.zone.SOUTHERN_SAN_DORIA_S] = true,            
    [dsp.zone.EAST_RONFAURE_S] = true,                 
    [dsp.zone.JUGNER_FOREST_S] = true,                 
    [dsp.zone.VUNKERL_INLET_S] = true,                 
    [dsp.zone.BATALLIA_DOWNS_S] = true,                
    [dsp.zone.LA_VAULE_S] = true,                      
    [dsp.zone.EVERBLOOM_HOLLOW] = true,                
    [dsp.zone.BASTOK_MARKETS_S] = true,                
    [dsp.zone.NORTH_GUSTABERG_S] = true,               
    [dsp.zone.GRAUBERG_S] = true,                      
    [dsp.zone.PASHHOW_MARSHLANDS_S] = true,            
    [dsp.zone.ROLANBERRY_FIELDS_S] = true,             
    [dsp.zone.BEADEAUX_S] = true,                      
    [dsp.zone.RUHOTZ_SILVERMINES] = true,              
    [dsp.zone.WINDURST_WATERS_S] = true,               
    [dsp.zone.WEST_SARUTABARUTA_S] = true,             
    [dsp.zone.FORT_KARUGO_NARUGO_S] = true,            
    [dsp.zone.MERIPHATAUD_MOUNTAINS_S] = true,         
    [dsp.zone.SAUROMUGUE_CHAMPAIGN_S] = true,          
    [dsp.zone.CASTLE_OZTROJA_S] = true,                
    ...
    [dsp.zone.GHOYUS_REVERIE] = true,                  
    [dsp.zone.RUAUN_GARDENS] = true,                   
    [dsp.zone.MORDION_GAOL] = true,                    
    [dsp.zone.ABYSSEA_LA_THEINE] = true,               
    [dsp.zone.DYNAMIS_BEAUCEDINE] = true,              
    [dsp.zone.DYNAMIS_XARCABARD] = true,               
    [dsp.zone.BEAUCEDINE_GLACIER_S] = true,            
    [dsp.zone.XARCABARD_S] = true,                     
    [dsp.zone.CASTLE_ZVAHL_BAILEYS_S] = true,          
    ...
    [dsp.zone.CASTLE_ZVAHL_KEEP_S] = true,             
    [dsp.zone.THRONE_ROOM_S] = true,                   
    ...
    [dsp.zone.GARLAIGE_CITADEL_S] = true,              
    ...
    [dsp.zone.WALK_OF_ECHOES] = true,                  
    [dsp.zone.MAQUETTE_ABDHALJS_LEGION] = true,        
    ...
    [dsp.zone.RESIDENTIAL_AREA] = true,                
    [dsp.zone.ABYSSEA_ATTOHWA] = true,                 
    [dsp.zone.ABYSSEA_MISAREAUX] = true,               
    [dsp.zone.ABYSSEA_VUNKERL] = true,                 
    [dsp.zone.ABYSSEA_ALTEPA] = true,                  
    [dsp.zone.RESIDENTIAL_AREA] = true,                
    [dsp.zone.SHIP_BOUND_FOR_SELBINA] = true,          
    [dsp.zone.SHIP_BOUND_FOR_MHAURA] = true,           
    [dsp.zone.PROVENANCE] = true,                      
