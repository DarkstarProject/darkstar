...
zones[dsp.zone.ABYSSEA_KONSCHTAT] =
{
    text =
    {
        ...
        STAGGERED               = 7315, -- <name>'s attack staggers the fiend!
        ...
        YELLOW_WEAKNESS         = 7319, -- The fiend appears vulnerable to [/fire/ice/wind/earth/lightning/water/light/darkness] elemental magic!
        BLUE_WEAKNESS           = 7320, -- The fiend appears vulnerable to [/hand-to-hand/dagger/sword/great sword/axe/great axe/scythe/polearm/katana/great katana/club/staff/archery/marksmanship] weapon skills!
        RED_WEAKNESS            = 7321, -- The fiend appears vulnerable to [/fire/ice/wind/earth/lightning/water/light/darkness] elemental weapon skills!
        EXACT_TIME_REMAINING    = 7322, -- Your visitant status will wear off in <number> [second/minute].
        TIME_REMAINING          = 7323, -- Your visitant status will wear off in <number> [seconds/minutes].
        LOST_VISITANT_STATUS    = 7324, -- Your visitant status has worn off.
        VISITANT_EXTENDED       = 7325, -- Your visitant status has been extended by <number> [minute/minutes].
        EXIT_WARNING_1          = 7326, -- Exiting in <number> [minute/minutes].
        EXIT_WARNING_2          = 7327, -- Those without visitant status will be ejected from the area in <number> [minute/minutes]. To learn about this status, please consult a Conflux Surveyor.
        EXIT_WARNING_3          = 7328, -- Exiting in <number> [second/minute].
        EXIT_WARNING_4          = 7329, -- Exiting in <number> [seconds/minutes].
        EXITING_NOW             = 7330, -- Exiting now.
        WARD_WARNING_1          = 7331, -- Returning to the Searing Ward in <number> [second/seconds].
        WARD_WARNING_2          = 7332, -- You do not have visitant status. Returning to the Searing Ward in <number> [second/seconds].
        WARD_WARNING_3          = 7333, -- Returning to the Searing Ward in <number> [second/seconds].
        ...
        INFO_KI                 = 7572, -- Your keen senses tell you that something may happen if only you had [this item/these items].
        USE_KI                  = 7575, -- Use the [key item/key items]? Yes. No.
    },
    mob =
    {
    },
