...
function onEventFinish(player,csid,option)
    ...
    elseif (option == 393220) then -- HP Boost
        player:addStatusEffectEx(EFFECT.ABYSSEA_HP,EFFECT_MAX_HP_BOOST,20+(getAbyssiteTotal(player,"MERIT") *10),0,0);
        player:addHP(20+(getAbyssiteTotal(player,"MERIT") *10) *10);
        player:delCurrency("cruor", 50);
    elseif (option == 458756) then -- MP Boost
        player:addStatusEffectEx(EFFECT.ABYSSEA_MP,EFFECT_MAX_MP_BOOST,10+(getAbyssiteTotal(player,"MERIT") *5),0,0);
        player:addMP(10+(getAbyssiteTotal(player,"MERIT") *5) *10);
        player:delCurrency("cruor", 120);
    elseif (option == 524292) then -- STR-DEX Boost
        player:addStatusEffectEx(EFFECT.ABYSSEA_STR,EFFECT_STR_BOOST,10+(getAbyssiteTotal(player,"FURTHERANCE") *10),0,0);
        player:addStatusEffectEx(EFFECT.ABYSSEA_DEX,EFFECT_DEX_BOOST,10+(getAbyssiteTotal(player,"FURTHERANCE") *10),0,0);
        player:delCurrency("cruor", 120);
    elseif (option == 589828) then -- VIT-AGI Boost
        player:addStatusEffectEx(EFFECT.ABYSSEA_VIT,EFFECT_VIT_BOOST,10+(getAbyssiteTotal(player,"FURTHERANCE") *10),0,0);
        player:addStatusEffectEx(EFFECT.ABYSSEA_AGI,EFFECT_AGI_BOOST,10+(getAbyssiteTotal(player,"FURTHERANCE") *10),0,0);
        player:delCurrency("cruor", 100);
    elseif (option == 655364) then -- INT-MND-CHR Boost
        player:addStatusEffectEx(EFFECT.ABYSSEA_INT,EFFECT_INT_BOOST,10+(getAbyssiteTotal(player,"FURTHERANCE") *10),0,0);
        player:addStatusEffectEx(EFFECT.ABYSSEA_MND,EFFECT_MND_BOOST,10+(getAbyssiteTotal(player,"FURTHERANCE") *10),0,0);
        player:addStatusEffectEx(EFFECT.ABYSSEA_CHR,EFFECT_CHR_BOOST,10+(getAbyssiteTotal(player,"FURTHERANCE") *10),0,0);
        player:delCurrency("cruor", 100);
