...
--[[
    if (trade:hasItemQty(2917,1) and trade:getItemCount() == 1) then -- Player has all the required items.
...
function onTrigger(player,npc)
    player:startEvent(1010, 2917); -- Inform payer what items they need.
end;
