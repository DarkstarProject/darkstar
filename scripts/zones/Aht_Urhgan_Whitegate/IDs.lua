...
zones[dsp.zone.AHT_URHGAN_WHITEGATE] =
{
    text =
    {
        ITEM_CANNOT_BE_OBTAINEDX      = 222, -- You cannot obtain the ?Possible Special Code: 01??Possible Special Code: 05?#?BAD CHAR: 8280??BAD CHAR: 80??BAD CHAR: 80?. Try trading again after sorting your inventory.?Prompt?
        ...
        ITEM_OBTAINEDX                = 1496, -- You obtain ?Numeric Parameter 1? ?Possible Special Code: 01??Speaker Name?)??BAD CHAR: 80??BAD CHAR: 80??BAD CHAR: 8280??BAD CHAR: 80??BAD CHAR: 80?!?Prompt?
        ...
        ITEM_CANNOT_BE_OBTAINED       = 9523, -- You cannot obtain the item. Come back after sorting your inventory.?Prompt?
        ...
        AUTOMATON_ATTACHMENT_UNLOCK   = 9647, -- You can now equip your automaton with
