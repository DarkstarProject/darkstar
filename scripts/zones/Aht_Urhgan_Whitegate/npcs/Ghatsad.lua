...
function onTrigger(player,npc)
    ...
    elseif (NoStringsAttached == QUEST_COMPLETED and attachments == 0 and attachmentStatus == 0 and player:getMainJob() == dsp.jobs.PUP and player:getMainLvl() >= 10) then
    ...
    elseif (NoStringsAttached == QUEST_COMPLETED and attachments == 1 and attachmentStatus == 0 and player:getMainJob() == dsp.jobs.PUP and player:getMainLvl() >= 20) then
    ...
    elseif (NoStringsAttached == QUEST_COMPLETED and attachments == 2 and attachmentStatus == 0 and player:getMainJob() == dsp.jobs.PUP and player:getMainLvl() >= 30) then
    ...
    elseif (NoStringsAttached == QUEST_COMPLETED and attachments == 3 and attachmentStatus == 0 and player:getMainJob() == dsp.jobs.PUP and player:getMainLvl() >= 40) then
        player:startEventString(900, automatonName, automatonName, automatonName, automatonName, 0, 0, 0, 0, 0, 2186, 2);
    elseif (NoStringsAttached == QUEST_COMPLETED and attachments == 4 and attachmentStatus == 0 and player:getMainJob() == dsp.jobs.PUP and player:getMainLvl() >= 50) then
