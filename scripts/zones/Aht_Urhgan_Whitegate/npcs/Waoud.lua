...
function onTrigger(player,npc)
    ...
    elseif (beginnings == QUEST_ACCEPTED) then
        local brand1 = player:hasKeyItem(dsp.kis.BRAND_OF_THE_SPRINGSERPENT);
        local brand2 = player:hasKeyItem(dsp.kis.BRAND_OF_THE_GALESERPENT);
        local brand3 = player:hasKeyItem(dsp.kis.BRAND_OF_THE_FLAMESERPENT);
        local brand4 = player:hasKeyItem(dsp.kis.BRAND_OF_THE_SKYSERPENT);
        local brand5 = player:hasKeyItem(dsp.kis.BRAND_OF_THE_STONESERPENT);
