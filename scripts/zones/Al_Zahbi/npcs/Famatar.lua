...
function onTrigger(player,npc)
    ...
    if (merc_rank == 0) then
        ...
        player:startEvent(218,player:getCurrency("imperial_standing"),maps,merc_rank,0,x,y,z,w);
    end
end;

function onEventUpdate(player,csid,option)
    if (csid == 218 and option >= 1 and option <= 57345) then
