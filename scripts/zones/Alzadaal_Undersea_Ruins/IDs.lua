...
zones[dsp.zone.ALZADAAL_UNDERSEA_RUINS] =
{
    text =
    {
        ...
        IMPERIAL_CONTROL        = 7210, -- This gate guards and area under Imperial Control
        STAGING_POINT           = 7216, -- Nyzul Isle Staging Point
        CANNOT_LEAVE            = 7220, -- You cannot leave this area while in possession of 
