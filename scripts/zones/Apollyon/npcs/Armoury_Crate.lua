...
function onTrigger(player,npc)
 ...
 local  MimicID=0;
  ...
  for coffer = 1,table.getn (ARMOURY_CRATES_LIST_APPOLLYON),2 do
      if(ARMOURY_CRATES_LIST_APPOLLYON[coffer]== CofferID-16932865)then	  
 ...
 printf("CofferID : %u",CofferID-16932865);
 ...
 printf("lootID: %u",lootID);
	...
	elseif(CofferType == cMIMIC)then 
	     if(CofferID==16932865+210)then 
		    	GetNPCByID(16932865+195):setPos(npc:getXPos(),npc:getYPos(),npc:getZPos());
                GetNPCByID(16932865+195):setStatus(STATUS_NORMAL);
	     elseif(CofferID==16932865+211)then
	     ...
	     elseif(CofferID==16932865+212)then
		    	GetNPCByID(169328645+196):setPos(npc:getXPos(),npc:getYPos(),npc:getZPos());
	            GetNPCByID(16932865+196):setStatus(STATUS_NORMAL);
	     elseif(CofferID==16932865+213)then
	     ...
	     elseif(CofferID==16932865+214)then
		    	GetNPCByID(16932865+197):setPos(npc:getXPos(),npc:getYPos(),npc:getZPos());
	            GetNPCByID(16932865+197):setStatus(STATUS_NORMAL);
	     elseif(CofferID==16932865+215)then
	     ...
	     elseif(CofferID==16932865+216)then	
