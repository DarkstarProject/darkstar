...
-- Other Texts
            YOU_NO_REQS =  7894; -- You do not meet the requirements to enter the battlefield
        NOTHING_HAPPENS =   119; -- Nothing happens...
               RESPONSE =  7328; -- There is no response...
         DOOR_IS_LOCKED = 40225; -- The door is locked. You might be able to open it with a <item>.
        DOOR_IS_LOCKED2 = 40226; -- The door is locked. You might be able to open it with a <item> or a <item>.
             KEY_BREAKS = 40227; -- The <item> breaks.
           LOCK_SUCCESS = 40231; -- <player> successfully opened the lock with the <item>!
              LOCK_FAIL = 40232; -- <player> failed to open the lock with the <item>...
