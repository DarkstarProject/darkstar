...
-- Other Texts
        ...
        NOTHING_HAPPENS =  119 -- Nothing happens...
         ...
         DOOR_IS_LOCKED = 7457 -- The door is locked. You might be able to open it with a <item>
        DOOR_IS_LOCKED2 = 7458 -- The door is locked. You might be able to open it with a <item>
             KEY_BREAKS = 7459 -- The <item> breaks.
           LOCK_SUCCESS = 7463 -- <player> successfully opened the lock with the <item>!
              LOCK_FAIL = 7464 -- <player> failed to open the lock with the <item>...
