...
function afterInstanceRegister(player)
    ...
    player:addStatusEffectEx(EFFECT.ENCUMBRANCE_I, EFFECT_ENCUMBRANCE_I, 0xFFFF, 0, 0)
    player:addStatusEffectEx(EFFECT.OBLIVISCENCE, EFFECT_OBLIVISCENCE, 0, 0, 0)
    player:addStatusEffectEx(EFFECT.OMERTA, EFFECT_OMERTA, 0, 0, 0)
    player:addStatusEffectEx(EFFECT.IMPAIRMENT, EFFECT_IMPAIRMENT, 0, 0, 0)
    player:addStatusEffectEx(EFFECT.DEBILITATION, EFFECT_DEBILITATION, 0x1FF, 0, 0)
    for i = 0,15 do
