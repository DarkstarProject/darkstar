...
function onEventFinish(player,csid,option)
    if (csid == 139 and option == 1) then
        ...
        player:addQuest(CRYSTAL_WAR,dsp.quests.ids.crystalWar.THE_FIGHTING_FOURTH);
    ...
    elseif (csid == 140 and option == 1) then
        ...
        player:delQuest(CRYSTAL_WAR, dsp.quests.ids.crystalWar.THE_FIGHTING_FOURTH);
    ...
    elseif (csid == 143) then
        ...
        if (player:getVar("Campaign_Nation") == 0) then
            if (player:getFreeSlotsCount() >= 1) then
                ...
                player:completeQuest(CRYSTAL_WAR,dsp.quests.ids.crystalWar.THE_FIGHTING_FOURTH);
