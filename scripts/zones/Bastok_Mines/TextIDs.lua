...
-- Dynamis dialogs
      YOU_CANNOT_ENTER_DYNAMIS = 11724 -- You cannot enter Dynamis
PLAYERS_HAVE_NOT_REACHED_LEVEL = 11726 -- Players who have not reached levelare prohibited from entering Dynamis.
...
-- Dialog Texts
               HEMEWMEW_DIALOG =  7059 -- I have been appointed by the Guildworkers' Union to manage the trading of manufactured crafts and the exchange of guild points.
              VIRNAGE_DIALOG_1 = 10981 -- They stayed in a citadel on the Sauromugue Champaign. The paint may be there still!
...
-- Harvest Festival
               ...
               THANK_YOU_TREAT = 11686 -- And now for your treat...
...
-- Shop Texts
         FAUSTIN_CLOSED_DIALOG = 10778 -- I'm trying to start a business selling goods from Ronfaure,
      RODELLIEUX_CLOSED_DIALOG = 10779 -- I'm trying to start a business selling goods from Fauregandi,
           MILLE_CLOSED_DIALOG = 10780 -- I'm trying to start a business selling goods from Norvallen,
         TIBELDA_CLOSED_DIALOG = 10781 -- I'm trying to start a business selling goods from Valdeaunia,
          GALDEO_CLOSED_DIALOG = 10782 -- I'm trying to start a business selling goods from Li'Telor,
          ...
          ZEMEDARS_SHOP_DIALOG = 10900 -- Everything in our store is top-grade and Galka-made! What're you lookin' for?
             BOYTZ_SHOP_DIALOG = 12411 -- Welcome to Boytz's Knickknacks.
          GELZERIO_SHOP_DIALOG = 12402 -- ...Yes?
        ...
        RODELLIEUX_OPEN_DIALOG = 10907 -- Hello there! Might I interest you specialty goods from Fauregandi?
         ...
         AULAVIA_CLOSED_DIALOG = 11472 -- I'm trying to start a business selling goods from Vollbow,
