...
Fallen = player:getQuestStatus(BASTOK,dsp.quests.ids.bastok.FALLEN_COMRADES);
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 90) then
        player:addQuest(BASTOK,dsp.quests.ids.bastok.FALLEN_COMRADES);
    elseif (csid == 91) then
        player:completeQuest(BASTOK,dsp.quests.ids.bastok.FALLEN_COMRADES);
