...
-- Quest Dialog
      LOCKED_DOOR_QUADAV_HAS_KEY = 7175; -- It is locked tight, but has what looks like a keyhole. Maybe one of the Quadav here has the key.
         NOTHING_OUT_OF_ORDINARY = 7660; -- There is nothing out of the ordinary here.
YOU_CAN_NOW_BECOME_A_DARK_KNIGHT = 7312; -- You can now become a dark knight!
