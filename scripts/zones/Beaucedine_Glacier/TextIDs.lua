...
-- Dynamis dialogs
	   YOU_CANNOT_ENTER_DYNAMIS = 7790; -- You cannot enter Dynamis - Bastok for x day (Vana'diel time)
 PLAYERS_HAVE_NOT_REACHED_LEVEL = 7792; -- Players who have not reached level <number> are prohibited from entering Dynamis.
UNUSUAL_ARRANGEMENT_OF_BRANCHES = 7802; -- There is an unusual arrangement of branches here.