...
-- ZM4 Dialog
       SOMETHING_BETTER = 7313; -- Don't you have something better to do right now?
     CANNOT_REMOVE_FRAG = 7316; -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...?Prompt?
  ALREADY_OBTAINED_FRAG = 7317; -- You have already obtained this monument's
        FOUND_ALL_FRAGS = 7319; -- You have obtained ! You now have all 8 fragments of light!
        ZILART_MONUMENT = 7320; -- It is an ancient Zilart monument.?Prompt?
