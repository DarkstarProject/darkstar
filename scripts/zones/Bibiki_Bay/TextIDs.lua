...
-- Dialogs
 MEP_NHAPOPOLUKO_DIALOG = 7197; -- Welcome! Fishermen's Guild representative, at your service!?Prompt?
NOTHING_OUT_OF_ORDINARY = 6395; -- There is nothing out of the ordinary here.

-- Manaclipper
  NO_BILLET = 7451; -- You were refused passage for failing to present
HAVE_BILLET = 7456; -- You cannot buy morrre than one . Use the one you have now to ride the next ship.
