...
ITEM_CANNOT_BE_OBTAINED = 6379; -- You cannot obtain the item <item>. Come back after sorting your inventory.
 ...
 FISHING_MESSAGE_OFFSET = 7036; -- You can't fish here.
			HOMEPOINT_SET = 8955; -- Home point set!

-- Logging
LOGGING_IS_POSSIBLE_HERE = 7325; -- Logging is possible here if you have
...
-- Other Texts
               RESPONSE = 7311; -- There is no response...
NOTHING_OUT_OF_ORDINARY = 7363; --There is nothing out of the ordinary here.
        NOTHING_HAPPENS = 7431; -- Nothing happens...

 JAZARAATS_HEADSTONE = 7505; -- The name ir Jazaraat is engraved on the headstone... 
SEAPRINCES_TOMBSTONE = 8029; -- It appears to be the grave of a great soul to an age long past.
