...
-- Logging
LOGGING_IS_POSSIBLE_HERE = 7342; -- Logging is possible here if you have
...
-- Other Texts
 ...
 NOTHING_OUT_OF_ORDINARY = 7380; --There is nothing out of the ordinary here.
         NOTHING_HAPPENS = 7448; -- Nothing happens...
     JAZARAATS_HEADSTONE = 7523; -- The name “Sir Jazaraat�? is engraved on the headstone...≺Prompt≻
