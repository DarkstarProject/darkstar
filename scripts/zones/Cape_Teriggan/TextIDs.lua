...
FULL_INVENTORY_AFTER_TRADE =  6385 -- You cannot obtain the #. Try trading again after sorting your inventory.
          ...
          KEYITEM_OBTAINED =  6390 -- Obtained key item: <keyitem>.
            ITEMS_OBTAINED =  7706 -- You obtain
...
-- Other dialog
   NOTHING_OUT_OF_ORDINARY =  7686 -- There is nothing out of the ordinary here.
...
-- ZM4 Dialog
     ...
     ALREADY_OBTAINED_FRAG =  7665 -- You have already obtained this monument's . Try searching for another.
