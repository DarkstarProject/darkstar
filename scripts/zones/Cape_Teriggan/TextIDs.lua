...
FULL_INVENTORY_AFTER_TRADE = 6382; -- You cannot obtain the #. Try trading again after sorting your inventory.
    ...
    FISHING_MESSAGE_OFFSET = 7541; -- You can't fish here.
            HOMEPOINT_SET = 11230; -- Home point set!
...
-- ZM4 Dialog
   CANNOT_REMOVE_FRAG = 7651; -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
ALREADY_OBTAINED_FRAG = 7652; -- You have already obtained this monument's . Try searching for another.
      FOUND_ALL_FRAGS = 7653; -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
      ZILART_MONUMENT = 7655; -- It is an ancient Zilart monument.
