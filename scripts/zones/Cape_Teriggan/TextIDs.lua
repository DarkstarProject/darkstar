...
-- ZM4 Dialog
   CANNOT_REMOVE_FRAG = 7631; -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
ALREADY_OBTAINED_FRAG = 7632; -- You have already obtained this monument's . Try searching for another.
      FOUND_ALL_FRAGS = 7633; -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
      ZILART_MONUMENT = 7635; -- It is an ancient Zilart monument.
