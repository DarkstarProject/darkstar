...
-- Logging
LOGGING_IS_POSSIBLE_HERE = 7345; -- Logging is possible here if you have <item>.

-- Shop Texts
BEUGUNGEL_SHOP_DIALOG = 7377; -- Hello, sir/ma'am! I'm selling goods direct from the Carpenters' Guild.
