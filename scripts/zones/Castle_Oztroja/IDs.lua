...
zones[dsp.zone.CASTLE_OZTROJA] =
{
    text =
    {
        ...
        FULL_INVENTORY_AFTER_TRADE         = 6570, -- You cannot obtain the #. Try trading again after sorting your inventory.
        ...
        ITEMS_OBTAINED                     = 6581, -- You obtain
        ...
        CHEST_FAIL                         = 7423, -- Fails to open the chest.
        ...
        CHEST_LOCKED                       = 7429, -- The chest appears to be locked.
        ...
        NOTHING_OUT_OF_ORDINARY            = 7782, -- There is nothing out of the ordinary here.
    },
    mob =
    {
