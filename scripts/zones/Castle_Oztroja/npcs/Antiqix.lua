...
local maps = {
    [dsp.kis.MAP_OF_DYNAMIS_SANDORIA]   = 10000,
    [dsp.kis.MAP_OF_DYNAMIS_BASTOK]     = 10000,
    [dsp.kis.MAP_OF_DYNAMIS_WINDURST]   = 10000,
    [dsp.kis.MAP_OF_DYNAMIS_JEUNO]      = 10000,
    [dsp.kis.MAP_OF_DYNAMIS_BEAUCEDINE] = 15000,
    [dsp.kis.MAP_OF_DYNAMIS_XARCABARD]  = 20000,
    [dsp.kis.MAP_OF_DYNAMIS_VALKURM]    = 10000,
    [dsp.kis.MAP_OF_DYNAMIS_BUBURIMU]   = 10000,
    [dsp.kis.MAP_OF_DYNAMIS_QUFIM]      = 10000,
    [dsp.kis.MAP_OF_DYNAMIS_TAVNAZIA]   = 20000,
}
-----------------------------------
...
function onTrade(player,npc,trade)
    ...
    if (player:hasKeyItem(dsp.kis.VIAL_OF_SHROUDED_SAND)) then

        -- buy prismatic hourglass
        if (gil == PRISMATIC_HOURGLASS_COST and count == 1 and not player:hasKeyItem(dsp.kis.PRISMATIC_HOURGLASS)) then
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 54) then
        ...
        player:addKeyItem(dsp.kis.PRISMATIC_HOURGLASS);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.kis.PRISMATIC_HOURGLASS);
