...
-- Other Texts
YOU_CANNOT_ENTER_THE_BATTLEFIELD = 7197; -- You cannot enter the battlefield at present. Please wait a little longer.

-- Mission Texts
PLACED_INTO_THE_PEDESTAL = 7601; -- It appears that something should be placed into this pedestal.
           YOU_PLACE_THE = 7602; -- You place theinto the pedestal.
  IS_SET_IN_THE_PEDESTAL = 7603; -- Theis set in the pedestal.
      HAS_LOST_ITS_POWER = 7604; -- Thehas lost its power.
