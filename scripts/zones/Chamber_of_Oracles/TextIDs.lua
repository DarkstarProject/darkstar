...
PLACED_INTO_THE_PEDESTAL = 7616; -- It appears that something should be placed into this pedestal.
           YOU_PLACE_THE = 7617; -- You place theinto the pedestal.
  IS_SET_IN_THE_PEDESTAL = 7618; -- Theis set in the pedestal.
      HAS_LOST_ITS_POWER = 7619; -- Thehas lost its power.

-- Maat dialog
      YOU_DECIDED_TO_SHOW_UP = 7638; -- So, you decided to show up.
 LOOKS_LIKE_YOU_WERENT_READY = 7639; -- Looks like you weren't ready for me, were you?
       YOUVE_COME_A_LONG_WAY = 7640; -- Hm. That was a mighty fine display of skill there, Player Name. You've come a long way...
