...
-- General Texts
   ITEM_CANNOT_BE_OBTAINED =  6564; --Come back after sorting your inventory.
          ...
          KEYITEM_OBTAINED =  6570; --Obtained key item: <<<Unknown Parameter (Type: 80) 1>>>.
              KEYITEM_LOST =  6571; --Lost key item: << >>.

-- Other Dialog
TOMBSTONE =  7116; --Here lies the beloved Queen Leaute.\nMay Her Majesty's soul find Paradise.

-- Mission dialog
HALVER_OFFSET =  6737; --The princess is always speaking of your deeds for the Kingdom. Everyone here is counting on you, <<<Player Name>>>.
