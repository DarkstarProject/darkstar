...
zones[dsp.zone.CLOISTER_OF_FLAMES] =
{
    text =
    {
        ...
        IFRIT_UNLOCKED                   = 7567, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
    },
    mob =
    {
    },
...
return zones[dsp.zone.CLOISTER_OF_FLAMES]