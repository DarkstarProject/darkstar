...
zones[dsp.zone.CLOISTER_OF_FROST] =
{
    text =
    {
        ...
        ALREADY_OBTAINED_FRAG            = 7662, -- You have already obtained this monument's <keyitem>. Try searching for another.
        ALREADY_HAVE_ALL_FRAGS           = 7663, -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS                  = 7664, -- You have obtained <keyitem>! You now have all 8 fragments of light!
