...
-- print("leave code "..leavecode);
    trialLightning = player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.TRIAL_SIZE_TRIAL_BY_LIGHTNING)
...
-- print("bc finish csid "..csid.." and option "..option);
    ...
    if (csid == 32001) then
        ...
        player:completeQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.TRIAL_SIZE_TRIAL_BY_LIGHTNING);
    end
