...
zones[dsp.zone.CLOISTER_OF_TIDES] =
{
    text =
    {
        ...
        LEVIATHAN_UNLOCKED               = 7567, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
    },
    mob =
    {
    },
...
return zones[dsp.zone.CLOISTER_OF_TIDES]