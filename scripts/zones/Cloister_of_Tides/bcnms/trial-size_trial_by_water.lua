...
-- print("leave code "..leavecode);
    trialLightning = player:getQuestStatus(OUTLANDS,dsp.quests.ids.outlands.TRIAL_SIZE_TRIAL_BY_WATER)
...
-- print("bc finish csid "..csid.." and option "..option);
    ...
    if (csid == 32001) then
        ...
        player:completeQuest(OUTLANDS,dsp.quests.ids.outlands.TRIAL_SIZE_TRIAL_BY_WATER);
    end
end;
