...
-- print("bc finish csid "..csid.." and option "..option);
    ...
    if (csid == 32001) then
        player:delKeyItem(dsp.kis.TUNING_FORK_OF_WATER);
        player:addKeyItem(dsp.kis.WHISPER_OF_TIDES);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.kis.WHISPER_OF_TIDES);
    end
