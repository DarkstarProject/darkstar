...
-- Quest Dialog
      ...
      NOTHING_WILL_HAPPEN_YET = 7228; -- It seems that nothing will happen yet.
      NOTHING_SEEMS_TO_HAPPEN = 7229; -- Nothing seems to happen.

                 YOU_BURY_THE = 7225; -- You <bury the old boot> and <crawler blood>.
SOMEONE_HAS_BEEN_DIGGING_HERE = 7222; -- Someone has been digging here.
EQUIPMENT_COMPLETELY_PURIFIED = 7223; -- Your equipment has not been completely purified.
