...
CHEST_UNLOCKED = 7240; -- You unlock the chest!
    CHEST_FAIL = 7241; -- Fails to open the chest.
    CHEST_TRAP = 7242; -- The chest was trapped!
    CHEST_WEAK = 7243; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7244; -- The chest was a mimic!
...
-- Quest Dialog
      ...
      NOTHING_WILL_HAPPEN_YET = 7254; -- It seems that nothing will happen yet.
      NOTHING_SEEMS_TO_HAPPEN = 7255; -- Nothing seems to happen.

SOMEONE_HAS_BEEN_DIGGING_HERE = 7248; -- Someone has been digging here.
EQUIPMENT_COMPLETELY_PURIFIED = 7249; -- Your equipment has not been completely purified.
                 YOU_BURY_THE = 7251; -- You bury the
