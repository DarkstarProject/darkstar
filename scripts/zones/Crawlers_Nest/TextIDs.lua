...
-- Quest Dialog
      ...
      NOTHING_WILL_HAPPEN_YET = 7259; -- It seems that nothing will happen yet.
      NOTHING_SEEMS_TO_HAPPEN = 7260; -- Nothing seems to happen.

SOMEONE_HAS_BEEN_DIGGING_HERE = 7253; -- Someone has been digging here.
EQUIPMENT_COMPLETELY_PURIFIED = 7254; -- Your equipment has not been completely purified.
                 YOU_BURY_THE = 7256; -- You bury the
