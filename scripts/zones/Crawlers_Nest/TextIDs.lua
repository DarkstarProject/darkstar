...
-- Quest Dialog
      ...
      NOTHING_WILL_HAPPEN_YET = 7252; -- It seems that nothing will happen yet.
      NOTHING_SEEMS_TO_HAPPEN = 7253; -- Nothing seems to happen.

SOMEONE_HAS_BEEN_DIGGING_HERE = 7246; -- Someone has been digging here.
EQUIPMENT_COMPLETELY_PURIFIED = 7247; -- Your equipment has not been completely purified.
                 YOU_BURY_THE = 7249; -- You bury the
