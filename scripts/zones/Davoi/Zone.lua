...
function onZoneIn(player,prevZone)
    ...
    if player:getQuestStatus(SANDORIA,dsp.quests.ids.sandoria.THE_CRIMSON_TRIAL) == QUEST_ACCEPTED and not GetMobByID(ID.mob.PURPLEFLASH_BRUKDOK):isSpawned() then
