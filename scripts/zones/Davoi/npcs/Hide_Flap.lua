...
function onTrigger(player,npc)
    ...
    -- THE DOORMAN
    if offset == 0 and player:getQuestStatus(BASTOK, dsp.quests.ids.bastok.THE_DOORMAN) == QUEST_ACCEPTED and not player:hasKeyItem(dsp.ki.SWORD_GRIP_MATERIAL) then
    ...
    -- THE FIRST MEETING
    elseif offset == 1 and player:getQuestStatus(BASTOK, dsp.quests.ids.bastok.THE_FIRST_MEETING) == QUEST_ACCEPTED and not player:hasKeyItem(dsp.ki.SANDORIAN_MARTIAL_ARTS_SCROLL) then
