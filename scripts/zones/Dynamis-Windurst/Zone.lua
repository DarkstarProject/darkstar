...
function onZoneIn(player,prevZone)
	...
	if((dynaWaitxDay + (BETWEEN_2DYNA_WAIT_TIME * 60 * 60)) < realDay or (dynaWaitxDay == realDay and player:getVar("DynamisID") == GetServerVariable("[DynaWindurst]UniqueID"))) then
