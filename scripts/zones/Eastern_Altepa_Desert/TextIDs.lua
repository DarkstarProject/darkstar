...
ITEM_CANNOT_BE_OBTAINED = 6376; -- You cannot obtain the item <item>. Come back after sorting your inventory.
 ...
 FISHING_MESSAGE_OFFSET = 7516; -- You can't fish here.
  ALREADY_OBTAINED_TELE = 7617; -- You already possess the gate crystal for this telepoint.
...
NOTHING_OUT_OF_ORDINARY = 7623; -- There is nothing out of the ordinary here.
