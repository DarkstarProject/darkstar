...
ITEM_CANNOT_BE_OBTAINED = 6379; -- You cannot obtain the item <item>. Come back after sorting your inventory.
 ...
 FISHING_MESSAGE_OFFSET = 7541; -- You can't fish here.
  ALREADY_OBTAINED_TELE = 7645; -- You already possess the gate crystal for this telepoint.
...
NOTHING_OUT_OF_ORDINARY = 7651; -- There is nothing out of the ordinary here.

-- conquest Base
CONQUEST_BASE = 7040; -- Tallying conquest results...

--chocobo digging
DIG_THROW_AWAY = 7554; -- You dig up$, but your inventory is full. You regretfully throw the # away.
