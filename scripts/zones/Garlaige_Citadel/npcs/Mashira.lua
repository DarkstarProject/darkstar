...
function onTrigger(player,npc)
    if (player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.RUBBISH_DAY) == QUEST_ACCEPTED and player:getVar("RubbishDayVar") == 0) then
...
RubbishDay = player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.RUBBISH_DAY);
