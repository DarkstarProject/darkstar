...
-- Harvesting
HARVESTING_IS_POSSIBLE_HERE = 7394; -- Harvesting is possible here if you have

-- Quest Dialog
        SENSE_OF_FOREBODING = 6402; -- You are suddenly overcome with a sense of foreboding...
    NOTHING_OUT_OF_ORDINARY = 7307; -- There is nothing out of the ordinary here.
...
-- Treasure Coffer/Chest Dialog
             CHEST_UNLOCKED = 7386; -- You unlock the chest!
                 CHEST_FAIL = 7387; -- Fails to open the chest.
             ...
             CHEST_ILLUSION = 7392; -- The chest was but an illusion...
               CHEST_LOCKED = 7393; -- The chest appears to be locked.
