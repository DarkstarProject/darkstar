...
-- Harvesting
HARVESTING_IS_POSSIBLE_HERE = 7365; -- Harvesting is possible here if you have

-- Quest Dialog
    SENSE_OF_FOREBODING = 6396; -- You are suddenly overcome with a sense of foreboding...
NOTHING_OUT_OF_ORDINARY = 7278; -- There is nothing out of the ordinary here.
         SPRING_FILL_UP = 7324; -- You fill your flask with water.
         SPRING_DEFAULT = 7325; -- Sparkling clear water bubbles up from the ground. If you have a container, you can fill it here.
