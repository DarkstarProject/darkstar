...
-- Harvesting
HARVESTING_IS_POSSIBLE_HERE = 7350; -- Harvesting is possible here if you have <item>.

-- Quest Dialog
    SENSE_OF_FOREBODING = 6393; -- You are suddenly overcome with a sense of foreboding...
NOTHING_OUT_OF_ORDINARY = 7263; -- There is nothing out of the ordinary here.
         SPRING_FILL_UP = 7309; -- You fill your flask with water.
         SPRING_DEFAULT = 7310; -- Sparkling clear water bubbles up from the ground. If you have a container, you can fill it here.
