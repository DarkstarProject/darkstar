...
-- Mining
MINING_IS_POSSIBLE_HERE = 7921; -- Mining is possible here if you have

-- Other Texts
        NOTHING_HAPPENS = 7896; -- Nothing happens...
            BLUE_FLAMES = 7960; -- You can see blue flames flickering from a hole in the ground here...
