...
-- General Texts
   ITEM_CANNOT_BE_OBTAINED = 7120; -- Come back after sorting your inventory.
             ITEM_OBTAINED = 7123; -- Obtained:
              GIL_OBTAINED = 7124; -- Obtained <<<Numeric Parameter 0>>> gil.
          KEYITEM_OBTAINED = 7126; -- Obtained key item: <<<Unknown Parameter (Type: 80) 1>>>.
    FISHING_MESSAGE_OFFSET = 7345; -- You can't fish here.
