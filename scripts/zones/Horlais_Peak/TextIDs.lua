...
-- General Texts
  ...
  FULL_INVENTORY_AFTER_TRADE = 6385; -- You cannot obtain the #. Try trading again after sorting your inventory.
            ...
            KEYITEM_OBTAINED = 6390; -- Obtained key item: <keyitem>.
              ITEMS_OBTAINED = 7766; -- You obtain

     NOTHING_OUT_OF_ORDINARY = 7747; -- There is nothing out of the ordinary here.

-- Maat dialog
      YOU_DECIDED_TO_SHOW_UP = 7740; -- So, you decided to show up.
 LOOKS_LIKE_YOU_WERENT_READY = 7741; -- Looks like you weren't ready for me, were you?
       YOUVE_COME_A_LONG_WAY = 7742; -- Hm. That was a mighty fine display of skill there, Player Name. You've come a long way...
