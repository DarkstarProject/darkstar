...
ALTAR_COMPLETED = 7201; -- You have already made an offering today.
  ALTAR_INSPECT = 7202; -- This looks like the altar where offerings are to be placed.
 ALTAR_OFFERING = 7203; -- You place your offering of <item> on the altar.
 ALTAR_STANDARD = 7204; -- It is an altar for offerings.
