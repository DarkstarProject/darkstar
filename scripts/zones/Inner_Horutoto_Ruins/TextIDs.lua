...
ITEM_CANNOT_BE_OBTAINED = 6547; -- You cannot obtain the item <item>. Come back after sorting your inventory.
       ...
       KEYITEM_OBTAINED = 6553; -- Obtained key item: <keyitem>.
         NOT_BROKEN_ORB = 7209; -- The Mana Orb in this receptacle is not broken.
    EXAMINED_RECEPTACLE = 7210; -- You have already examined this receptacle.
     DOOR_FIRMLY_CLOSED = 7237; -- The door is firmly closed.
