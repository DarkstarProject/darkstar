...
CHEST_UNLOCKED = 7335; -- You unlock the chest!
    CHEST_FAIL = 7336; -- Fails to open the chest.
    CHEST_TRAP = 7337; -- The chest was trapped!
    CHEST_WEAK = 7338; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7339; -- The chest was a mimic!
  CHEST_MOOGLE = 7340; -- You cannot open the chest while participating in the moogle event.
CHEST_ILLUSION = 7341; -- The chest was but an illusion...
  CHEST_LOCKED = 7342; -- The chest appears to be locked.
