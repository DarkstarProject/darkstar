...
GHEMISENTERILO_SHOP_DIALOG = 9961; -- Can you really get everything that you want on the mainland?
 ...
 PAHYALOLOHOIV_SHOP_DIALOG = 10244; -- Nothing in this world is crrreated good or evil. However, evil can arrrise when something exists in a place where it did not originally belong.
 ...
 -- Quest Items
	SLAB_OF_ELSHIMO_MARBLE = 1146; -- Item of the quest "Missionary Man"
  SCROLL_OF_TELEPORT_YHOAT = 4728; -- Reward of the quest "Missionary Man"