...
SOMETHING_BURIED_HERE = 7386; -- Something has been buried here.
         FIND_NOTHING = 7387; -- You thought you saw something, but find nothing.

      NOTHING_HAPPENS = 119;  -- Nothing happens...

     NOTHING_OUT_OF_ORDINARY = 6401; -- There is nothing out of the ordinary here.
TELEPOINT_HAS_BEEN_SHATTERED = 7475; -- The telepoint has been shattered into a thousand pieces...
