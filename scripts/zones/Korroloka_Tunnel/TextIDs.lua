...
-- Mining
MINING_IS_POSSIBLE_HERE = 7284; -- Mining is possible here if you have

-- Quest dialog
NOTHING_OUT_OF_ORDINARY = 6396; -- There is nothing out of the ordinary here.
    SENSE_OF_BOREBODING = 6397; -- You are suddenly overcome with a sense of foreboding...

-- Other
MORION_WORM_1 = 7305; -- It appears to be a hole made by some kind of animal. Fragments of iron ore are scattered around the area...
