...
function onEventFinish(player,csid,option)
    ...
    if (csid == 32001) then
        if (player:getQuestStatus(OUTLANDS,dsp.quests.ids.outlands.DIVINE_MIGHT) == QUEST_ACCEPTED) then
        ...
        elseif (player:getQuestStatus(OUTLANDS,dsp.quests.ids.outlands.DIVINE_MIGHT_REPEAT) == QUEST_ACCEPTED and player:hasKeyItem(dsp.ki.MOONLIGHT_ORE) == true) then
