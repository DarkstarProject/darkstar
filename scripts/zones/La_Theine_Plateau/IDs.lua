...
zones[dsp.zone.LA_THEINE_PLATEAU] =
{
    text =
    {
        ...
        NOTHING_TO_REPORT            = 7386, -- Nothing to report.
        ...
        A_TIMELY_VISIT_1             = 7728, -- The suspect appears to have taken refuge within Ordelle's Caves.  We will follow our training drills and stick to our posts!
        A_TIMELY_VISIT_2             = 7729, -- Our rigorous training drills have shown their worth.  That preparation honed the skills we needed to handle the situation this day.
        A_TIMELY_VISIT_3             = 7730, -- Another suspect has been discovered in Ordelle's Caves!  We must be ready to move at a moment's notice!  Take care to stay out of our way.
        A_TIMELY_VISIT_4             = 7731, -- We have succeeded not once, but twice at capturing a suspected criminal.  I'm certain that this will be the site for developing even more effective training exercises in the future.
