...
zones[dsp.zone.LA_THEINE_PLATEAU] =
{
    text =
    {
        ...
        DIG_THROW_AWAY               = 7224, -- You dig up$, but your inventory is full. You regretfully throw the # away.
        ...
        FAURBELLANT_2                = 7424, -- Thank you for making such a long journey to bring this! May the Gates of Paradise open to all.
        FAURBELLANT_3                = 7425, -- Please deliver thatto the high priest in the San d'Oria Cathedral.
        ...
        ALREADY_OBTAINED_FRAG        = 7586, -- You have already obtained this monument's . Try searching for another.
        ALREADY_HAVE_ALL_FRAGS       = 7587, -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
        FOUND_ALL_FRAGS              = 7588, -- You have obtained ! You now have all 8 fragments of light!
