...
function onTrigger(player,npc)
    ...
    if (player:hasKeyItem(dsp.kis.HOLLA_GATE_CRYSTAL) == false) then
        player:addKeyItem(dsp.kis.HOLLA_GATE_CRYSTAL);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.kis.HOLLA_GATE_CRYSTAL);
    else
