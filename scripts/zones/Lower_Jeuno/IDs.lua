...
zones[dsp.zone.LOWER_JEUNO] =
{
    text =
    {
        ...
        GUIDE_STONE             = 7136, -- Up: Upper Jeuno (facing San d'Oria) Down: Port Jeuno (facing Windurst)
        ...
        PARIKE_PORANKE_DIALOG   = 8950, -- All these people running back and forth... There have to be a few that have munched down more mithkabobs than they can manage. (And if I don't hand in this report to the Orastery soon... Ulp!)
        ...
        PARIKE_PORANKE_6        = 8965, -- 's digestive magic skill rises 0.1 points.
        PARIKE_PORANKE_7        = 8966, -- 's digestive magic skill rises one level.
        ...
        PARIKE_PORANKE_13       = 8977, -- 's all in the name of science skill rises 0.1 points.
        PARIKE_PORANKE_14       = 8978, -- 's all in the name of science skill rises one level.
        ...
        RETRIEVE_DIALOG_ID      = 10182, -- You retrieve <item> from the porter moogle's care.
