...
function onTrigger(player,npc)
    ...
    saveTheClockTower = player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.SAVE_THE_CLOCK_TOWER);
...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 231) then
        ...
        player:completeQuest(JEUNO,dsp.quests.ids.jeuno.SAVE_THE_CLOCK_TOWER);
    end
end;
