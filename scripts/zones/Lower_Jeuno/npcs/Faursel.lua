...
function onTrade(player,npc,trade)
    ...
    local questStatus = player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.THE_ROAD_TO_AHT_URHGAN);
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 10062 and option == 1) then -- Offer Quest, First Dialog.
        player:addQuest(JEUNO,dsp.quests.ids.jeuno.THE_ROAD_TO_AHT_URHGAN);
    ...
    elseif (csid == 10068) then
        player:completeQuest(JEUNO,dsp.quests.ids.jeuno.THE_ROAD_TO_AHT_URHGAN);
