...
function onTrade(player,npc,trade)
    local theOldMonument = player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.THE_OLD_MONUMENT)
...
function onEventFinish(player,csid,option)
    ...
    elseif csid == 101 then
        ...
        player:completeQuest(JEUNO,dsp.quests.ids.jeuno.A_MINSTREL_IN_DESPAIR)
    ...
    elseif (csid == 137 or csid == 138) and option == 1 then
        player:addQuest(JEUNO,dsp.quests.ids.jeuno.PAINFUL_MEMORY)
    ...
    elseif csid == 139 then
        player:addQuest(JEUNO,dsp.quests.ids.jeuno.THE_CIRCLE_OF_TIME)
