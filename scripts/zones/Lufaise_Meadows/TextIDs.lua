...
-- Logging
LOGGING_IS_POSSIBLE_HERE = 7704; -- Logging is possible here if you have

-- Other Texts
 SURVEY_THE_SURROUNDINGS = 7711; -- You survey the surroundings but see nothing out of the ordinary.
      MURDEROUS_PRESENCE = 7712; -- Wait, you sense a murderous presence...!
   YOU_CAN_SEE_FOR_MALMS = 7713; -- You can see for malms in every direction.
