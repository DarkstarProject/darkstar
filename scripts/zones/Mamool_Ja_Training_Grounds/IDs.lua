...
zones[dsp.zone.MAMOOL_JA_TRAINING_GROUNDS] =
{
    text = {
        ...
        ASSAULT_11_START        = 7456, -- Commencing <assault>! Objective: Rescue the agent
        ASSAULT_12_START        = 7457, -- Commencing <assault>! Objective: Destroy the assassins
        ASSAULT_13_START        = 7458, -- Commencing <assault>! Objective: Defeat Sagelord Molaal Ja
        ASSAULT_14_START        = 7459, -- Commencing <assault>! Objective: Steal the supplies
        ASSAULT_15_START        = 7460, -- Commencing <assault>! Objective: Apprehend the spy
        ASSAULT_16_START        = 7461, -- Commencing <assault>! Objective: Recover the treasure
        ASSAULT_17_START        = 7462, -- Commencing <assault>! Objective: Annihilate the enemy
        ASSAULT_18_START        = 7463, -- Commencing <assault>! Objective: Neutralize the marids
        ASSAULT_19_START        = 7464, -- Commencing <assault>! Objective: Gather pathological data
        ASSAULT_20_START        = 7465, -- Commencing <assault>! Objective: Defeat Orochi
