...
-- Mission Dialogs
   ...
   ORIGINAL_MISSION_OFFSET  =    14; -- You can consult the ission section of the main menu to review your objectives. Speed and efficiency are your priorities. Dismissed. 
                  GOOD_LUCK =  7445; -- Good luck on your mission. Bastokers like to do things by the book, so stay out of trouble and follow their rules.
MISSION_DIALOG_CID_TO_AYAME =  7572; -- Give it to one of his Mythril Musketeers instead. Ayame and Naji should be on guard near the President's Office. Either one will do.
                 ITS_LOCKED =  7983; -- It's locked.
...
VICIOUS_EYE_SHOP_DIALOG =  8000; -- Hi. This is where blacksmiths buy what they need.
     AMULYA_SHOP_DIALOG =  8001; -- Hello. Welcome to the Blacksmiths' Guild shop.
       OLAF_SHOP_DIALOG =  8002; -- We sell items in the Gunpowder Room, too. What do you need?
      NOGGA_SHOP_DIALOG =  8003; -- I've got some items you won't find elsewhere!
     TOMASA_SHOP_DIALOG =  8004; -- This is the Craftsmen's Eatery. Make room for the next customer when you're done, all right?
