...
MISSION_DIALOG_CID_TO_AYAME =  7488; -- Give it to one of his Mythril Musketeers instead. Ayame and Naji should be on guard near the President's Office. Either one will do.
   ...
   EXTENDED_MISSION_OFFSET  =  8507; -- Go to Ore Street and talk to Medicine Eagle. He says he was there when the commotion started.
...
NOTHING_OUT_OF_ORDINARY =  6448; -- There is nothing out of the ordinary here.
     ...
     GLAROCIQUET_DIALOG =  8119; -- I am Speaker Name, a Temple Knight. I am one of the guards charged with overseeing San d'Oria's conquest campaign.
   LEXUN_MARIXUN_DIALOG =  8121; -- I am Speaker Name, a War Warlock. I am one of the guards charged with overseeing Windurst's conquest campaign.

-- Shop Texts
VICIOUS_EYE_SHOP_DIALOG =  7916; -- Hi. This is where blacksmiths buy what they need.
     AMULYA_SHOP_DIALOG =  7917; -- Hello. Welcome to the Blacksmiths' Guild shop.
       OLAF_SHOP_DIALOG =  7918; -- We sell items in the Gunpowder Room, too. What do you need?
      NOGGA_SHOP_DIALOG =  7919; -- I've got some items you won't find elsewhere!
     TOMASA_SHOP_DIALOG =  7920; -- This is the Craftsmen's Eatery. Make room for the next customer when you're done, all right?

  TAKIYAH_CLOSED_DIALOG =  9877; -- Maybe someday I'll be able to sell goods from Qufim Island... Someday...
    TAKIYAH_OPEN_DIALOG =  9878; -- Hey, it's your lucky day! I've got a fresh batch of goods straight from the island of Qufim!
