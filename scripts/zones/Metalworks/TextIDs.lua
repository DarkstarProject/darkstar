...
MISSION_DIALOG_CID_TO_AYAME =  7488; -- Give it to one of his Mythril Musketeers instead. Ayame and Naji should be on guard near the President's Office. Either one will do.
   ...
   EXTENDED_MISSION_OFFSET  =  8506; -- Go to Ore Street and talk to Medicine Eagle. He says he was there when the commotion started.
...
VICIOUS_EYE_SHOP_DIALOG =  7916; -- Hi. This is where blacksmiths buy what they need.
  ...
  TAKIYAH_CLOSED_DIALOG =  9876; -- Maybe someday I'll be able to sell goods from Qufim Island... Someday...
    TAKIYAH_OPEN_DIALOG =  9877; -- Hey, it's your lucky day! I've got a fresh batch of goods straight from the island of Qufim!
