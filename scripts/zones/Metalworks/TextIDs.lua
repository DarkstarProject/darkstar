...
-- General Texts
 ...
 FULL_INVENTORY_AFTER_TRADE =  6440 -- You cannot obtain the item <item>. Try trading again after sorting your inventory.
        ...
        NOT_HAVE_ENOUGH_GIL =  6447 -- You do not have enough gil.
           KEYITEM_OBTAINED =  6445 -- Obtained key item: <<<Unknown Parameter (Type: 80) 1>>>.
             ITEMS_OBTAINED =  6451 -- You obtain
           SMITHING_SUPPORT =  6859 -- Your ?Multiple Choice (Parameter 1)?[fishing/woodworking/smithing/goldsmithing/clothcraft/leatherworking/bonecraft/alchemy/cooking] skills went up ...
   GUILD_TERMINATE_CONTRACT =  6873 -- You have terminated your trading contract with the Multiple Choice (Parameter 1)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild and formed a new one with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
         GUILD_NEW_CONTRACT =  6881 -- You have formed a new trading contract with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
        NO_MORE_GP_ELIGIBLE =  6888 -- You are not eligible to receive guild points at this time
                GP_OBTAINED =  6893 -- Obtained: ?Numeric Parameter 0? guild points.
...
-- Other dialog
    NOTHING_OUT_OF_ORDINARY =  6456 -- There is nothing out of the ordinary here.
         GLAROCIQUET_DIALOG =  8209 -- I am Speaker Name, a Temple Knight. I am one of the guards charged with overseeing San d'Oria's conquest campaign.
       LEXUN_MARIXUN_DIALOG =  8211 -- I am Speaker Name, a War Warlock. I am one of the guards charged with overseeing Windurst's conquest campaign.
