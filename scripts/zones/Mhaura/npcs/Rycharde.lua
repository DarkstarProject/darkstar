...
function onTrade(player,npc,trade)
    ...
    if (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.RYCHARDE_THE_CHEF)== QUEST_ACCEPTED) then
    ...
    elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.WAY_OF_THE_COOK) == QUEST_ACCEPTED) then
    ...
    elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.UNENDING_CHASE) == QUEST_ACCEPTED) then
    ...
    elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_CLUE) == QUEST_ACCEPTED) then
        local count = trade:getItemCount();
    ...
    elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_BASICS) == QUEST_ACCEPTED) then
...
if (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.RYCHARDE_THE_CHEF)==QUEST_AVAILABLE) then
...
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.RYCHARDE_THE_CHEF)==QUEST_ACCEPTED) then
    player:startEvent(72); -- not done yet huh?
--------------------------------------------- quest WAY_OF_THE_COOK
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.WAY_OF_THE_COOK)==QUEST_AVAILABLE and player:getFameLevel(WINDURST)>2) then    -- quest WAY_OF_THE_COOK
...
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.UNENDING_CHASE)==QUEST_AVAILABLE and player:getFameLevel(WINDURST) > 2) then
...
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.HIS_NAME_IS_VALGEIR)==QUEST_AVAILABLE and player:getFameLevel(WINDURST)>2) then
...
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.HIS_NAME_IS_VALGEIR)==QUEST_ACCEPTED) then
...
---------------------------QUEST THE CLUE--------------------------------------------------------
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_CLUE)==QUEST_AVAILABLE and player:getFameLevel(WINDURST)>4) then
    if (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.EXPERTISE)==QUEST_COMPLETED) then
...
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_CLUE)==QUEST_ACCEPTED) then
    player:startEvent(85);-- third quest  comment no hurry
---------------------------QUEST THE Basics--------------------------------------------------------
elseif (player:getQuestStatus(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_BASICS)==QUEST_AVAILABLE and player:getFameLevel(WINDURST) > 4) then
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 70 or csid == 71) then  --accept quest 1
        ...
        if (option == 71 or option == 72) then    --70 = answer no  71 answer yes!
            player:addQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.RYCHARDE_THE_CHEF);
        end
    elseif (csid == 74) then   -- end quest 1 RYCHARDE_THE_CHEF
        ...
        player:completeQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.RYCHARDE_THE_CHEF);
    elseif (csid == 76) then  -- accept quest 2
        if (option == 74 ) then -- answer yes!
            ...
            player:addQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.WAY_OF_THE_COOK);
        end
    elseif (csid == 80) then  --end quest 2 WAY_OF_THE_COOK
        ...
        player:completeQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.WAY_OF_THE_COOK);
    ...
    elseif (csid == 82) then  -- accept quest 3 UNENDING_CHASE
        ...
        if (option == 77 ) then -- answer yes!
            player:addQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.UNENDING_CHASE);
        end
    ...
    elseif (csid == 83) then  -- end quest 3 UNENDING_CHASE
        ...
        player:completeQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.UNENDING_CHASE);
    elseif (csid == 86) then  -- accept quest 4 HIS_NAME_IS_VALGEIR
        if (option == 80 ) then -- answer yes!
            ...
            player:addQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.HIS_NAME_IS_VALGEIR);
        end
    elseif (csid == 88) then  -- end quest 4 his name is Valgeir
        ...
        player:completeQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.HIS_NAME_IS_VALGEIR);
    elseif (csid == 90 or csid == 91) then  --accept quest the clue
        player:setVar("QuestTheClueStatus_var",1);
        if (option == 83 ) then
            player:addQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_CLUE);
        end
    elseif (csid == 92) then   -- end quest THE CLUE
        ...
        player:completeQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_CLUE);
    elseif (csid == 94) then  --accept quest the basics
        if (option == 85 ) then
            ...
            player:addQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_BASICS);
        end
    elseif (csid == 96) then   -- end quest the basics
        ...
        if (player:getFreeSlotsCount() <= 1) then
            ...
            player:completeQuest(OTHER_AREAS_LOG,dsp.quests.ids.otherAreas.THE_BASICS);
        end
