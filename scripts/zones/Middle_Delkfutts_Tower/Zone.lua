...
function onEventFinish(player,csid,option)
    ...
    -- BLADE OF EVIL
    elseif ( csid == 14 and option == 0 and npcUtil.completeQuest(player, BASTOK, BLADE_OF_EVIL, {item=12516, title=dsp.titles.PARAGON_OF_DARK_KNIGHT_EXCELLENCE, fame=AF3_FAME}) ) then
