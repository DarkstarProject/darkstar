...
CHEST_UNLOCKED = 7256; -- You unlock the chest!
    CHEST_FAIL = 7257; -- Fails to open the chest.
    CHEST_TRAP = 7258; -- The chest was trapped!
    CHEST_WEAK = 7259; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7260; -- The chest was a mimic!
  CHEST_MOOGLE = 7261; -- You cannot open the chest while participating in the moogle event.
CHEST_ILLUSION = 7262; -- The chest was but an illusion...
  CHEST_LOCKED = 7263; -- The chest appears to be locked.
