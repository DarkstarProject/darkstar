...
ITEM_CANNOT_BE_OBTAINED = 6540; -- You cannot obtain the item <item>. Come back after sorting your inventory.
       ...
       KEYITEM_OBTAINED = 6549; -- Obtained key item: <keyitem>.
              ...
              NO_ESCAPE = 7207; -- Any attempt at escape is futile!
  PROHIBITED_ACTIVITIES = 7223; -- Your character has been jailed due to prohibited activities. Your account will soon be suspended due to this violation.
