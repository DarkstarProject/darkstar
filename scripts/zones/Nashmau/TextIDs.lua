...
-- Shop Texts
  CHICHIROON_SHOP_DIALOG = 0;
   JAJAROONT_SHOP_DIALOG = 10397; -- Hellooo. Yooo have caaard? Can do gaaame? Jajaroon have diiice.
    MAMAROON_SHOP_DIALOG = 0;
    PIPIROON_SHOP_DIALOG = 0;
    POPOROON_SHOP_DIALOG = 0;
WATAKHAMAZOM_SHOP_DIALOG = 0;
    YOYOROON_SHOP_DIALOG = 0;
