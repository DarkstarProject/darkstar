...
function onTrade(player,npc,trade)
    ...
    if (player:getQuestStatus(AHT_URHGAN,dsp.quests.ids.ahtUrhgan.RAT_RACE) == QUEST_ACCEPTED and player:getVar("ratraceCS") == 5) then
...
function onTrigger(player,npc)
    ...
    elseif (player:getQuestStatus(AHT_URHGAN,dsp.quests.ids.ahtUrhgan.RAT_RACE) == QUEST_COMPLETED) then
