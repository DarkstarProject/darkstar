...
zones[dsp.zone.NEWTON_MOVALPOLOS] =
{
    text =
    {
        ...
        SHOWMAN_DECLINE         = 7263, -- ... Me no want that. Thing me want not here! It not being here!!!
        SHOWMAN_TRIGGER         = 7264, -- Hey, you there! Muscles nice. You want fight strong one? It cost you. Give me nice item.
        SHOWMAN_ACCEPT          = 7265, -- Fhungaaa!!! The freshyness, the flavoryness! This very nice item! Good luck, then. Try not die. One...two...four...FIIIIIIGHT!!!
        HOMEPOINT_SET           = 7268, -- Home point set!
    },
    mob =
    {
        MIMIC                = 16826564,
