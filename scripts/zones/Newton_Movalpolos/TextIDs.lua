...
-- Mining
MINING_IS_POSSIBLE_HERE = 7213; -- Mining is possible here if you have

-- Treasure Coffer/Chest Dialog
CHEST_UNLOCKED = 7227; -- You unlock the chest!
    CHEST_FAIL = 7228; -- Fails to open the chest.
    CHEST_TRAP = 7229; -- The chest was trapped!
    CHEST_WEAK = 7230; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7231; -- The chest was a mimic!
  CHEST_MOOGLE = 7232; -- You cannot open the chest while participating in the moogle event.
CHEST_ILLUSION = 7233; -- The chest was but an illusion...
  CHEST_LOCKED = 7234; -- The chest appears to be locked.
