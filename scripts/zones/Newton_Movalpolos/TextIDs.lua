...
CHEST_UNLOCKED = 7223; -- You unlock the chest!
    CHEST_FAIL = 7224; -- Fails to open the chest.
    CHEST_TRAP = 7225; -- The chest was trapped!
    CHEST_WEAK = 7226; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7227; -- The chest was a mimic!
  CHEST_MOOGLE = 7228; -- You cannot open the chest while participating in the moogle event.
CHEST_ILLUSION = 7229; -- The chest was but an illusion...
  CHEST_LOCKED = 7230; -- The chest appears to be locked.
