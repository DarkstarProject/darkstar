...
-- General Texts
ITEM_CANNOT_BE_OBTAINED = 10508; -- You cannot obtain the item <item> come back again after sorting your inventory
...
YOU_CAN_NOW_BECOME_A_SAMURAI = 10124; -- You accept the Mumeito from Gilgamesh. You can now become a samurai.
   CARRYING_TOO_MUCH_ALREADY = 10125; -- I wish to give you your reward, but you seem to be carrying too much already. Come back when you have more room in your pack.
			  ...
			  SPASIJA_DIALOG = 10275; -- Hiya! I can deliver packages to anybody, anywhere, anytime. What do you say?
			 PALEILLE_DIALOG = 10276; -- We can deliver parcels to any residence in Vana'diel.
	
		  LEVIATHAN_UNLOCKED = 10395; -- You are now able to summon Leviathan.	
 
		 NOMAD_MOOGLE_DIALOG = 10463; -- I'm a traveling moogle, kupo. I help adventurers in the Outlands access items they have stored in a Mog House elsewhere, kupo.
