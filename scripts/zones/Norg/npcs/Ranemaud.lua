...
function onTrade(player,npc,trade)
    ...
    if (player:getQuestStatus(OUTLANDS,dsp.quests.ids.outlands.THE_SACRED_KATANA) == QUEST_ACCEPTED and player:hasItem(17809) == false) then
...
function onTrigger(player,npc)
    ...
    if (player:getQuestStatus(OUTLANDS,dsp.quests.ids.outlands.FORGE_YOUR_DESTINY) == QUEST_ACCEPTED and swordTimer == 0) then
    ...
    elseif (player:getQuestStatus(OUTLANDS,dsp.quests.ids.outlands.THE_SACRED_KATANA) == QUEST_ACCEPTED and player:hasItem(17809) == false) then
