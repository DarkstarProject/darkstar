...
-- General Texts
ITEM_CANNOT_BE_OBTAINED_TWICE = 6536; -- You cannot obtain the item <item>
   ...
   FULL_INVENTORY_AFTER_TRADE = 6539; -- You cannot obtain the <item>. Try trading again after sorting your inventory
    ...
    SHINING_OBJECT_SLIPS_AWAY = 7365; -- The shining object slips through your fingers and is washed further down the stream.
  
-- Conquest
CONQUEST = 7408; -- You've earned conquest points!

-- Other Dialog
        NOTHING_HAPPENS = 7293; -- Nothing happens...
