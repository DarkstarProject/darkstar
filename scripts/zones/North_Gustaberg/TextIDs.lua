...
ITEM_CANNOT_BE_OBTAINED_TWICE = 6550; -- You cannot obtain the item <item>.
   ...
   FULL_INVENTORY_AFTER_TRADE = 6553; -- You cannot obtain the #. Try trading again after sorting your inventory.
             ...
             KEYITEM_OBTAINED = 6557; -- Obtained key item: <keyitem>.
               ITEMS_OBTAINED = 6563; -- You obtain
       FISHING_MESSAGE_OFFSET = 7197; -- You can't fish here.

-- Conquest
CONQUEST = 7442; -- You've earned conquest points!

-- Quests
SHINING_OBJECT_SLIPS_AWAY = 7399; -- The shining object slips through your fingers and is washed further down the stream.
