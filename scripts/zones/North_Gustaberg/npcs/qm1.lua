...
local function moveSirenTear(npc)
    ...
    local npcPos = math.floor(math.floor(npc:getXPos())*1000000 + math.floor(npc:getYPos())*1000 + npc:getZPos())
    local disp = (npc:getYPos()*100 - math.floor(npc:getYPos()*100+0.5))*10
    local dispf = disp*0.001
