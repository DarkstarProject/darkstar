...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 49 and npcUtil.completeQuest(player, SANDORIA, dsp.quests.ids.sandoria.PEACE_FOR_THE_SPIRIT, {item = 12513, fame = AF3_FAME, title = dsp.title.PARAGON_OF_RED_MAGE_EXCELLENCE})) then
