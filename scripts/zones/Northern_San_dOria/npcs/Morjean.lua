...
function onTrigger(player,npc)
    ...
    elseif (player:getQuestStatus(SANDORIA,dsp.quests.ids.sandoria.A_SQUIRE_S_TEST_II) == QUEST_ACCEPTED) then
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 65) then
        player:addQuest(SANDORIA,dsp.quests.ids.sandoria.THE_HOLY_CREST);
