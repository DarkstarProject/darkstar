...
-- Mining
MINING_IS_POSSIBLE_HERE = 7698; -- Mining is possible here if you have

-- Treasure Coffer/Chest Dialog
         CHEST_UNLOCKED = 7745; -- You unlock the chest!
             CHEST_FAIL = 7746; -- Fails to open the chest.
         ...
         CHEST_ILLUSION = 7751; -- The chest was but an illusion...
           CHEST_LOCKED = 7752; -- The chest appears to be locked.
