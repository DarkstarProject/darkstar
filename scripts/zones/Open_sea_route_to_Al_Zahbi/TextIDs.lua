...
ITEM_CANNOT_BE_OBTAINED = 6378; -- You cannot obtain the item <item> come back again after sorting your inventory
 ...
 FISHING_MESSAGE_OFFSET = 7024; -- You can't fish here.
    DOCKING_IN_AL_ZAHBI = 7279; -- We are now docking in Al Zahbi.

-- Shops
CEHN_TEYOHNGO_SHOP_DIALOG = 7282; -- If you're looking for fishing gear, you've come to the right place!

-- Other
ON_WAY_TO_AL_ZAHBI = 7278; -- We are on our way to Al Zahbi. We should arrive in
