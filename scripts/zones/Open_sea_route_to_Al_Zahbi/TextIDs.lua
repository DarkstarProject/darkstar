...
ITEM_CANNOT_BE_OBTAINED = 6376; -- You cannot obtain the item <item> come back again after sorting your inventory
 ...
 FISHING_MESSAGE_OFFSET = 7020; -- You can't fish here.
    DOCKING_IN_AL_ZAHBI = 7275; -- We are now docking in Al Zahbi.
    
-- Shops
CEHN_TEYOHNGO_SHOP_DIALOG = 7278; -- If you're looking for fishing gear, you've come to the right place!
    
-- Other
ON_WAY_TO_AL_ZAHBI = 7274; -- We are on our way to Al Zahbi. We should arrive in
