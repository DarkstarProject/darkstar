...
-- General Texts
  ITEM_CANNOT_BE_OBTAINED = 6380; -- You cannot obtain the item <item> come back again after sorting your inventory
   ...
   FISHING_MESSAGE_OFFSET = 7047; -- You can't fish here.
      DOCKING_IN_AL_ZAHBI = 7307; -- We are now docking in Al Zahbi.

-- Shops
CEHN_TEYOHNGO_SHOP_DIALOG = 7310; -- If you're looking for fishing gear, you've come to the right place!
