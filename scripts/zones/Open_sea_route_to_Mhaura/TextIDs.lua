...
ITEM_CANNOT_BE_OBTAINED = 6378; -- You cannot obtain the item <item> come back again after sorting your inventory
 ...
 FISHING_MESSAGE_OFFSET = 7024; -- You can't fish here
      DOCKING_IN_MHAURA = 7279; -- We are now docking in Mhaura.

-- Shops
PASHI_MACCALEH_SHOP_DIALOG = 7282; -- Step right up for the best fishing gear in these parts!

-- Other
ON_WAY_TO_MHAURA = 7278; -- We are on our way to Mhaura. We should arrive in
