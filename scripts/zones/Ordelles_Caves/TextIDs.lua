...
-- Quest Dialog
  ...
  A_SQUIRE_S_TEST_II_DIALOG_I = 7340; -- You place your hands into the pool.
 A_SQUIRE_S_TEST_II_DIALOG_II = 7343; -- The dew from the stalactite slips through your fingers.
A_SQUIRE_S_TEST_II_DIALOG_III = 7344; -- You have already obtained the dew.
          GERWITZS_AXE_DIALOG = 7397; -- Mine axe shall rend thy throat!
        GERWITZS_SWORD_DIALOG = 7398; -- Mine sword shall pierce thy tongue!
         GERWITZS_SOUL_DIALOG = 7399; -- Long have I waited. I will tell all...

-- Mission Dialog
RUILLONT_INITIAL_DIALOG = 7329; -- Confound it! If I only had my sword, I'd cut through these fiends single-handedly...

-- conquest Base
CONQUEST_BASE = 0;

-- Strange Apparatus
DEVICE_NOT_WORKING = 7306; -- The device is not working.
      SYS_OVERLOAD = 7315; -- arning! Sys...verload! Enterin...fety mode. ID eras...d 
      YOU_LOST_THE = 7320; -- You lost the #. 
