...
-- General Texts
ITEM_CANNOT_BE_OBTAINED = 6583; -- You cannot obtain the item <item>. Come back after sorting your inventory.
          ITEM_OBTAINED = 6586; -- Obtained: <item>.
           GIL_OBTAINED = 6587; -- Obtained <number> gil.
       KEYITEM_OBTAINED = 6589; -- Obtained key item: <keyitem>.

-- Treasure Coffer/Chest Dialog
CHEST_UNLOCKED = 7254; -- You unlock the chest!
    CHEST_FAIL = 7255; -- Fails to open the chest.
    CHEST_TRAP = 7256; -- The chest was trapped!
    CHEST_WEAK = 7257; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7258; -- The chest was a mimic!
  CHEST_MOOGLE = 7259; -- You cannot open the chest while participating in the moogle event.
CHEST_ILLUSION = 7260; -- The chest was but an illusion...
  CHEST_LOCKED = 7261; -- The chest appears to be locked.
