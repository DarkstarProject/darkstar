...
function onEventFinish(player,csid,option)
    ...
    if (csid == 48) then
        ...
        if (orb_value == 1) then
            ...
            --Delete the key item
            player:delKeyItem(dsp.kis.THIRD_DARK_MANA_ORB);
        ...
        elseif (orb_value == 2) then
            ...
            player:addKeyItem(dsp.kis.THIRD_GLOWING_MANA_ORB);
            player:messageSpecial(KEYITEM_OBTAINED,dsp.kis.THIRD_GLOWING_MANA_ORB);
