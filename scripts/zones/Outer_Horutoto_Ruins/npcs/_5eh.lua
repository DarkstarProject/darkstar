...
function onEventFinish(player,csid,option)
    ...
    if (csid == 49) then
        ...
        if (orb_value == 1) then
            ...
            --Delete the key item
            player:delKeyItem(dsp.kis.FOURTH_DARK_MANA_ORB);
        ...
        elseif (orb_value == 2) then
            ...
            player:addKeyItem(dsp.kis.FOURTH_GLOWING_MANA_ORB);
            player:messageSpecial(KEYITEM_OBTAINED,dsp.kis.FOURTH_GLOWING_MANA_ORB);
