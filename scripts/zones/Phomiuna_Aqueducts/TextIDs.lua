...
ITEM_CANNOT_BE_OBTAINED = 6376; -- You cannot obtain the item <item> come back again after sorting your inventory
 ...
 -- Lamps
LAMP_OFFSET = 7185; -- A symbol for fire is engraved on the base of the lamp...

-- Other
NOTHING_OUT_HERE = 6393; -- There is nothing out of the ordinary here.
DOOR_SEALED_SHUT = 7177; -- The door above you is sealed shut.
     DOOR_LOCKED = 7179; -- The door is locked. You might be able to open it with <a bronze key>.