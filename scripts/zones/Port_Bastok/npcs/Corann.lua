...
TheQuadav = player:getQuestStatus(BASTOK,dsp.quests.ids.bastok.THE_QUADAV_S_CURSE);
...
TheQuadav = player:getQuestStatus(BASTOK,dsp.quests.ids.bastok.THE_QUADAV_S_CURSE);
OutOfOneShell = player:getQuestStatus(BASTOK,dsp.quests.ids.bastok.OUT_OF_ONE_S_SHELL);
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 80) then
        player:addQuest(BASTOK,dsp.quests.ids.bastok.THE_QUADAV_S_CURSE);
    elseif (csid == 81) then
        player:tradeComplete();
        player:completeQuest(BASTOK,dsp.quests.ids.bastok.THE_QUADAV_S_CURSE);
