...
function onTrade(player,npc,trade)
	...
	carnation	=	trade:getItemQty(948)
	----------------ARROWS----------------------------
	--antlion		=	(trade:getItemQty(19195) / 99)
	beetle		=	(trade:getItemQty(18154) / 99)
	demon		=	(trade:getItemQty(18159) / 99)
	--gargouille	=	(trade:getItemQty(19800) / 99)
	horn		=	(trade:getItemQty(18156) / 99)
	irona		=	(trade:getItemQty(17320) / 99)
	kabura		=	(trade:getItemQty(17325) / 99)
	--ruszor		=	(trade:getItemQty(19182) / 99)
	scorpion	=	(trade:getItemQty(18155) / 99)
	silvera		=	(trade:getItemQty(17321) / 99)
	sleepa		=	(trade:getItemQty(18158) / 99)
	----------------BOLTS-----------------------------
	acid		=	(trade:getItemQty(18148) / 99)
	--adamana		=	(trade:getItemQty(19801) / 99)
	blind		=	(trade:getItemQty(18150) / 99)
	bloody		=	(trade:getItemQty(18151) / 99)
	--darka		=	(trade:getItemQty(19183) / 99)
	--darkling	=	(trade:getItemQty(19196) / 99)
	darksteel	=	(trade:getItemQty(17338) / 99)
	holy		=	(trade:getItemQty(18153) / 99)
	mythril		=	(trade:getItemQty(17337) / 99)
	sleepb		=	(trade:getItemQty(18149) / 99)
	venom		=	(trade:getItemQty(18152) / 99)
	----------------BULLETS---------------------------
	--adamanb	=	(trade:getItemQty(19803) / 99)
	bullet		=	(trade:getItemQty(17340) / 99)
	bronze		=	(trade:getItemQty(17343) / 99)
	--darkb		=	(trade:getItemQty(19184) / 99)
	--dweomer	=	(trade:getItemQty(19198) / 99)
	ironb		=	(trade:getItemQty(17312) / 99)
	--oberons	=	(trade:getItemQty(19199) / 99)
	--orichalcum=	(trade:getItemQty(19802) / 99)
	silverb		=	(trade:getItemQty(17341) / 99)
	steel		=	(trade:getItemQty(18723) / 99)
	spartan		=	(trade:getItemQty(18160) / 99)
	----------------CARDS-----------------------------
...
-----------------------------------------------------
	...
	quiver = (beetle + demon + horn + irona + kabura + scorpion + silvera + sleepa + acid + blind + bloody + darksteel + holy + mythril + sleepb + venom + bullet + bronze + ironb + silverb + steel + spartan)
