...
function onTrade(player,npc,trade)
	...
	wijinruit 	=	trade:getItemQty(951)
	uchitake 	= 	(trade:getItemQty(1161) / 99)
	tsurara 	= 	(trade:getItemQty(1164) / 99)
	kawahori 	= 	(trade:getItemQty(1167) / 99)
	makibishi 	= 	(trade:getItemQty(1170) / 99)
	hiraishin 	= 	(trade:getItemQty(1173) / 99)
	mizu 		= 	(trade:getItemQty(1176) / 99)
	shihei 		= 	(trade:getItemQty(1179) / 99)
	jusatsu 	=	(trade:getItemQty(1182) / 99)
	kaginawa	=	(trade:getItemQty(1185) / 99)
	sairui 		=	(trade:getItemQty(1188) / 99)
	kodoku 		=	(trade:getItemQty(1191) / 99)
	shinobi 	=	(trade:getItemQty(1194) / 99)
	sanjaku		=	(trade:getItemQty(2553) / 99)
	soushi 		=	(trade:getItemQty(2555) / 99)
	kabenro 	= 	(trade:getItemQty(2642) / 99)
	jinko 		= 	(trade:getItemQty(2643) / 99)
	mokujin 	= 	(trade:getItemQty(2970) / 99)
	inoshi 		= 	(trade:getItemQty(2971) / 99)
	shikan 		= 	(trade:getItemQty(2972) / 99)
	chono 		= 	(trade:getItemQty(2973) / 99)
	tools = (uchitake + tsurara + kawahori + makibishi + hiraishin + mizu + shihei + jusatsu + kaginawa + sairui + kodoku + shinobi + sanjaku + soushi + kabenro + jinko + mokujin + inoshi + shikan + chono)
	if(((tools * 99) + wijinruit) == count) then
