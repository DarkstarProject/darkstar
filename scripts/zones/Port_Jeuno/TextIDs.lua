...
-- Other Texts
         GUIDE_STONE = 7012; -- Up: Lower Jeuno (Selection Dialogfacing Bastok) Down: Qufim Island
...
SECURITY_DIALOG = 7086; -- Port Jeuno must remain secure. After all, if anything happened to the archduke, it would change the world!
 ...
 CHOCOBO_DIALOG = 7174; -- ...
      ...
      DRYEYES_2 = 8159; -- Done deal. Deal is done.
      DRYEYES_3 = 8160; -- Hey, you already got . What you tryin' to pull here? Save some for my other customers, eh
