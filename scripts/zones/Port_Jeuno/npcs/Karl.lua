...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 1) then
        player:addTitle(dsp.titles.TRADER_OF_MYSTERIES);
        player:addKeyItem(dsp.kis.WONDER_MAGIC_SET);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.kis.WONDER_MAGIC_SET);
