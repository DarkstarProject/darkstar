...
FULL_INVENTORY_AFTER_TRADE = 6402; -- You cannot obtain the <item>. Try trading again after sorting your inventory
    ...
    FISHING_MESSAGE_OFFSET = 6785; -- You can't fish here
...
-- Dialogs
  ...
  FLYER_ACCEPTED = 7104; -- Your flyer is accepted!
   FLYERS_HANDED = 7105; -- You've handed out <number> flyer(s).


 PORTAURE_DIALOG = 7367; -- What's this? A magic shop? Hmm...I could use a new line of work, and magic just might be the ticket!
  ANSWALD_DIALOG = 7387; -- A magic shop? Oh, it's right near here. I'll go check it out sometime.
  PRIETTA_DIALOG = 7411; -- This is the first I've heard of a magic shop here in San d'Oria. Such arts have never been popular in the Kingdom.
   AUVARE_DIALOG = 7418; -- What have I got here? Look, I can't read, but I takes what I gets, and you ain't getting it back!
    MIENE_DIALOG = 7471; -- Oh, a magic shop... Here in San d'Oria? I'd take a look if I got more allowance.

 ANSWALD_MESSAGE = 7961; -- Answald looks over curiously for a moment.
 PRIETTA_MESSAGE = 7962; -- Prietta looks over curiously for a moment.
   MIENE_MESSAGE = 7963; -- Miene looks over curiously for a moment.
PORTAURE_MESSAGE = 7964; -- Portaure looks over curiously for a moment.
  AUVARE_MESSAGE = 7965; -- Auvare looks over curiously for a moment.

-- Shop Texts
           ALBINIE_SHOP_DIALOG = 7431; -- Welcome to my simple shop.
