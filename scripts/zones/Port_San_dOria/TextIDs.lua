...
PORTAURE_MESSAGE = 7930; -- Portaure looks over curiously for a moment.
  AUVARE_MESSAGE = 7931; -- Auvare looks over curiously for a moment.

-- Shop Texts
   ALBINIE_SHOP_DIALOG = 7397; -- Welcome to my simple shop.
  COULLAVE_SHOP_DIALOG = 7443; -- Can I help you?
CROUMANGUE_SHOP_DIALOG = 7444; -- Can't fight on an empty stomach. How about some nourishment?

	      VENDAVOQ_OPEN_DIALOG = 7451;  -- Vandoolin! Vendavoq vring voods vack vrom Vovalpolos! Vuy! Vuy!
	    VENDAVOQ_CLOSED_DIALOG = 7442;  -- Vandoolin... Vendavoq's vream vo vell voods vrom vometown vf Vovalpolos...

       BONMAURIEUT_OPEN_DIALOG = 7780;  -- My shipment is in! Would you like to see what has just arrived from the Elshimo Uplands?
     BONMAURIEUT_CLOSED_DIALOG = 7777;  -- I would like to sell goods from the Elshimo Uplands, but I cannot, as it's under foreign control.
	  ...
	  DEGUERENDARS_OPEN_DIALOG = 7453;  -- Welcome! Have a look at these rare goods from Tavnazia!
	DEGUERENDARS_CLOSED_DIALOG = 7454;  -- With that other nation in control of the region, there is no way for me to import goods from Tavnazia...
DEGUERENDARS_COP_NOT_COMPLETED = 7455;  -- <Sigh> Why must I wait for the Kingdom to issue a permit allowing me to set up shop? How am I to feed my children in the meantime!??Prompt?
