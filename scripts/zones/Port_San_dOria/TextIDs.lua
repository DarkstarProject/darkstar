...
FIXME:           MYSTIC_RETRIEVER =  6427; -- You cannot obtain the <item>. Speak with the mystic retriever after sorting your inventory.
...
DEGUERENDARS_COP_NOT_COMPLETED = 7945; -- Why must I wait for the Kingdom to issue a permit allowing me to set up shop? How am I to feed my children in the meantime!?
     ...
     BONMAURIEUT_CLOSED_DIALOG = 8280; -- I would like to sell goods from the Elshimo Uplands, but I cannot, as it's under foreign control.
           ...
           PATOLLE_OPEN_DIALOG = 8282; -- How about some specialty goods from Kuzotz?
