...
function onTrade(player, npc, trade)
    ...
    elseif player:getQuestStatus(JEUNO, dsp.quests.ids.jeuno.RIDING_ON_THE_CLOUDS) == QUEST_ACCEPTED and player:getVar("ridingOnTheClouds_1") == 5 and npcUtil.tradeHas(trade, 1127) then
