...
zones[dsp.zone.PORT_WINDURST] =
{
    text =
    {
        MELEK_DIALOG_B                  = 3251, -- Take that sword to Giddeus. Good luck.
        GOLD_SKULL_DIALOG               = 3252, -- Welcome back. Your mission went without incident, I trust?
        MELEK_DIALOG_C                  = 3257, -- I hope to see you safe and well again someday. Take care, <name>.
        MELEK_DIALOG_A                  = 3279, -- Well, good luck with your mission. I look forward to hearing of your success.
        BABUBU_SHOP_DIALOG              = 3606, -- This be the Fishermen's Guild shop. What supplies will you be needin' today?
        ULIPEHKOWA_SHOP_DIALOG          = 4131, -- Step rrright up! Step rrright up! This is yourrr last chance to shop in Windurst! Get yourrr souvenirs or forrrgotten shopping done here!
        KUSUSU_SHOP_DIALOG              = 4134, -- Welcome to Kususu's Hoodoos! We have low-level to medium-level magic on sale to help you through the early, rough spells in your life.
        ARORO_SHOP_DIALOG               = 4135, -- Buy some hocus-pocus from us at Kususu's Hoodoos! I'll give you a smiley charm from me, Aroro, for free! C'mon... How about it then?
        HOHBIBAMUBIBA_SHOP_DIALOG       = 4136, -- Hohbiba-Mubiba! Just because, at first glance, we Tarutaru look weak, doesn't mean you should make light of our weapons.
        ...
        KUMAMA_SHOP_DIALOG              = 4141, -- At Guruna-Maguruna's, we tailor to your needs!
        POSSORUHBINI_OPEN_DIALOG        = 4142, -- Rrroll up! Rrroll up! Plenty of goods from Norvallen! The morrre you buy, the happierrr you'll make me!
        POSSORUHBINI_CLOSED_DIALOG      = 4143, -- The sea brrreeze is so refrrreshing! At least this'll keep me happy until I rrreceive my next shipment of goods from Norvallen! I think I'm in heaven!
        SHEIAPOHRICHAMAHA_OPEN_DIALOG   = 4144, -- Come one, come all! Goods from Fauregandi for sale! But make surrre you brrring your gil with you!
        SHEIAPOHRICHAMAHA_CLOSED_DIALOG = 4145, -- I'm a traveling merrrchant. There arrre times when I have prrroducts from Fauregandi, but rrright now I'm clearrr out of stock!
        ZOREEN_OPEN_DIALOG              = 4146, -- Buy somethin' from Valdeaunia...?
        ZOREEN_CLOSED_DIALOG            = 4147, -- Valdeaunia...
        KHEL_PAHLHAMA_DIALOG            = 4148, -- She sells % by the sea shorrre! Hahaha...
        CONQUEST_BASE                   = 4425, -- Tallying conquest results...
