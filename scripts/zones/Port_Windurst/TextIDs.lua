...
-- General Texts
     ...
     FULL_INVENTORY_AFTER_TRADE = 10968 -- Try trading again after sorting your inventory.
                  ITEM_OBTAINED = 10970 -- Obtained:
       ...
       GUILD_TERMINATE_CONTRACT = 11689 -- You have terminated your trading contract with the Multiple Choice (Parameter 1)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild and formed a new one with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
             GUILD_NEW_CONTRACT = 11697 -- You have formed a new trading contract with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
            NO_MORE_GP_ELIGIBLE = 11704 -- You are not eligible to receive guild points at this time.
                    GP_OBTAINED = 11709 -- Obtained: ?Numeric Parameter 0? guild points.
...
SHEIAPOHRICHAMAHA_CLOSED_DIALOG =  4144 -- I'm a traveling merrrchant. There arrre times when I have prrroducts from Fauregandi, but rrright now I'm clearrr out of stock!
      ...
      KHEL_PAHLHAMA_SHOP_DIALOG = 11200 -- These magic shells are full of mysteries...
               RYAN_SHOP_DIALOG = 11824 -- I have no time for white-livered scum that rely on magic alone.
             DROZGA_SHOP_DIALOG = 11825 -- Not only is Ryan a boorish lout, but his craftsmanship leaves much to be desired, as well. You're better off buyin' from me.
