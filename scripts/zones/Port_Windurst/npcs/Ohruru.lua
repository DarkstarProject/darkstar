...
--    player:delQuest(WINDURST,dsp.quests.ids.windurst.CATCH_IT_IF_YOU_CAN); -- ======== FOR TESTING ONLY ==========-----
-- ======== FOR TESTING ONLY ==========-----
...
-- ======== FOR TESTING ONLY ==========-----
    ...
    Catch = player:getQuestStatus(WINDURST,dsp.quests.ids.windurst.CATCH_IT_IF_YOU_CAN);
...
function onEventFinish(player,csid,option)
    if (csid == 231) then
        player:addQuest(WINDURST,dsp.quests.ids.windurst.CATCH_IT_IF_YOU_CAN);
    elseif (csid == 246 and option == 0) then
        ...
        if (player:getQuestStatus(WINDURST,dsp.quests.ids.windurst.CATCH_IT_IF_YOU_CAN) == QUEST_ACCEPTED) then
            player:completeQuest(WINDURST,dsp.quests.ids.windurst.CATCH_IT_IF_YOU_CAN);
