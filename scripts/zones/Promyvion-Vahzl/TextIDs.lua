...
-- Other
OVERFLOWING_MEMORIES = 7186; -- It appears to be a barrier woven from the energy of overflowing memories...

-- Popped NM Spawns
     ON_NM_SPAWN = 7190; -- You sense a dark, empty presence...
    POPPED_NM_OFFSET = 7272; -- Remnants of a
