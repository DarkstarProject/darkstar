...
HOMEPOINT_SET = 12678; -- Home point set!
...
-- Quest dialog
   THESE_WITHERED_FLOWERS = 7317; -- These withered flowers seem unable to bloom.
NOW_THAT_NIGHT_HAS_FALLEN = 7318; -- Now that night has fallen, the flowers bloom with a strange glow.
