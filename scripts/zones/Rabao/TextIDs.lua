...
ITEM_CANNOT_BE_OBTAINED = 6390; -- You cannot obtain the item <item> come back again after sorting your inventory
 ...
 -- Other Texts
 PAKHI_DELIVERY_DIALOG = 9978; -- When your pack is fit to burrrst, send your non-essential items to your delivery box and bam, prrroblem solved!
SPIRIT_DELIVERY_DIALOG = 9979; -- We can deliver goods to your residence or to the residences of your friends

-- Quest Dialog
    GARUDA_UNLOCKED = 10063; -- You are now able to summon
NOMAD_MOOGLE_DIALOG = 10131; -- I'm a traveling moogle, kupo. I help adventurers in the Outlands access items they have stored in a Mog House elsewhere, kupo.
