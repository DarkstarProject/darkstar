...
function onTrigger(player,npc)
	...
	if(id == base) then
		-- not real!
	elseif(id == base+1) then --  L-9 porter
		player:startEvent(0x2);
	elseif(id == base+2) then --  L-8 porter
		player:startEvent(0x3);
	elseif(id == base+3) then --  K-8 porter
		player:startEvent(0x4);
	elseif(id == base+4) then --  J-7 porter (SE)
		player:startEvent(0x5);
	elseif(id == base+5) then --  I-8 porter
		player:startEvent(0x6);
	elseif(id == base+7) then --  G-9 porter
		player:startEvent(0x8);
	elseif(id == base+8) then --  M-9 porter 
		player:startEvent(0x9);
	elseif(id == base+9) then --  M-9 porter (back to Misareaux Coast)
		player:startEvent(0xA);
	elseif(id == base+10) then --  M-8 porter
		player:startEvent(0xB);
	elseif(id == base+11) then --  L-7 porter (east)
		player:startEvent(0xC);
	elseif(id == base+12) then --  L-7 porter (NW)
		player:startEvent(0xD);
	elseif(id == base+13) then --  J-6 porter
		player:startEvent(0xE);
	elseif(id == base+14) then --  K-6 porter (SE)
		player:startEvent(0xF);
	elseif(id == base+15) then --  K-7 porter (S)
		player:startEvent(0x10);
	elseif(id == base+16) then --  K-7 porter (N)
		player:startEvent(0x11);
	elseif(id == base+17) then --  J-7 porter (NE)
		player:startEvent(0x12);
	elseif(id == base+18) then --  J-7 porter (Middle)
		player:startEvent(0x13);
	elseif(id == base+19) then --  J-7 porter (NW)
		player:startEvent(0x14);
	elseif(id == base+20) then --  I-7 porter (N middle)
		player:startEvent(0x15);
	elseif(id == base+22) then --  I-7 porter (NW to southern island)
		player:startEvent(0x17);
	elseif(id == base+23) then --  I-7 porter (southern island N)
		player:startEvent(0x18);
	elseif(id == base+24) then --  I-7 porter (S)
		player:startEvent(0x19);
	elseif(id == base+25) then --  G-7 porter (NE)
		player:startEvent(0x1A);
	elseif(id == base+26) then --  F-6 porter (E)
		player:startEvent(0x1B);
	elseif(id == base+27) then --  G-7 porter (S)
		player:startEvent(0x1C);
	elseif(id == base+28) then --  F-8 porter 
		player:startEvent(0x1D);
	elseif(id == base+29) then --  F-6 porter (W)
		player:startEvent(0x1E);
	elseif(id == base+30) then --  E-7 porter (SE)
		player:startEvent(0x1F);		
	elseif(id == base+31) then --  E-8 (N)
		player:startEvent(0x20);
	elseif(id == base+32) then --  E-8 (S) - Monarch Linn
		player:startEvent(0x21);
	elseif(id == base+37) then -- E-7 porter (SW)
		player:startEvent(0x24);
	elseif(id == base+38) then -- D-8 (NE)
		player:startEvent(0x25);
	elseif(id == base+40) then -- C-9 porter (N)
		player:startEvent(0x27);
	elseif(id == base+41) then -- C-9 porter (Monument)
		player:startEvent(0x28);
	elseif(id == base+42) then -- D-10 porter (Monument)
