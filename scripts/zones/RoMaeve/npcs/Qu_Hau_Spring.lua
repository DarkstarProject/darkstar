...
function onTrade(player,npc,trade)
    ...
    if (player:getWeather() == 0 and Hour >= 0 and Hour <= 3) then
        if (DMfirst == QUEST_ACCEPTED and trade:hasItemQty(1408,1) and trade:hasItemQty(917,1) and trade:getItemCount() == 2) then
