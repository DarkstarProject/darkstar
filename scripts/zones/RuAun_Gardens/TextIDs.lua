...
CHEST_UNLOCKED = 7318; -- You unlock the chest!
    CHEST_FAIL = 7319; -- Fails to open the chest.
...
CHEST_ILLUSION = 7324; -- The chest was but an illusion...
  CHEST_LOCKED = 7325; -- The chest appears to be locked.

-- Other dialog
IT_IS_ALREADY_FUNCTIONING = 7285; -- It is already functioning.
           SKY_GOD_OFFSET = 7335; -- A strange insignia pointing north is carved into the wall.
         SKY_GOD_OFFSET_2 = 7336; -- A strange insignia pointing east is carved into the wall.
         SKY_GOD_OFFSET_3 = 7337; -- A strange insignia pointing west is carved into the wall.
         SKY_GOD_OFFSET_4 = 7338; -- A strange insignia pointing south is carved into the wall.
