...
--printf("RESULT: %u",option);
	...
	elseif(csid == 0x0051) then
		...
		player:addTitle(title.HORIZON_BREAKER);
		player:levelCap(55);
	...
	elseif(csid == 0x0054) then
		player:addTitle(title.SUMMIT_BREAKER);
	...
	elseif(csid == 0x0057) then
		player:addTitle(title.SKY_BREAKER);
	...
	elseif(csid == 0x005a) then
		player:addTitle(title.CLOUD_BREAKER);
	...
	elseif(csid == 0x005d) then
		player:addTitle(title.STAR_BREAKER);
		player:levelCap(75);
	...
	elseif(csid==0x004a)then
		if(player:getFreeSlotsCount() > 0)then
			...
			player:addTitle(title.ULTIMATE_CHAMPION_OF_THE_WORLD);
