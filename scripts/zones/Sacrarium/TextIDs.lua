...
NOTHING_OUT_OF_ORDINARY = 7197; -- There is nothing out of the ordinary here.
			...
			EVIL_PRESENCE = 7229; -- You sense an evil presence!
			  DRAWER_OPEN = 7230; -- You open the drawer.
			 DRAWER_EMPTY = 7231; -- There is nothing inside. 
			  DRAWER_SHUT = 7232; -- The drawer is jammed shut.
			  
     START_GET_GOOSEBUMPS = 7330; -- You start to get goosebumps.
			 HEART_RACING = 7331; -- Your heart is racing.
LEAVE_QUICKLY_AS_POSSIBLE = 7332; -- Your common sense tells you to leave as quickly as possible.
          NOTHING_HAPPENS = 7335; -- Nothing happens.

-- Treasure Coffer/Chest Dialog
CHEST_UNLOCKED = 7320; -- You unlock the chest!
    CHEST_FAIL = 7321; -- Fails to open the chest. 
    CHEST_TRAP = 7322; -- The chest was trapped! 
    CHEST_WEAK = 7323; -- You cannot open the chest when you are in a weakened state.
   CHEST_MIMIC = 7324; -- The chest was a mimic! 
  CHEST_MOOGLE = 7325; -- You cannot open the chest while participating in the moogle event.
CHEST_ILLUSION = 7326; -- The chest was but an illusion...
  CHEST_LOCKED = 7327; -- The chest appears to be locked.
