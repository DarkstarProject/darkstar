...
SAHAGIN_DOOR_OUTSIDE = 7300; -- This door has an oddly shaped keyhole. It looks as if once you enter, you may not be able to get out the way you came in.
 SAHAGIN_DOOR_TRADED = 7301; -- breaks

-- Secret Door Texts; The first five are the same for each door, with the 6th and 7th being unique
    FIRST_CHECK = 7305; -- You do not see anything out of the ordinary.
   SECOND_CHECK = 7306; -- You do not see anything out of the ordinary...
    THIRD_CHECK = 7307; -- It looks like a rock wall.
   FOURTH_CHECK = 7308; -- It looks like a rock wall...
    FIFTH_CHECK = 7309; -- You see a small indentation in the wall.
   SILVER_CHECK = 7310; -- You see something silver glittering around the indentation.
  MYTHRIL_CHECK = 7311; -- You find something that looks like mythril dust scattered about the indentation.
     GOLD_CHECK = 7312; -- You see something gold glittering around the indentation.
COMPLETED_CHECK = 7313; -- It is a door you can open using
