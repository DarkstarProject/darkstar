        ...
        if (success ~= -2) then
            ...
            if (math.random() <= success) then
                ...
                if (questItemNeeded == 1) then
                    ...
                    player:messageSpecial(text.KEYITEM_OBTAINED,MAP_OF_THE_SEA_SERPENT_GROTTO); -- Map of Sea Serpent Grotto
                elseif (questItemNeeded == 2) then
                    ...
                    player:messageSpecial(text.KEYITEM_OBTAINED,LEPHEMERE); -- L'Ephemere for A Test Of True Love quest
                else
...
function onTrigger(player,npc)
    player:messageSpecial(text.CHEST_LOCKED,1055);
end; 
