        ...
        if (success ~= -2) then
            ...
            if (math.random() <= success) then
                ...
                elseif (questItemNeeded == 3) then
                    ...
                    player:messageSpecial(text.KEYITEM_OBTAINED,MAP_OF_THE_SEA_SERPENT_GROTTO); -- Map of the Sea Serpent Grotto (KI)
                else
...
function onTrigger(player,npc)
    player:messageSpecial(text.CHEST_LOCKED,1059);
end; 
