...
-- Standard Text
       FIRE_GOOD = 7361; -- The fire seems to be good enough for cooking.
        FIRE_PUT = 7362; -- You put$ in the fire.
       FIRE_TAKE = 7363; -- You take$ out of the fire.
     FIRE_LONGER = 7364; -- It may take a little while more to cook
...
MONSTER_TRACKS_FRESH = 7358; -- You see fresh monster tracks on the ground.
