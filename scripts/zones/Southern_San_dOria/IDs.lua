...
zones[dsp.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        FULL_INVENTORY_AFTER_TRADE     = 6429, -- Try trading again after sorting your inventory.
        ...
        NOTHING_OUT_OF_ORDINARY        = 6445, -- There is nothing out of the ordinary here.<Prompt>
        ...
        GUILD_TERMINATE_CONTRACT       = 6788, -- You have terminated your trading contract with the Multiple Choice (Parameter 1)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild and formed a new one with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
        GUILD_NEW_CONTRACT             = 6796, -- You have formed a new trading contract with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
        NO_MORE_GP_ELIGIBLE            = 6803, -- You are not eligible to receive guild points at this time
        GP_OBTAINED                    = 6808, -- Obtained: ?Numeric Parameter 0? guild points.
        ...
        THANK_YOU                      = 7358, -- Thank you...<<<Prompt>>>
        ...
        YOU_CANNOT_ENTER_DYNAMIS       = 7413, -- You cannot enter Dynamis
        PLAYERS_HAVE_NOT_REACHED_LEVEL = 7415, -- Players who have not reached level <<<Numeric Parameter 0>>> are prohibited from entering Dynamis.
        ...
        LUSIANE_THANK                  = 8879, -- Thank you!?Prompt?
        ...
        CAPUCINE_SHOP_DIALOG           = 10310, -- Hello!
