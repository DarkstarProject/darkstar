...
function onTrigger(player,npc)
    ...
    local aSquiresTestII = player:getQuestStatus(SANDORIA, dsp.quests.ids.sandoria.dsp.quests.ids.sandoria.A_SQUIRE_S_TEST_II)
    local medicineWoman = player:getQuestStatus(SANDORIA, dsp.quests.ids.sandoria.THE_MEDICINE_WOMAN)
    local toCureaCough = player:getQuestStatus(SANDORIA, dsp.quests.ids.sandoria.TO_CURE_A_COUGH)
