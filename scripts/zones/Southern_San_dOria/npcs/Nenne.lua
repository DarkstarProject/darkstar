...
function onTrigger(player,npc)
    ...
    medicineWoman = player:getQuestStatus(SANDORIA,dsp.quests.ids.sandoria.THE_MEDICINE_WOMAN);
    toCureaCough = player:getQuestStatus(SANDORIA,dsp.quests.ids.sandoria.TO_CURE_A_COUGH);
...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 647) then
        ...
        player:completeQuest(SANDORIA,dsp.quests.ids.sandoria.TO_CURE_A_COUGH);
    end
