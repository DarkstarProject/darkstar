...
function onEventFinish(player,csid,option)
    if (csid == 7 and option == 0) then
        player:addQuest(CRYSTAL_WAR,dsp.quests.ids.crystalWar.STEAMED_RAMS);
    ...
    elseif (csid == 12 and option == 0) then
        ...
        if (player:getVar("Campaign_Nation") == 0) then
            if (player:getFreeSlotsCount() >= 1) then
                ...
                player:completeQuest(CRYSTAL_WAR,dsp.quests.ids.crystalWar.STEAMED_RAMS);
    ...
    elseif (csid == 13 and option == 1) then
        player:delQuest(CRYSTAL_WAR,dsp.quests.ids.crystalWar.STEAMED_RAMS);
    end
end;