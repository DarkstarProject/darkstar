...
ITEM_CANNOT_BE_OBTAINED = 6380; -- You cannot obtain the item <item> come back again after sorting your inventory
       ...
       KEYITEM_OBTAINED = 6389; -- Obtained key item: <keyitem>
         ...
         FAINT_SCRAPING = 7079; -- You can hear a faint scraping sound from within, but the way is barred by some strange membrane...
          CANT_REMEMBER = 7630; -- You cannot remember when exactly, but you have obtained
