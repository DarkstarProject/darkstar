...
-- ??? that spawns NM Yara Ma Yha Who
     SPROUT_LOOKS_WITHERED = 7548; -- There is something sprouting from the ground here. It looks a little withered.
REPULSIVE_CREATURE_EMERGES = 7549; -- A repulsive creature emerges from the ground!
SPROUT_DOES_NOT_NEED_WATER = 7550; -- The sprout does not need any more water now.
     SPROUT_LOOKING_BETTER = 7552; -- The sprout is looking better.
...
-- Luck Rune
NOTHING_OUT_OF_THE_ORDINARY = 6582;  -- There is nothing out of the ordinary here.

-- Other Texts
TELEPOINT_HAS_BEEN_SHATTERED = 7505; -- The telepoint has been shattered into a thousand pieces...
