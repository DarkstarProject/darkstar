...
-- Shop Text
     CAIPHIMONRIDE_SHOP_DIALOG = 10901; -- Welcome! Thanks to the supplies from Jeuno, I've been able to fix some of the weapons I had in storage!
      ...
      MAZUROOOZURO_SHOP_DIALOG = 10897; -- Hidely-howdy-ho! I'll sell you what I've got if you fork over enough dough!
            MIGRAN_SHOP_DIALOG = 10907; -- Even with the aid from Jeuno, I still have trouble feeding my six children...
      ...
      YOU_CANNOT_ENTER_DYNAMIS = 11827; -- You cannot enter Dynamis

PLAYERS_HAVE_NOT_REACHED_LEVEL = 11829; -- Players who have not reached levelare prohibited from entering Dynamis.

              MYSTERIOUS_VOICE = 11828; -- You hear a mysterious, floating voice:

-- conquest Base
                 CONQUEST_BASE =  6535; -- Tallying conquest results...

-- Porter Moogle
            RETRIEVE_DIALOG_ID = 12252; -- You retrieve$ from the porter moogle's care.
