...
function onMobDespawn(mob)
    ...
    if (GetMobByID(16929046):isDead() and GetMobByID(16929047):isDead() and GetMobByID(16929048):isDead() and 
        GetMobByID(16929049):isDead() and GetMobByID(16929050):isDead()) then
