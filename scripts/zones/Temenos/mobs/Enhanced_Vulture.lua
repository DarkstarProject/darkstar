...
function onMobDeath(mob, player, isKiller)
   ...
   if (limbus.isMobDead(16928959)==true and limbus.isMobDead(16928960)==true  and limbus.isMobDead(16928961)==true
   and limbus.isMobDead(16928962)==true  and limbus.isMobDead(16928963)==true and limbus.isMobDead(16928964)==true) then
