...
function onMobEngaged(mob, target)
    if limbus.isMobDead(16929049) then
...
function onMobDeath(mob, player, isKiller)
    ...
    if limbus.isMobDead(16929046) and limbus.isMobDead(16929047) and limbus.isMobDead(16929049) and limbus.isMobDead(16929050) and limbus.isMobDead(16929051) then
