...
function onMobEngaged(mob,target)
  if   (limbus.isMobDead(16929017)==true and limbus.isMobDead(16929018)==true and limbus.isMobDead(16929019)==true and
        limbus.isMobDead(16929020)==true and limbus.isMobDead(16929021)==true and limbus.isMobDead(16929022)==true
    ) then
