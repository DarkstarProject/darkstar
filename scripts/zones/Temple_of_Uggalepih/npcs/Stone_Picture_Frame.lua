...
-- Opens door to Den of Rancor using Painbrush of Souls
-- @pos  159
-----------------------------------
...
function onTrigger(player,npc)
	...
	if(X < -60) then
		...
		elseif(Z > -5) then
			if(GetNPCByID(17428965):getAnimation() == 8) then
...
elseif(csid == 0x003C) then
	...
	if(time_elapsed >= 30) then
		...
		npc = GetNPCByID(17428965):openDoor(40); -- Open the door to Den of Rancor for 40 sec
