        ...
        if (success ~= -2) then
            ...
            if (math.random() <= success) then
                ...
                if (questItemNeeded == 3) then
                    ...
                    player:messageSpecial(text.KEYITEM_OBTAINED,MAP_OF_THE_TEMPLE_OF_UGGALEPIH); -- Map of the Temple of Uggalepih (KI)
...
function onTrigger(player,npc)
    player:messageSpecial(text.CHEST_LOCKED,1049);
end; 
