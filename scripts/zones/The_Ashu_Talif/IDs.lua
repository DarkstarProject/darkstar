...
zones[dsp.zone.THE_ASHU_TALIF] =
{
    text = {
        ...
        TIME_REMAINING_MINUTES     = 7407, -- ime remaining: <number> [minute/minutes] (Earth time).
        TIME_REMAINING_SECONDS     = 7408, -- ime remaining: <number> [second/seconds] (Earth time).
        FADES_INTO_NOTHINGNESS     = 7409, -- The <item> fades into nothingness...
        PARTY_FALLEN               = 7410, -- ll party members have fallen in battle. Mission failure in <number> [minute/minutes].
