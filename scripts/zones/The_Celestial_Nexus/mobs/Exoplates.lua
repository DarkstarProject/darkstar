...
function onMobDeath(mob, player, isKiller)
    ...
    eald_narche:delStatusEffect(EFFECT.PHYSICAL_SHIELD, 0, 1, 0, 0);
    eald_narche:delStatusEffect(EFFECT.ARROW_SHIELD, 0, 1, 0, 0);
    eald_narche:delStatusEffect(EFFECT.MAGIC_SHIELD, 0, 1, 0, 0);
end;
