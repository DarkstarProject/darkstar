...
-- Quests
         NOTHING_OUT_OF_ORDINARY = 7457; -- There is nothing out of the ordinary here.
             SENSE_OF_FOREBODING = 6560; -- You are suddenly overcome with a sense of foreboding...
                NOTHING_HAPPENED = 7429; -- Nothing happened...

            RETURN_RIBBON_TO_HER = 7353; -- You can hear a voice from somewhere. (...return...ribbon to...her...)

              THE_BRAZIER_IS_LIT = 7367; -- The brazier is lit.
                 REFUSE_TO_LIGHT = 7368; -- Unexpectedly, therefuses to light.
                LANTERN_GOES_OUT = 7369; -- For some strange reason, the light of thegoes out...
                 THE_LIGHT_DIMLY = 7370; -- lights dimly. It doesn't look like this will be effective yet.?Prompt?
       THE_LIGHT_HAS_INTENSIFIED = 7371; -- The light of thehas intensified.
          THE_LIGHT_IS_FULLY_LIT = 7372; -- is fully lit!

dsp.ki.SPIRIT_INCENSE_EMITS_PUTRID_ODOR = 7409; -- emits a putrid odor and burns up. Your attempt this time has failed...?Prompt?
...
-- Strange Apparatus
              DEVICE_NOT_WORKING = 7316; -- The device is not working.
                    SYS_OVERLOAD = 7325; -- arning! Sys...verload! Enterin...fety mode. ID eras...d 
                    YOU_LOST_THE = 7330; -- You lost the #. 
