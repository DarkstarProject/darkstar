...
-- Quest "Save my son"
  NOTHING_OUT_OF_ORDINARY = 7385; -- There is nothing out of the ordinary here.
	   THE_BRAZIER_IS_LIT = 7295; --	The brazier is lit.
	     ...
	     LANTERN_GOES_OUT = 7297; -- For some strange reason, the light of the Ducal Guard's lantern goes out...
		  THE_LIGHT_DIMLY = 7298; -- The Ducal Guard's lantern lights dimly.
THE_LIGHT_HAS_INTENSIFIED = 7299; -- The light of Ducal Guard's lantern has intensified.
   THE_LIGHT_IS_FULLY_LIT = 7300; -- The Ducal Guard's lantern is fully lit!
