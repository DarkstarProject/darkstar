    ...
    if (csid == 0x002c and option == 0) then 
        ...
        elseif (LanternOrder == 3) then
            if (npcID == 17576346) then --(H-9)
                ...
                player:messageSpecial(text.THE_LIGHT_IS_FULLY_LIT,0,0,0,DUCAL_GUARDS_LANTERN_LIT);
