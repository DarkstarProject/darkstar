...
function onTrigger(player, npc)
    ...
    if player:getQuestStatus(JEUNO, dsp.quests.ids.jeuno.A_NEW_DAWN) == QUEST_ACCEPTED and npc:getID() == ID.npc.SARCOPHAGUS_OFFSET then
...
function onEventFinish(player,csid,option)
    ...
    -- A NEW DAWN
    elseif csid == 45 and npcUtil.completeQuest(player, JEUNO, dsp.quests.ids.jeuno.A_NEW_DAWN, {item = 14222, title = dsp.title.PARAGON_OF_BEASTMASTER_EXCELLENCE}) then
