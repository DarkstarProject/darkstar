...
function onTrade(player,npc,trade)
	...
	key = trade:hasItemQty(1046,1); 		-- Treasure Key
	...
	if((key or sk or lk or ttk) and trade:getItemCount() == 1) then 
		...
		if((AFHandsActivated == 8 or AFHandsActivated == 5 or AFHandsActivated == 1 or AFHandsActivated == 7) and oldGauntlets == false) then 
			questItemNeeded = 1;
		else
