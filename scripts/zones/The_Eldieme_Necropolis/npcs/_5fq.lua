...
function onTrigger(player,npc)
	...
	GetNPCByID(17576309):setAnimation(state0);
	-- Odin's Gate
	...
	GetNPCByID(17576314):setAnimation(state1);
	-- Leviathan's Gate
	...
	GetNPCByID(17576319):setAnimation(state0);
	-- Titan's Gate
	...
	GetNPCByID(17576324):setAnimation(state1);
	...
	GetNPCByID(17576332):setAnimation(state0);
	return 0;
end;
