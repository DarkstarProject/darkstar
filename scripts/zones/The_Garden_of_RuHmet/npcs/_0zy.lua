...
function onTrigger(player,npc)
    ...
    if ((player:getCurrentMission(COP) == dsp.mission.id.cop.DAWN and player:getVar("PromathiaStatus") > 0) or player:getCurrentMission(COP) > dsp.mission.id.cop.DAWN) then
