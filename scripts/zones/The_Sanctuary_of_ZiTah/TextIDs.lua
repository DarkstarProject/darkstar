...
-- Quest Dialogs
    SENSE_OF_FOREBODING = 6398; -- You are suddenly overcome with a sense of foreboding...
          STURDY_BRANCH = 7747; -- It is a beautiful, sturdy branch.
NOTHING_OUT_OF_ORDINARY = 6397; -- There is nothing out of the ordinary here.

-- ZM4 Dialog
   CANNOT_REMOVE_FRAG = 7720; -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
ALREADY_OBTAINED_FRAG = 7721; -- You have already obtained this monument's
      FOUND_ALL_FRAGS = 7723; -- You now have all 8 fragments of light!
      ZILART_MONUMENT = 7724; -- It is an ancient Zilart monument.
