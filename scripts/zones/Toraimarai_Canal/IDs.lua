...
zones[dsp.zone.TORAIMARAI_CANAL] =
{
    text =
    {
        ...
        YOUR_GEOMAGNETRON_HAS_ATTUNED = 7056,  -- Your <Geomagnetron> has been attuned.
        A_FAINT_ENERGY_WAFTS_UP       = 7057,  -- A faint energy wafts up from the ground
        YOUR_GEOMAGNETRON_HAS_ALREADY = 7058,  -- Your Geomagnetron has already been attuned.
