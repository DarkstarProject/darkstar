...
zones[dsp.zone.TORAIMARAI_CANAL] =
{
    text =
    {
        ...
        ITEM_CANNOT_BE_OBTAINED = 6427, -- You cannot obtain the item <item>. Come back after sorting your inventory.
        ...
        CHEST_IS_LOCKED         = 7353, -- This chest is locked. It can be opened with
        CHEST_UNLOCKED          = 7360, -- You unlock the chest!
        CHEST_FAIL              = 7361, -- Fails to open the chest.
