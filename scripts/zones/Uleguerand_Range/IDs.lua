...
zones[dsp.zone.ULEGUERAND_RANGE] =
{
    text =
    {
        ...
        SOMETHING_GLITTERING    = 7333, -- You see something glittering beneath the surface of the ice. There are many cold Moblin Hotroks scattered around the area.
        WHAT_LIES_BENEATH       = 7334, -- Could someone be trying to melt the ice to retrieve what lies beneath?
