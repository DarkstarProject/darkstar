...
function onEventFinish(player,csid,option)
    ...
    if (csid == 10) then
        ...
        player:addExp(EXP_RATE * 2000)
        player:addKeyItem(dsp.ki.MAP_OF_THE_ULEGUERAND_RANGE)
        player:messageSpecial(ID.text.KEYITEM_OBTAINED, dsp.ki.MAP_OF_THE_ULEGUERAND_RANGE)
