...
function onEventFinish(player,csid,option)
    ...
    if csid == 10 and npcUtil.completeQuest(player, SANDORIA, dsp.quests.ids.sandoria.OVER_THE_HILLS_AND_FAR_AWAY, {gil = 2000, xp = 2000, ki = dsp.ki.MAP_OF_THE_ULEGUERAND_RANGE}) then
        player:confirmTrade()
    end
