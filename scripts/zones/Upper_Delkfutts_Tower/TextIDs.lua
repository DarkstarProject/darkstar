...
-- General Texts
ITEM_CANNOT_BE_OBTAINED = 6411; -- You cannot obtain the item <item>. Come back after sorting your inventory.
          ITEM_OBTAINED = 6414; -- Obtained: <item>.
           GIL_OBTAINED = 6415; -- Obtained <number> gil.
       KEYITEM_OBTAINED = 6417; -- Obtained key item: <keyitem>.
