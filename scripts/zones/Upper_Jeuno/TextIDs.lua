...
-- Conquest system
CONQUEST = 7680; -- You've earned conquest points!

-- NPC Texts
            KIRISOMANRISO_DIALOG = 8013; -- Delivering goods to residences everywhere!
YOU_CAN_NOW_BECOME_A_BEASTMASTER = 7124; -- You can now become a beastmaster.

                   UNLOCK_DANCER = 11767; -- You can now become a dancer!

GUIDE_STONE = 6919; -- Up: Ru'Lude Gardens Down: Lower Jeuno

-- Shop Texts
       GLYKE_SHOP_DIALOG = 6914; -- Can I help you?
     MEJUONE_SHOP_DIALOG = 6915; -- Welcome to the Chocobo Shop.
     COUMUNA_SHOP_DIALOG = 6916; -- Welcome to Viette's Finest Weapons.
     ANTONIA_SHOP_DIALOG = 6916; -- Welcome to Viette's Finest Weapons.
DEADLYMINNOW_SHOP_DIALOG = 6917; -- Welcome to Durable Shields.
 KHECHALAHKO_SHOP_DIALOG = 6917; -- Welcome to Durable Shields.
