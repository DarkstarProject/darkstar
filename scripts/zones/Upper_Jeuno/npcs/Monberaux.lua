...
function onTrigger(player,npc)
    local TheLostCardien = player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.THE_LOST_CARDIAN);
    ...
    elseif (TheLostCardien == QUEST_COMPLETED and player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.THE_KIND_CARDIAN) == QUEST_ACCEPTED) then
...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 33 and option == 0 or csid == 34 and option == 0) then
        ...
        player:completeQuest(JEUNO,dsp.quests.ids.jeuno.THE_LOST_CARDIAN);
        player:addQuest(JEUNO,dsp.quests.ids.jeuno.THE_KIND_CARDIAN); -- Start next quest "THE_KING_CARDIAN"
