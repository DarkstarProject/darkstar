        ...
        if (success ~= -2) then
            ...
            if (math.random() <= success) then
                ...
                if (questItemNeeded == 3) then
                    ...
                    player:messageSpecial(ID.text.KEYITEM_OBTAINED,dsp.ki.MAP_OF_THE_VELUGANNON_PALACE); -- Map of the Ve'Lugannon Palace (KI)
...
function onTrigger(player,npc)
    player:messageSpecial(ID.text.CHEST_LOCKED,1060);
end;
