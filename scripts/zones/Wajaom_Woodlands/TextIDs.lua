...
NOTHING_HAPPENS =  119; -- Nothing happens...
       LEYPOINT = 7387; -- An eerie red glow emanates from this stone platform

-- Harvesting
HARVESTING_IS_POSSIBLE_HERE = 7395; -- Harvesting is possible here if you have

-- Quest: NAVIGATING_THE_UNFRIENDLY_SEAS
PLACE_HYDROGAUGE = 7331; -- You set the # in the glowing trench.
 ENIGMATIC_LIGHT = 7332; -- is giving off an enigmatic light.
