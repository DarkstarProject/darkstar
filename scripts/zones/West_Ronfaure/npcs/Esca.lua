...
function onTrade(player, npc, trade)
    if player:getQuestStatus(SANDORIA, dsp.quests.ids.sandoria.THE_PICKPOCKET) == QUEST_ACCEPTED and player:getVar("thePickpocket") == 1 and npcUtil.tradeHas(trade, 578) then
