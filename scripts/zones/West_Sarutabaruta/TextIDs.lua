...
-- Fields of Valor Texts
            REGIME_ACCEPTED = 10185; -- New training regime registered!
             DONT_SWAP_JOBS = 10186; -- your job will result in the cancellation of your current training regime.
...
-- Harvesting
HARVESTING_IS_POSSIBLE_HERE =  7437; -- Harvesting is possible here if you have
...
-- Other Dialog
            NOTHING_HAPPENS =  7307; -- Nothing happens...
    NOTHING_OUT_OF_ORDINARY = 11304; -- There is nothing out of the ordinary here.
...
-- Signs
                    ...
                    SIGN_17 =  7385; -- Northwest: Northwest Tower, Horutoto RuinsEast: Outpost Southwest: Giddeus
-- conquest Base
