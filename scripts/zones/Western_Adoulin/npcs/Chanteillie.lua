...
function onTrade(player,npc,trade)
    local DNGITL = player:getQuestStatus(ADOULIN, dsp.quests.ids.adoulin.DO_NOT_GO_INTO_THE_LIGHT);
    local VVC = player:getQuestStatus(ADOULIN, dsp.quests.ids.adoulin.VEGETABLE_VEGETABLE_CRISIS);
