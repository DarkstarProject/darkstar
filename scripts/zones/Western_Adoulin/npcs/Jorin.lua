...
function onEventFinish(player,csid,option)
    if (csid == 2540) then
        ...
        player:addQuest(ADOULIN, dsp.quests.ids.adoulin.THE_OLD_MAN_AND_THE_HARPOON);
    ...
    elseif (csid == 2542) then
        -- Finishing Quest: 'The Old Man and the Harpoon'
        player:completeQuest(ADOULIN, dsp.quests.ids.adoulin.THE_OLD_MAN_AND_THE_HARPOON);
