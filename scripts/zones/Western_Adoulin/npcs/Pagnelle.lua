...
function onTrigger(player,npc)
    ...
    elseif (Raptor_Rapture == QUEST_ACCEPTED) then
        ...
        elseif (Raptor_Rapture_Status == 6) then
            local Has_Rockberries = player:hasKeyItem(dsp.kis.ROCKBERRY1) and player:hasKeyItem(dsp.kis.ROCKBERRY2) and player:hasKeyItem(dsp.kis.ROCKBERRY3)
...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 5037) then
        ...
        player:delKeyItem(dsp.kis.ROCKBERRY1);
        player:delKeyItem(dsp.kis.ROCKBERRY2);
        player:delKeyItem(dsp.kis.ROCKBERRY3);
