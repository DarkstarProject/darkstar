...
function onTrigger(player,npc)
    local Raptor_Rapture = player:getQuestStatus(ADOULIN, dsp.quests.ids.adoulin.RAPTOR_RAPTURE);
...
function onEventFinish(player,csid,option)
    ...
    elseif ((csid == 5061) and (option == 1)) then
        ...
        player:addQuest(ADOULIN, dsp.quests.ids.adoulin.RAPTOR_RAPTURE);
    ...
    elseif (csid == 5039) then
        ...
        player:completeQuest(ADOULIN, dsp.quests.ids.adoulin.RAPTOR_RAPTURE);
