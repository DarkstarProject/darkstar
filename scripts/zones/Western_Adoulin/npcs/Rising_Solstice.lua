...
function onEventFinish(player,csid,option)
    if (csid == 2550) then
        ...
        player:addKeyItem(dsp.kis.WESTERN_ADOULIN_PATROL_ROUTE);
        player:messageSpecial(KEYITEM_OBTAINED, dsp.kis.WESTERN_ADOULIN_PATROL_ROUTE);
    ...
    elseif (csid == 2552) then
        ...
        player:delKeyItem(dsp.kis.WESTERN_ADOULIN_PATROL_ROUTE);
