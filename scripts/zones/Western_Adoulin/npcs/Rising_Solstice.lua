...
function onEventFinish(player,csid,option)
    if (csid == 2550) then
        ...
        player:addQuest(ADOULIN, dsp.quests.ids.adoulin.A_CERTAIN_SUBSTITUTE_PATROLMAN);
    ...
    elseif (csid == 2552) then
        -- Finishing Quest: 'A Certain Substitute Patrolman'
        player:completeQuest(ADOULIN, dsp.quests.ids.adoulin.A_CERTAIN_SUBSTITUTE_PATROLMAN);
