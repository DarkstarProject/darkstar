...
FULL_INVENTORY_AFTER_TRADE = 6385 -- You cannot obtain the <item>. Try trading again after sorting your inventory.
          ...
          KEYITEM_OBTAINED = 6390 -- Obtained key item: <keyitem>.
            ITEMS_OBTAINED = 7422 -- You obtain <param2 number> <param1 item>!
   NOTHING_OUT_OF_ORDINARY = 7393 -- There is nothing out of the ordinary here.
...
-- ZM4 dialog
     ...
     ALREADY_OBTAINED_FRAG = 7345 -- You have already obtained this monument's
    ALREADY_HAVE_ALL_FRAGS = 7346 -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
           FOUND_ALL_FRAGS = 7347 -- You now have all 8 fragments of light!
...
--chocobo digging
            DIG_THROW_AWAY = 7220 -- You dig up$, but your inventory is full. You regretfully throw the # away.
