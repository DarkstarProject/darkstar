...
-- ZM4 dialog
    CANNOT_REMOVE_FRAG = 7302; -- It is an oddly shaped monument. A shiny stone... cannot be removed.
 ALREADY_OBTAINED_FRAG = 7303; -- You have already obtained this monuments...
ALREADY_HAVE_ALL_FRAGS = 7304; -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
       FOUND_ALL_FRAGS = 7305; -- You have obtained <frag>! You now have all 8 fragments of light!
       ZILART_MONUMENT = 7306; -- Its an ancient Zilart Monument.

-- Other dialog
	 THE_DOOR_IS_LOCKED = 7285; -- The door is locked.
	   DOES_NOT_RESPOND = 7286; -- It does not respond.
