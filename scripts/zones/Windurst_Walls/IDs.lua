...
zones[dsp.zone.WINDURST_WALLS] =
{
    text =
    {
        ...
        SCAVNIX_SHOP_DIALOG            = 8671, -- I'm goood Goblin from underwooorld.I find lotshhh of gooodieshhh.You want try shhhome chipshhh? Cheap for yooou.
        RETRIBUTION_LEARNED            = 9059, -- You have learned the weapon skill “Retribution”!
        YOU_CANNOT_ENTER_DYNAMIS       = 9082, -- You cannot enter Dynamis
        PLAYERS_HAVE_NOT_REACHED_LEVEL = 9084, -- Players who have not reached levelare prohibited from entering Dynamis.
