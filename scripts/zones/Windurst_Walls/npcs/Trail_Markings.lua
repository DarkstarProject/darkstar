...
function onTrigger(player,npc)
	...
	elseif(player:hasKeyItem(VIAL_OF_SHROUDED_SAND)) then
		...
		elseif((dynaWaitxDay + (BETWEEN_2DYNA_WAIT_TIME * 24 * 60 * 60)) < realDay or (dynaWaitxDay == realDay and player:getVar("DynamisID") == GetServerVariable("[DynaWindurst]UniqueID"))) then
