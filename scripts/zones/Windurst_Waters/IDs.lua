...
zones[dsp.zone.WINDURST_WATERS] =
{
    text =
    {
        ...
        INVENTORY_FULL             = 6542, -- You cannot obtain the item.
        ...
        GUILD_NEW_CONTRACT         = 7171, -- You have formed a new trading contract with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
        NO_MORE_GP_ELIGIBLE        = 7178, -- You are not eligible to receive guild points at this time.
        GP_OBTAINED                = 7183, -- Obtained: ?Numeric Parameter 0? guild points.
        ...
        OREZEBREZ_SHOP_DIALOG      = 8916, -- Welcome to Baren-Moren's, makers of the finest headwear. Our slogan is: he smarter the hat, the smarter the head.
        ...
        JOURILLE_CLOSED_DIALOG     = 8930, -- Greetings! I am Jourille, your friendly neighborhood traveling merchant. I would most like to sell you something from Ronfaure right now, but I regret that I am waiting on my next shipment.
        ...
        THANK_YOU_TREAT            = 10166, -- And now for your treat...
