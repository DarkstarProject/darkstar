...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 400) then
        ...
        player:completeQuest(WINDURST,dsp.quests.ids.windurst.EARLY_BIRD_CATCHES_THE_BOOKWORM);
    ...
    elseif (csid == 410) then
        ...
        player:addFame(WINDURST,120);
        player:completeQuest(WINDURST,dsp.quests.ids.windurst.CHASING_TALES);
