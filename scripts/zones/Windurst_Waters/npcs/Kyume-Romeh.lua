...
function onTrigger(player,npc)
    ...
    local MakingHeadlines = player:getQuestStatus(WINDURST,dsp.quests.ids.windurst.MAKING_HEADLINES);
    ...
    elseif (player:getQuestStatus(WINDURST,dsp.quests.ids.windurst.LURE_OF_THE_WILDCAT_WINDURST) == QUEST_ACCEPTED and player:getMaskBit(WildcatWindurst,14) == false) then
