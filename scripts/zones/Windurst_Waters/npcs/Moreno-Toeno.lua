...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 0x00B6 or csid == 0x02AF) and option ~= 1 then -- start
        ...
        player:messageSpecial(TextIDs.KEYITEM_OBTAINED,CREATURE_COUNTER_MAGIC_DOLL);
    ...
    elseif (csid == 0x00C6 or csid == 0x00C7 or csid == 0x00CA or csid == 0x00D0) then -- failed testing time
        ...
        player:messageSpecial(TextIDs.KEYITEM_OBTAINED + 1,CREATURE_COUNTER_MAGIC_DOLL);
    ...
    elseif (csid == 0x02F0) then
        ...
        player:messageSpecial(TextIDs.KEYITEM_OBTAINED,STAR_SEEKER);
