...
-- General Texts
     ITEM_CANNOT_BE_OBTAINED =  6540 -- Come back after sorting your inventory.
               ITEM_OBTAINED =  6546 -- Obtained: <<<Unknown Parameter (Type: 80) 1>>><<<Possible Special Code: 01>>><<<Possible Special Code: 05>>>
    ...
    GUILD_TERMINATE_CONTRACT =  7213 -- You have terminated your trading contract with the Multiple Choice (Parameter 1)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild and formed a new one with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
          GUILD_NEW_CONTRACT =  7221 -- You have formed a new trading contract with the Multiple Choice (Parameter 0)[Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild
                 GP_OBTAINED =  7233 -- Obtained: ?Numeric Parameter 0? guild points.
...
-- Other Texts
        ITEM_DELIVERY_DIALOG =  6826 -- We can deliver goods to your residence or to the residences of your friends.
           ...
           NOKKHI_GOOD_TRADE =  9759 -- And here you go! Come back soon, and bring your friends!
             ...
             CLOUD_BAD_COUNT = 10104 -- Well, don't just stand there like an idiot! I can't do any bundlin' until you fork over a set of 99 tools and
...
-- Shop Texts
      ...
      KUZAH_HPIROHPON_DIALOG =  7968 -- want to get your paws on the top-quality materials as used in the Weaverrrs' Guild?
       ...
       MONONCHAA_SHOP_DIALOG =  8511 -- , then hurry up and decide, then get the heck out of herrre!
...
TARAIHIPERUNHI_CLOSED_DIALOG =  8527 -- I am but a poor  merchant. Mate, but you just wait! Strife...one day I'll live the high life. Hey, that's my dream, anyway...
...
--Test
      RAKOHBUUMA_OPEN_DIALOG =  7641 -- To expel those who would subvert the law and order of Windurst Woods...
...
-- Harvest Festival
             ...
             THANK_YOU_TREAT =  9736 -- And now for your treat...
...
-- Linkshell Concierges
    LS_CONCIERGE_REGISTERED1 = 14190 -- Your registration is officially complete.
    LS_CONCIERGE_REGISTERED2 = 14191 -- May your journeys lead you to many as-yet-unmet friends, and may the bonds you forge last a lifetime.
 LS_CONCIERGE_ALREADY_LISTED = 14192 -- Another member of that linkshell currently has an active registration. Please wait until that registration expires and try again.
 LS_CONCIERGE_LISTING_CANCEL = 14138 -- It was my pleasure to meet with you this fine day. May you encounter many friendly faces throughout your travels.
