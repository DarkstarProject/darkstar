...
-- Involved in quests: Legendary Plan B
...
function onEventFinish(player,csid,option)
    ...
    elseif csid == 303 and npcUtil.completeQuest(player, WINDURST, A_GREETING_CARDIAN, {item=13330, var={"AGreetingCardian_timer", "AGreetingCardian_Event"}}) then
