...
function onEventFinish(player,csid,option)
    ...
    elseif (csid == 93) then -- start quest "rock racketeer"
        ...
        player:addKeyItem(dsp.ki.SHARP_GRAY_STONE);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.SHARP_GRAY_STONE);
    elseif (csid == 98) then
    ...
    elseif (csid == 496) then
        ...
        player:addKeyItem(dsp.ki.LETTER_FROM_THE_TENSHODO);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.LETTER_FROM_THE_TENSHODO);
    elseif (csid == 504 and option == 1) then  -- start quest "as thick as thieves"
        ...
        player:addKeyItem(dsp.ki.GANG_WHEREABOUTS_NOTE);
        player:addKeyItem(dsp.ki.FIRST_FORGED_ENVELOPE);
        player:addKeyItem(dsp.ki.SECOND_FORGED_ENVELOPE);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.GANG_WHEREABOUTS_NOTE);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.FIRST_FORGED_ENVELOPE);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.SECOND_FORGED_ENVELOPE);
    ...
    elseif (csid == 512) then  -- start quest "hitting The Marquisate "
        ...
        player:addKeyItem(dsp.ki.CAT_BURGLARS_NOTE);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.CAT_BURGLARS_NOTE);
    ...
    elseif (csid == 165 and option == 1) then -- Windurst Mission 2-1 continuation
        ...
        player:addKeyItem(dsp.ki.LAPIS_MONOCLE);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.LAPIS_MONOCLE);
        -- Mark the progress
    ...
    elseif (csid == 169) then -- Windurst Mission 2-1 continuation
        ...
        player:addKeyItem(dsp.ki.HIDEOUT_KEY);
        player:messageSpecial(KEYITEM_OBTAINED,dsp.ki.HIDEOUT_KEY);
