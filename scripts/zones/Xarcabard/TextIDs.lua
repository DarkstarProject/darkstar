...
ITEM_CANNOT_BE_OBTAINED = 6392; -- You cannot obtain the item <item>. Come back after sorting your inventory.
       ...
       KEYITEM_OBTAINED = 6398; -- Obtained key item: <keyitem>.
        BEASTMEN_BANNER = 7122; -- There was a curse on the beastmen's banner!
  ALREADY_OBTAINED_TELE = 7251; -- You already possess the gate crystal for this telepoint.

-- Conquest
CONQUEST = 7264; -- You've earned conquest points!

-- Other
NOTHING_OUT_OF_ORDINARY = 6409; -- There is nothing out of the ordinary here.
            ONLY_SHARDS = 7597; -- Only shards of ice lie upon the ground.
