...
function onMobDeath(mob, player, isKiller)
    if OldSchoolG2 then
        ...
        if player:getQuestStatus(JEUNO,dsp.quests.ids.jeuno.ATOP_THE_HIGHEST_MOUNTAINS) == QUEST_ACCEPTED and not player:hasKeyItem(dsp.ki.TRIANGULAR_FRIGICITE) then
