...
function onMobDeath(mob, player, isKiller)
    if OldSchoolG2 then
        ...
        if player:getQuestStatus(JEUNO, tpz.quest.id.jeuno.ATOP_THE_HIGHEST_MOUNTAINS) == QUEST_ACCEPTED and not player:hasKeyItem(tpz.ki.TRIANGULAR_FRIGICITE) then
