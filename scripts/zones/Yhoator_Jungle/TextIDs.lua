...
NOTHING_OUT_OF_ORDINARY = 6398; -- There is nothing out of the ordinary here.
 ...
 FISHING_MESSAGE_OFFSET = 7544; -- You can't fish here.
  ALREADY_OBTAINED_TELE = 7639; -- You already possess the gate crystal for this telepoint.

-- Conquest
CONQUEST = 7211; -- You've earned conquest points!

-- Logging
   LOGGING_IS_POSSIBLE_HERE = 7652; -- Logging is possible here if you have
HARVESTING_IS_POSSIBLE_HERE = 7659; -- Harvesting is possible here if you have

-- Other dialog
TREE_CHECK = 7666; -- The hole in this tree is filled with a sweet-smelling liquid.
 TREE_FULL = 7667; -- Your wine barrel is already full.
...
FIND_NOTHING = 7559; -- You dig and you dig, but find nothing.?Prompt?
