...
ITEM_CANNOT_BE_OBTAINED = 6375; -- You cannot obtain the item <item>. Come back after sorting your inventory.
 ...
 FISHING_MESSAGE_OFFSET = 7513; -- You can't fish here.
  ALREADY_OBTAINED_TELE = 7605; -- You already possess the gate crystal for this telepoint.

-- Conquest
CONQUEST = 7180; -- You've earned conquest points!

-- Logging
   LOGGING_IS_POSSIBLE_HERE = 7617; -- Logging is possible here if you have <item>.
HARVESTING_IS_POSSIBLE_HERE = 7624; -- Harvesting is possible here if you have <item>.

-- Other dialog
             TREE_CHECK = 7631; -- The hole in this tree is filled with a sweet-smelling liquid.
              TREE_FULL = 7632; -- Your wine barrel is already full.
