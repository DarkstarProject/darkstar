...
HARVESTING_IS_POSSIBLE_HERE = 7703; -- Harvesting is possible here if you have
...
-- ZM4 Dialog
      ...
      ALREADY_OBTAINED_FRAG = 7676; -- You have already obtained this monument's
     ALREADY_HAVE_ALL_FRAGS = 7677; -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
            FOUND_ALL_FRAGS = 7678; -- You now have all 8 fragments of light!
