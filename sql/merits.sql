...
-- unknown 0
-- INSERT INTO `merits` VALUES(1728, 'unknown', 0, 0, 0, 0, 26);
-- unknown 1
-- INSERT INTO `merits` VALUES(1792, 'unknown', 0, 0, 0, 0, 27);
-- unknown 2
-- INSERT INTO `merits` VALUES(1856, 'unknown', 0, 0, 0, 0, 28);
-- unknown 3
-- INSERT INTO `merits` VALUES(1920, 'unknown', 0, 0, 0, 0, 29);
-- unknown 4
-- INSERT INTO `merits` VALUES(1984, 'unknown', 0, 0, 0, 0, 30);
...
-- blm 2
INSERT INTO `merits` VALUES(2240, 'flare_ii', 5, 5, 8, 7, 34); -- magic burst + 3 / magic accuracy + 5
INSERT INTO `merits` VALUES(2242, 'freeze_ii', 5, 5, 8, 7, 34); -- magic burst + 3 / magic accuracy + 5
INSERT INTO `merits` VALUES(2244, 'tornado_ii', 5, 5, 8, 7, 34); -- magic burst + 3 / magic accuracy + 5
INSERT INTO `merits` VALUES(2246, 'quake_ii', 5, 5, 8, 7, 34); -- magic burst + 3 / magic accuracy + 5
INSERT INTO `merits` VALUES(2248, 'burst_ii', 5, 5, 8, 7, 34); -- magic burst + 3 / magic accuracy + 5
INSERT INTO `merits` VALUES(2250, 'flood_ii', 5, 5, 8, 7, 34); -- magic burst + 3 / magic accuracy + 5

-- rdm 2
INSERT INTO `merits` VALUES(2304, 'dia_iii', 5, 30, 16, 7, 35);
INSERT INTO `merits` VALUES(2306, 'slow_ii', 5, 1, 16, 7, 35); -- slow effect + 1 / magic accuracy + 2
INSERT INTO `merits` VALUES(2308, 'paralyze_ii', 5, 5, 16, 7, 35); -- paralyze effect + 1 / magic accuracy + 2
INSERT INTO `merits` VALUES(2310, 'phalanx_ii', 5, 3, 16, 7, 35); -- Each additional merit increases damage shield effect by 3 and increases duration by 30 seconds up to a maximum of 240 seconds. 
INSERT INTO `merits` VALUES(2312, 'bio_iii', 5, 30, 16, 7, 35);
INSERT INTO `merits` VALUES(2314, 'blind_ii', 5, 5, 16, 7, 35); -- blind effect +1 / magic accuracy + 2
...
INSERT INTO `merits` VALUES(2438, 'guardian', 5, 1, 64, 7, 37); -- 1 is just a guess

-- drk 2
INSERT INTO `merits` VALUES(2496, 'dark_seal', 5, 1, 128, 7, 38); -- 1 just a guess
INSERT INTO `merits` VALUES(2498, 'diabolic_eye', 5, 1, 128, 7, 38);  -- 1 just a guess
INSERT INTO `merits` VALUES(2500, 'muted_soul', 5, 10, 128, 7, 38); 
INSERT INTO `merits` VALUES(2502, 'desperate_blows', 5, 5, 128, 7, 38);
...
INSERT INTO `merits` VALUES(2630, 'adventurers_dirge', 5, 10, 512, 7, 40); -- 10 first merit / 3 afterwards

-- rng 2
INSERT INTO `merits` VALUES(2688, 'stealth_shot', 5, 10, 1024, 7, 41);
INSERT INTO `merits` VALUES(2690, 'flashy_shot', 5, 1, 1024, 7, 41); -- 1 is guess
...
INSERT INTO `merits` VALUES(2820, 'katon_san', 5, 1, 4096, 7, 43); -- 1 is guess
INSERT INTO `merits` VALUES(2822, 'hyoton_san', 5, 1, 4096, 7, 43); -- 1 is guess
INSERT INTO `merits` VALUES(2824, 'huton_san', 5, 1, 4096, 7, 43); -- 1 is guess
INSERT INTO `merits` VALUES(2826, 'doton_san', 5, 1, 4096, 7, 43); -- 1 is guess
INSERT INTO `merits` VALUES(2828, 'raiton_san', 5, 1, 4096, 7, 43); -- 1 is guess
INSERT INTO `merits` VALUES(2830, 'suiton_san', 5, 1, 4096, 7, 43); -- 1 is guess

-- drg 2
INSERT INTO `merits` VALUES(2880, 'deep_breathing', 5, 1, 8192, 7, 44); -- 1 is guess
INSERT INTO `merits` VALUES(2882, 'angon', 5, 1, 8192, 7, 44); -- 1 is guess
INSERT INTO `merits` VALUES(2884, 'empathy', 5, 5, 8192, 7, 44); -- The first level of Empathy allows a Dragoon to copy one status effect to his or her wyvern each time Spirit Link is used. Each subsequent level of Empathy copies one additional status effect (so Empathy level 2 copies two effects each Spirit Link, while level 3 copies 3, and so on). 
...
-- cor 2
INSERT INTO `merits` VALUES(3072, 'snake_eye', 5, 1, 65536, 7, 47); -- 1 is guess
INSERT INTO `merits` VALUES(3074, 'fold', 5, 1, 65536, 7, 47); -- 1 is guess 
INSERT INTO `merits` VALUES(3076, 'winning_streak', 5, 20, 65536, 7, 47);
INSERT INTO `merits` VALUES(3078, 'loaded_deck', 5, 10, 65536, 7, 47);

-- pup 2
INSERT INTO `merits` VALUES(3136, 'role_reversal', 5, 1, 131072, 7, 48); -- 30 second reduction per 1
INSERT INTO `merits` VALUES(3138, 'ventriloquy', 5, 15, 131072, 7, 48); -- 1 is guess 
...
INSERT INTO `merits` VALUES(3270, 'enquanimity', 5, 1, 524288, 7, 50); -- 1 is guess
