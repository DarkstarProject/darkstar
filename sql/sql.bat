...
REM "c:\program files\mysql\mysql server 5.6\bin\mysqladmin" -h localhost -u root -proot DROP dspdb

REM ECHO Creating Database dspdb
REM "c:\program files\mysql\mysql server 5.6\bin\mysqladmin" -h localhost -u root -proot CREATE dspdb
