...
struct location_t 
{
	...
	uint16		boundary;	// определенная область в зоне (здесь ей самое место, хотя и используется только персонажем)
};
...
struct profile_t 
{
	...
	uint32	   rankpoints[3];	// очки ранга в трех государствах
