...
CTaskMgr::CTask *CTaskMgr::AddTask(std::string InitName, time_point InitTick, std::experimental::any InitData,TASKTYPE InitType,TaskFunc_t InitFunc,duration InitInterval)
{
