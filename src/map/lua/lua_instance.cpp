...
inline int32 CLuaInstance::getLastTimeUpdate(lua_State* L)
{
    ...
    auto count = std::chrono::duration_cast<std::chrono::milliseconds>(get_start_time() - m_PLuaInstance->GetLastTimeUpdate()).count();
...
inline int32 CLuaInstance::getWipeTime(lua_State* L)
{
    ...
    auto count = std::chrono::duration_cast<std::chrono::milliseconds>(get_start_time() - m_PLuaInstance->GetWipeTime()).count();
...
inline int32 CLuaInstance::setLastTimeUpdate(lua_State* L)
{
    ...
    m_PLuaInstance->SetLastTimeUpdate(get_start_time() + std::chrono::milliseconds(lua_tointeger(L, 1)));
...
inline int32 CLuaInstance::setWipeTime(lua_State* L)
{
    ...
    m_PLuaInstance->SetWipeTime(get_start_time() + std::chrono::milliseconds(lua_tointeger(L, 1)));
