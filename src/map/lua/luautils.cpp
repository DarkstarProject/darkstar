...
************************************************************************/
    ...
    ************************************************************************/
    ...
    int32 OnUseAbility(CCharEntity* PChar, CBattleEntity* PTarget, CAbility* PAbility, actionTarget_t* action)
    {
        ...
        //#TODO: move to new action struct (and change pcall back to 4 arguments)
