...
namespace luautils
{
    ...
    int32 OnAutomatonAbility(CBaseEntity* PAutomaton, CBaseEntity* PMob, CMobSkill* PMobSkill, uint16 tp, action_t* action);      // triggers when an Automaton uses an ability
