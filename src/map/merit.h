...
enum MERIT_TYPE
{
    ...
    //DRG 1
    MERIT_JUMP_RECAST               = MCATEGORY_DRG_1 + 0x00,
    MERIT_HIGH_JUMP_RECAST          = MCATEGORY_DRG_1 + 0x02,
    MERIT_SUPER_JUMP_RECAST         = MCATEGORY_DRG_1 + 0x04,
    MERIT_SPIRIT_LINK_RECAST        = MCATEGORY_DRG_1 + 0x06,
