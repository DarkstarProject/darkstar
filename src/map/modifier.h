...
enum class Mod
{
    ...
    HASTE_MAGIC               = 167, // Haste (and Slow) from magic - 10000 base, 375 = 3.75% Truncate at decimal, do not round.
    HASTE_ABILITY             = 383, // Haste (and Slow) from abilities - 10000 base, 375 = 3.75% Truncate at decimal, do not round.
    HASTE_GEAR                = 384, // Haste (and Slow) from equipment - 10000 base, 375 = 3.75% Truncate at decimal, do not round.
