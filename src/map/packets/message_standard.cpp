...
CMessageStandardPacket::CMessageStandardPacket(CCharEntity* PChar, uint32 param0, uint32 param1, std::uint16_t MessageID)
{
	this->type = 0x09;
	this->size = 0x12;
...
CMessageStandardPacket::CMessageStandardPacket(uint32 param0, uint32 param1, uint32 param2, uint32 param3, std::uint16_t MessageID)
{
	this->type = 0x09;
	this->size = 0x08;
...
CMessageStandardPacket::CMessageStandardPacket(CCharEntity* PChar, uint32 param0, std::uint16_t MessageID)
{
	this->type = 0x09;
	this->size = 0x18;
