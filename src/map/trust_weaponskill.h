...
#ifndef _CTRUSTWEAPONSKILL_H
#define _CTRUSTWEAPONSKILL_H
...
public:
    ...
    uint16      getID() const;
    uint16      getMLvl() const;
    uint16      getAnimationID() const;
    uint8       getAoe() const;
    float       getDistance() const;
    uint8       getFlag() const;
    duration      getAnimationTime() const;
...
private:
    ...
    duration      m_AnimationTime;    //how long the tp animation lasts for in ms
