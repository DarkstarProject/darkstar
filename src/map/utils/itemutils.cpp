...
namespace itemutils
{
    ...
    ************************************************************************/
    ...
    void LoadDropList()
    {
        auto ret = Sql_Query(SqlHandle, "SELECT dropId, itemId, dropType, itemRate, groupId, groupRate FROM mob_droplist WHERE dropid < %u;", MAX_DROPID);
    ...
    ************************************************************************/
    ...
    void LoadLootList()
    {
        auto ret = Sql_Query(SqlHandle, "SELECT LootDropId, itemId, rolls, lootGroupId FROM bcnm_loot WHERE LootDropId < %u;", MAX_LOOTID);
